...
PPC_FUNC_IMPL(__imp__sub_82C85538) {
	...
	ctx.cr0.compare<int32_t>(ctx.r11.s32, 0, ctx.xer);
	// bne 0x82c8555c
	if (!ctx.cr0.eq) goto loc_82C8555C;
	// lwz r11,408(r30)
...
loc_82C8555C:
	...
	ctx.cr0.compare<uint32_t>(ctx.r3.u32, 0, ctx.xer);
	// beq 0x82c8557c
	if (ctx.cr0.eq) goto loc_82C8557C;
	// lwz r11,8884(r31)
...
loc_82C8557C:
	...
	ctx.cr0.compare<uint32_t>(ctx.r3.u32, 0, ctx.xer);
	// beq 0x82c85594
	if (ctx.cr0.eq) goto loc_82C85594;
	// lwz r11,8884(r31)
	ctx.r11.u64 = PPC_LOAD_U32(ctx.r31.u32 + 8884);
	// mtctr r11
	ctx.ctr.u64 = ctx.r11.u64;
...
loc_82C85594:
	...
	ctx.cr0.compare<uint32_t>(ctx.r31.u32, 0, ctx.xer);
	// bne 0x82c855b0
	if (!ctx.cr0.eq) goto loc_82C855B0;
	// li r29,0
	ctx.r29.s64 = 0;
	// stw r29,396(r30)
...
loc_82C855B0:
	...
	ctx.cr6.compare<uint32_t>(ctx.r31.u32, ctx.r11.u32, ctx.xer);
	// ble cr6,0x82c855cc
	if (!ctx.cr6.gt) goto loc_82C855CC;
	// mr r3,r28
	ctx.r3.u64 = ctx.r28.u64;
loc_82C855CC:
	// bl 0x82b6e518
	...
	ctx.cr0.compare<int32_t>(ctx.r10.s32, 0, ctx.xer);
	// beq 0x82c8560c
	if (ctx.cr0.eq) goto loc_82C8560C;
	// addic. r9,r31,-1
	ctx.xer.ca = ctx.r31.u32 > 0;
	ctx.r9.s64 = ctx.r31.s64 + -1;
	ctx.cr0.compare<int32_t>(ctx.r9.s32, 0, ctx.xer);
	// blt 0x82c85610
	if (ctx.cr0.lt) goto loc_82C85610;
	// lis r8,-32256
	ctx.r8.s64 = -2113929216;
	// addi r11,r10,8
...
loc_82C855F0:
	...
	ctx.r11.s64 = ctx.r11.s64 + 12;
	// bge 0x82c855f0
	if (!ctx.cr0.lt) goto loc_82C855F0;
	// b 0x82c85610
	goto loc_82C85610;
loc_82C8560C:
	// mr r10,r29
...
loc_82C85610:
	...
	ctx.cr6.compare<uint32_t>(ctx.r11.u32, ctx.r9.u32, ctx.xer);
	// ble cr6,0x82c85630
	if (!ctx.cr6.gt) goto loc_82C85630;
	// mr r3,r28
	ctx.r3.u64 = ctx.r28.u64;
loc_82C85630:
	// bl 0x82b6e518
...
__attribute__((alias("__imp__sub_82C85644"))) PPC_WEAK_FUNC(sub_82C85644);
PPC_FUNC_IMPL(__imp__sub_82C85644) {
	PPC_FUNC_PROLOGUE();
	// .long 0x0
}
