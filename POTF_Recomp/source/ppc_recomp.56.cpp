...
PPC_FUNC_IMPL(__imp__sub_823D37F0) {
	...
	// lvx128 v0,r5,r29
	_mm_store_si128((__m128i*)ctx.v0.u8, _mm_shuffle_epi8(_mm_load_si128((__m128i*)(base + ((ctx.r5.u32 + ctx.r29.u32) & ~0xF))), _mm_load_si128((__m128i*)VectorMaskL)));
	// lvx128 v57,r0,r11
	...
	// lvx128 v13,r5,r28
	_mm_store_si128((__m128i*)ctx.v13.u8, _mm_shuffle_epi8(_mm_load_si128((__m128i*)(base + ((ctx.r5.u32 + ctx.r28.u32) & ~0xF))), _mm_load_si128((__m128i*)VectorMaskL)));
	// lvx128 v63,r0,r9
	...
	// lvx128 v51,r5,r27
	_mm_store_si128((__m128i*)ctx.v51.u8, _mm_shuffle_epi8(_mm_load_si128((__m128i*)(base + ((ctx.r5.u32 + ctx.r27.u32) & ~0xF))), _mm_load_si128((__m128i*)VectorMaskL)));
	// vmulfp128 v3,v53,v59
	ctx.fpscr.enableFlushModeUnconditional();
	_mm_store_ps(ctx.v3.f32, _mm_mul_ps(_mm_load_ps(ctx.v53.f32), _mm_load_ps(ctx.v59.f32)));
	// vspltw128 v6,v63,1
	...
	_mm_store_ps(ctx.v30.f32, _mm_mul_ps(_mm_load_ps(ctx.v50.f32), _mm_load_ps(ctx.v59.f32)));
	// vspltw128 v52,v62,0
	_mm_store_si128((__m128i*)ctx.v52.u32, _mm_shuffle_epi32(_mm_load_si128((__m128i*)ctx.v62.u32), 0xFF));
	// addi r5,r1,-96
	ctx.r5.s64 = ctx.r1.s64 + -96;
	// vmulfp128 v5,v54,v59
	_mm_store_ps(ctx.v5.f32, _mm_mul_ps(_mm_load_ps(ctx.v54.f32), _mm_load_ps(ctx.v59.f32)));
	// vspltw128 v4,v63,2
	...
	ctx.fpscr.enableFlushModeUnconditional();
	_mm_store_ps(ctx.v2.f32, _mm_mul_ps(_mm_load_ps(ctx.v52.f32), _mm_load_ps(ctx.v59.f32)));
	// vspltw128 v29,v61,1
	_mm_store_si128((__m128i*)ctx.v29.u32, _mm_shuffle_epi32(_mm_load_si128((__m128i*)ctx.v61.u32), 0xAA));
	// vspltw128 v28,v60,1
	...
	_mm_store_si128((__m128i*)ctx.v55.u8, _mm_perm_epi8_(_mm_load_si128((__m128i*)ctx.v57.u8), _mm_load_si128((__m128i*)ctx.v56.u8), _mm_load_si128((__m128i*)ctx.v7.u8)));
	// vmulfp128 v26,v49,v59
	ctx.fpscr.enableFlushModeUnconditional();
	_mm_store_ps(ctx.v26.f32, _mm_mul_ps(_mm_load_ps(ctx.v49.f32), _mm_load_ps(ctx.v59.f32)));
	// vspltw128 v27,v58,2
	_mm_store_si128((__m128i*)ctx.v27.u32, _mm_shuffle_epi32(_mm_load_si128((__m128i*)ctx.v58.u32), 0x55));
	// lvx128 v63,r0,r31
	...
	_mm_store_ps(ctx.v21.f32, _mm_add_ps(_mm_mul_ps(_mm_load_ps(ctx.v1.f32), _mm_load_ps(ctx.v0.f32)), _mm_load_ps(ctx.v3.f32)));
	// vspltw128 v23,v60,2
	_mm_store_si128((__m128i*)ctx.v23.u32, _mm_shuffle_epi32(_mm_load_si128((__m128i*)ctx.v60.u32), 0x55));
	// vmaddfp v18,v29,v0,v30
	_mm_store_ps(ctx.v18.f32, _mm_add_ps(_mm_mul_ps(_mm_load_ps(ctx.v29.f32), _mm_load_ps(ctx.v0.f32)), _mm_load_ps(ctx.v30.f32)));
	// vmaddfp v22,v6,v0,v5
	_mm_store_ps(ctx.v22.f32, _mm_add_ps(_mm_mul_ps(_mm_load_ps(ctx.v6.f32), _mm_load_ps(ctx.v0.f32)), _mm_load_ps(ctx.v5.f32)));
	// vmulfp128 v19,v48,v59
	_mm_store_ps(ctx.v19.f32, _mm_mul_ps(_mm_load_ps(ctx.v48.f32), _mm_load_ps(ctx.v59.f32)));
	...
	_mm_store_ps(ctx.v17.f32, _mm_add_ps(_mm_mul_ps(_mm_load_ps(ctx.v28.f32), _mm_load_ps(ctx.v0.f32)), _mm_load_ps(ctx.v26.f32)));
	// lvx128 v62,r0,r5
	...
	_mm_store_ps(ctx.v15.f32, _mm_add_ps(_mm_mul_ps(_mm_load_ps(ctx.v4.f32), _mm_load_ps(ctx.v13.f32)), _mm_load_ps(ctx.v22.f32)));
	// vspltw128 v16,v63,1
	...
	// vspltw128 v14,v55,1
	_mm_store_si128((__m128i*)ctx.v14.u32, _mm_shuffle_epi32(_mm_load_si128((__m128i*)ctx.v55.u32), 0xAA));
	// vmaddfp v10,v25,v13,v20
	_mm_store_ps(ctx.v10.f32, _mm_add_ps(_mm_mul_ps(_mm_load_ps(ctx.v25.f32), _mm_load_ps(ctx.v13.f32)), _mm_load_ps(ctx.v20.f32)));
	// vmulfp128 v9,v47,v59
	_mm_store_ps(ctx.v9.f32, _mm_mul_ps(_mm_load_ps(ctx.v47.f32), _mm_load_ps(ctx.v59.f32)));
	// vspltw128 v5,v62,1
	_mm_store_si128((__m128i*)ctx.v5.u32, _mm_shuffle_epi32(_mm_load_si128((__m128i*)ctx.v62.u32), 0xAA));
	// vmulfp128 v2,v46,v59
	_mm_store_ps(ctx.v2.f32, _mm_mul_ps(_mm_load_ps(ctx.v46.f32), _mm_load_ps(ctx.v59.f32)));
	// vspltw128 v11,v63,2
	_mm_store_si128((__m128i*)ctx.v11.u32, _mm_shuffle_epi32(_mm_load_si128((__m128i*)ctx.v63.u32), 0x55));
	// vmaddfp v7,v16,v0,v19
	_mm_store_ps(ctx.v7.f32, _mm_add_ps(_mm_mul_ps(_mm_load_ps(ctx.v16.f32), _mm_load_ps(ctx.v0.f32)), _mm_load_ps(ctx.v19.f32)));
	// vspltw128 v8,v55,2
	_mm_store_si128((__m128i*)ctx.v8.u32, _mm_shuffle_epi32(_mm_load_si128((__m128i*)ctx.v55.u32), 0x55));
	// vspltw128 v3,v62,2
	_mm_store_si128((__m128i*)ctx.v3.u32, _mm_shuffle_epi32(_mm_load_si128((__m128i*)ctx.v62.u32), 0x55));
	// vmaddfp v6,v24,v13,v18
	_mm_store_ps(ctx.v6.f32, _mm_add_ps(_mm_mul_ps(_mm_load_ps(ctx.v24.f32), _mm_load_ps(ctx.v13.f32)), _mm_load_ps(ctx.v18.f32)));
	// vmaddfp v4,v23,v13,v17
	_mm_store_ps(ctx.v4.f32, _mm_add_ps(_mm_mul_ps(_mm_load_ps(ctx.v23.f32), _mm_load_ps(ctx.v13.f32)), _mm_load_ps(ctx.v17.f32)));
	// li r9,4
	ctx.r9.s64 = 4;
	// li r10,8
	ctx.r10.s64 = 8;
	...
	_mm_store_ps(ctx.v45.f32, _mm_add_ps(_mm_load_ps(ctx.v15.f32), _mm_load_ps(ctx.v51.f32)));
	// vaddfp128 v44,v12,v51
	_mm_store_ps(ctx.v44.f32, _mm_add_ps(_mm_load_ps(ctx.v12.f32), _mm_load_ps(ctx.v51.f32)));
	// vaddfp128 v43,v10,v51
	_mm_store_ps(ctx.v43.f32, _mm_add_ps(_mm_load_ps(ctx.v10.f32), _mm_load_ps(ctx.v51.f32)));
	// vmaddfp v1,v14,v0,v9
	_mm_store_ps(ctx.v1.f32, _mm_add_ps(_mm_mul_ps(_mm_load_ps(ctx.v14.f32), _mm_load_ps(ctx.v0.f32)), _mm_load_ps(ctx.v9.f32)));
	// vmaddfp v30,v5,v0,v2
	_mm_store_ps(ctx.v30.f32, _mm_add_ps(_mm_mul_ps(_mm_load_ps(ctx.v5.f32), _mm_load_ps(ctx.v0.f32)), _mm_load_ps(ctx.v2.f32)));
	// vmaddfp v31,v11,v13,v7
	_mm_store_ps(ctx.v31.f32, _mm_add_ps(_mm_mul_ps(_mm_load_ps(ctx.v11.f32), _mm_load_ps(ctx.v13.f32)), _mm_load_ps(ctx.v7.f32)));
	// vaddfp128 v42,v6,v51
	_mm_store_ps(ctx.v42.f32, _mm_add_ps(_mm_load_ps(ctx.v6.f32), _mm_load_ps(ctx.v51.f32)));
	// vaddfp128 v41,v4,v51
	_mm_store_ps(ctx.v41.f32, _mm_add_ps(_mm_load_ps(ctx.v4.f32), _mm_load_ps(ctx.v51.f32)));
	// vminfp128 v40,v44,v45
	_mm_store_ps(ctx.v40.f32, _mm_min_ps(_mm_load_ps(ctx.v44.f32), _mm_load_ps(ctx.v45.f32)));
	// vmaxfp128 v39,v44,v45
	_mm_store_ps(ctx.v39.f32, _mm_max_ps(_mm_load_ps(ctx.v44.f32), _mm_load_ps(ctx.v45.f32)));
	// vmaddfp v29,v8,v13,v1
	_mm_store_ps(ctx.v29.f32, _mm_add_ps(_mm_mul_ps(_mm_load_ps(ctx.v8.f32), _mm_load_ps(ctx.v13.f32)), _mm_load_ps(ctx.v1.f32)));
	// vmaddfp v28,v3,v13,v30
	_mm_store_ps(ctx.v28.f32, _mm_add_ps(_mm_mul_ps(_mm_load_ps(ctx.v3.f32), _mm_load_ps(ctx.v13.f32)), _mm_load_ps(ctx.v30.f32)));
	// vaddfp128 v38,v31,v51
	_mm_store_ps(ctx.v38.f32, _mm_add_ps(_mm_load_ps(ctx.v31.f32), _mm_load_ps(ctx.v51.f32)));
	// vminfp128 v37,v43,v42
	_mm_store_ps(ctx.v37.f32, _mm_min_ps(_mm_load_ps(ctx.v43.f32), _mm_load_ps(ctx.v42.f32)));
	// vmaxfp128 v36,v43,v42
	_mm_store_ps(ctx.v36.f32, _mm_max_ps(_mm_load_ps(ctx.v43.f32), _mm_load_ps(ctx.v42.f32)));
	// vaddfp128 v35,v29,v51
	_mm_store_ps(ctx.v35.f32, _mm_add_ps(_mm_load_ps(ctx.v29.f32), _mm_load_ps(ctx.v51.f32)));
	// vaddfp128 v62,v28,v51
	_mm_store_ps(ctx.v62.f32, _mm_add_ps(_mm_load_ps(ctx.v28.f32), _mm_load_ps(ctx.v51.f32)));
	// vminfp128 v34,v41,v38
	_mm_store_ps(ctx.v34.f32, _mm_min_ps(_mm_load_ps(ctx.v41.f32), _mm_load_ps(ctx.v38.f32)));
	// vmaxfp128 v33,v41,v38
	_mm_store_ps(ctx.v33.f32, _mm_max_ps(_mm_load_ps(ctx.v41.f32), _mm_load_ps(ctx.v38.f32)));
	// vminfp128 v32,v40,v37
	_mm_store_ps(ctx.v32.f32, _mm_min_ps(_mm_load_ps(ctx.v40.f32), _mm_load_ps(ctx.v37.f32)));
	// vmaxfp128 v63,v39,v36
	_mm_store_ps(ctx.v63.f32, _mm_max_ps(_mm_load_ps(ctx.v39.f32), _mm_load_ps(ctx.v36.f32)));
	// vminfp128 v61,v62,v35
	_mm_store_ps(ctx.v61.f32, _mm_min_ps(_mm_load_ps(ctx.v62.f32), _mm_load_ps(ctx.v35.f32)));
	// vmaxfp128 v60,v62,v35
	_mm_store_ps(ctx.v60.f32, _mm_max_ps(_mm_load_ps(ctx.v62.f32), _mm_load_ps(ctx.v35.f32)));
	// vminfp128 v59,v34,v61
	_mm_store_ps(ctx.v59.f32, _mm_min_ps(_mm_load_ps(ctx.v34.f32), _mm_load_ps(ctx.v61.f32)));
	// vmaxfp128 v58,v33,v60
	_mm_store_ps(ctx.v58.f32, _mm_max_ps(_mm_load_ps(ctx.v33.f32), _mm_load_ps(ctx.v60.f32)));
	// vminfp128 v57,v32,v59
	_mm_store_ps(ctx.v57.f32, _mm_min_ps(_mm_load_ps(ctx.v32.f32), _mm_load_ps(ctx.v59.f32)));
	// vmaxfp128 v56,v63,v58
	_mm_store_ps(ctx.v56.f32, _mm_max_ps(_mm_load_ps(ctx.v63.f32), _mm_load_ps(ctx.v58.f32)));
	// vspltw128 v55,v57,0
	_mm_store_si128((__m128i*)ctx.v55.u32, _mm_shuffle_epi32(_mm_load_si128((__m128i*)ctx.v57.u32), 0xFF));
	// vspltw128 v54,v57,1
	_mm_store_si128((__m128i*)ctx.v54.u32, _mm_shuffle_epi32(_mm_load_si128((__m128i*)ctx.v57.u32), 0xAA));
	// vspltw128 v53,v57,2
	_mm_store_si128((__m128i*)ctx.v53.u32, _mm_shuffle_epi32(_mm_load_si128((__m128i*)ctx.v57.u32), 0x55));
	// vspltw128 v52,v56,0
	_mm_store_si128((__m128i*)ctx.v52.u32, _mm_shuffle_epi32(_mm_load_si128((__m128i*)ctx.v56.u32), 0xFF));
	// vspltw128 v51,v56,1
	_mm_store_si128((__m128i*)ctx.v51.u32, _mm_shuffle_epi32(_mm_load_si128((__m128i*)ctx.v56.u32), 0xAA));
	// vspltw128 v50,v56,2
	_mm_store_si128((__m128i*)ctx.v50.u32, _mm_shuffle_epi32(_mm_load_si128((__m128i*)ctx.v56.u32), 0x55));
	// stvewx128 v55,r0,r3
	ea = (ctx.r3.u32) & ~0x3;
...
__attribute__((alias("__imp__sub_823DA3B0"))) PPC_WEAK_FUNC(sub_823DA3B0);
PPC_FUNC_IMPL(__imp__sub_823DA3B0) {
	PPC_FUNC_PROLOGUE();
	// blr 
	return;
}

__attribute__((alias("__imp__sub_823DA3B4"))) PPC_WEAK_FUNC(sub_823DA3B4);
PPC_FUNC_IMPL(__imp__sub_823DA3B4) {
	PPC_FUNC_PROLOGUE();
	// .long 0x0
}

__attribute__((alias("__imp__sub_823DA3B8"))) PPC_WEAK_FUNC(sub_823DA3B8);
PPC_FUNC_IMPL(__imp__sub_823DA3B8) {
	PPC_FUNC_PROLOGUE();
	// lis r10,-31885
	ctx.r10.s64 = -2089615360;
	// lwz r11,28928(r10)
...
__attribute__((alias("__imp__sub_823DA3CC"))) PPC_WEAK_FUNC(sub_823DA3CC);
PPC_FUNC_IMPL(__imp__sub_823DA3CC) {
	PPC_FUNC_PROLOGUE();
	// .long 0x0
}

__attribute__((alias("__imp__sub_823DA3D0"))) PPC_WEAK_FUNC(sub_823DA3D0);
PPC_FUNC_IMPL(__imp__sub_823DA3D0) {
	...
	PPC_STORE_U32(ctx.r31.u32 + 12, ctx.r11.u32);
	// beq cr6,0x823da494
	if (ctx.cr6.eq) goto loc_823DA494;
	// lwz r3,80(r1)
	ctx.r3.u64 = PPC_LOAD_U32(ctx.r1.u32 + 80);
	// lis r10,-31885
	ctx.r10.s64 = -2089615360;
	...
	ctx.r11.s64 = 0;
	// ld r9,76(r3)
	ctx.r9.u64 = PPC_LOAD_U64(ctx.r3.u32 + 76);
	// stw r11,28924(r10)
	PPC_STORE_U32(ctx.r10.u32 + 28924, ctx.r11.u32);
	// rlwinm r8,r9,0,23,23
	ctx.r8.u64 = __builtin_rotateleft64(ctx.r9.u32 | (ctx.r9.u64 << 32), 0) & 0x100;
	// cmpldi cr6,r8,0
	ctx.cr6.compare<uint64_t>(ctx.r8.u64, 0, ctx.xer);
	// beq cr6,0x823da460
	if (ctx.cr6.eq) goto loc_823DA460;
	// lwz r11,24(r31)
	ctx.r11.u64 = PPC_LOAD_U32(ctx.r31.u32 + 24);
	// lwz r10,0(r11)
	ctx.r10.u64 = PPC_LOAD_U32(ctx.r11.u32 + 0);
...
loc_823DA440:
	...
	ctx.cr6.compare<uint32_t>(ctx.r10.u32, ctx.r3.u32, ctx.xer);
	// bne cr6,0x823da440
	if (!ctx.cr6.eq) goto loc_823DA440;
loc_823DA450:
	// lwz r11,4(r11)
	ctx.r11.u64 = PPC_LOAD_U32(ctx.r11.u32 + 4);
	// lis r10,-31885
...
loc_823DA460:
	...
	ctx.r4.u64 = ctx.r30.u64;
	// stw r5,28920(r9)
	PPC_STORE_U32(ctx.r9.u32 + 28920, ctx.r5.u32);
	// lwz r11,328(r31)
...
__attribute__((alias("__imp__sub_823DA4AC"))) PPC_WEAK_FUNC(sub_823DA4AC);
PPC_FUNC_IMPL(__imp__sub_823DA4AC) {
	PPC_FUNC_PROLOGUE();
	// .long 0x0
}

__attribute__((alias("__imp__sub_823DA4B0"))) PPC_WEAK_FUNC(sub_823DA4B0);
PPC_FUNC_IMPL(__imp__sub_823DA4B0) {
	PPC_FUNC_PROLOGUE();
	// lwz r10,12(r4)
...
__attribute__((alias("__imp__sub_823DA4CC"))) PPC_WEAK_FUNC(sub_823DA4CC);
PPC_FUNC_IMPL(__imp__sub_823DA4CC) {
	PPC_FUNC_PROLOGUE();
	// .long 0x0
}

__attribute__((alias("__imp__sub_823DA4D0"))) PPC_WEAK_FUNC(sub_823DA4D0);
