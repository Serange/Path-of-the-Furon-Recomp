...
__attribute__((alias("__imp__sub_82BDE624"))) PPC_WEAK_FUNC(sub_82BDE624);
PPC_FUNC_IMPL(__imp__sub_82BDE624) {
	PPC_FUNC_PROLOGUE();
	// .long 0x0
}

__attribute__((alias("__imp__sub_82BDE628"))) PPC_WEAK_FUNC(sub_82BDE628);
PPC_FUNC_IMPL(__imp__sub_82BDE628) {
	PPC_FUNC_PROLOGUE();
	// lwz r11,24(r3)
	ctx.r11.u64 = PPC_LOAD_U32(ctx.r3.u32 + 24);
	// lwz r10,4(r11)
	...
	ctx.cr6.compare<int32_t>(ctx.r10.s32, ctx.r4.s32, ctx.xer);
	// bne cr6,0x82bde640
	if (!ctx.cr6.eq) goto loc_82BDE640;
	// lwz r3,16(r3)
	ctx.r3.u64 = PPC_LOAD_U32(ctx.r3.u32 + 16);
	// blr 
	return;
