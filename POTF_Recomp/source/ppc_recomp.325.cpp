...
__attribute__((alias("__imp__sub_82AAB100"))) PPC_WEAK_FUNC(sub_82AAB100);
...
__attribute__((alias("__imp__sub_82AAB120"))) PPC_WEAK_FUNC(sub_82AAB120);
PPC_FUNC_IMPL(__imp__sub_82AAB120) {
	PPC_FUNC_PROLOGUE();
	uint32_t ea{};
	// mflr r12
	ctx.r12.u64 = ctx.lr;
	...
	ctx.cr6.compare<uint32_t>(ctx.r31.u32, ctx.r11.u32, ctx.xer);
	// ble cr6,0x82aab174
	if (!ctx.cr6.gt) goto loc_82AAB174;
loc_82AAB16C:
	// mr r3,r31
	ctx.r3.u64 = ctx.r31.u64;
	// bl 0x82294a58
