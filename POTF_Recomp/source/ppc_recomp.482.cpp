...
PPC_FUNC_IMPL(__imp__sub_82F39FF0) {
	...
	ctx.r28.u64 = ctx.r11.u32 & 0xFFFFF;
	// beq cr6,0x82f3a160
	if (ctx.cr6.eq) goto loc_82F3A160;
	// cmplw cr6,r25,r24
	ctx.cr6.compare<uint32_t>(ctx.r25.u32, ctx.r24.u32, ctx.xer);
	// beq cr6,0x82f3a098
	...
	ctx.cr6.compare<uint32_t>(ctx.r25.u32, ctx.r11.u32, ctx.xer);
	// beq cr6,0x82f3a08c
	if (ctx.cr6.eq) goto loc_82F3A08C;
	// lis r11,29536
	ctx.r11.s64 = 1935671296;
	// cmplw cr6,r25,r11
	ctx.cr6.compare<uint32_t>(ctx.r25.u32, ctx.r11.u32, ctx.xer);
	...
	ctx.cr6.compare<uint32_t>(ctx.r25.u32, ctx.r11.u32, ctx.xer);
	// beq cr6,0x82f3a074
	if (ctx.cr6.eq) goto loc_82F3A074;
	// lis r11,29568
	ctx.r11.s64 = 1937768448;
	// cmplw cr6,r25,r11
	ctx.cr6.compare<uint32_t>(ctx.r25.u32, ctx.r11.u32, ctx.xer);
	// beq cr6,0x82f3a068
	if (ctx.cr6.eq) goto loc_82F3A068;
loc_82F3A060:
	// li r3,0
	ctx.r3.s64 = 0;
	// b 0x82f3a474
...
loc_82F3A098:
	...
	// beq 0x82f3a158
	if (ctx.cr0.eq) goto loc_82F3A158;
	// lwz r3,0(r31)
	ctx.r3.u64 = PPC_LOAD_U32(ctx.r31.u32 + 0);
	// cmplwi cr6,r3,0
	ctx.cr6.compare<uint32_t>(ctx.r3.u32, 0, ctx.xer);
	// beq cr6,0x82f3a138
	if (ctx.cr6.eq) goto loc_82F3A138;
	// li r4,105
	ctx.r4.s64 = 105;
	// bl 0x82cb80a0
	ctx.lr = 0x82F3A0E8;
	...
	ctx.cr0.compare<uint32_t>(ctx.r3.u32, 0, ctx.xer);
	// bne 0x82f3a138
	if (!ctx.cr0.eq) goto loc_82F3A138;
	// li r4,73
	ctx.r4.s64 = 73;
	// lwz r3,0(r31)
	ctx.r3.u64 = PPC_LOAD_U32(ctx.r31.u32 + 0);
...
loc_82F3A138:
	...
	ctx.cr6.compare<int32_t>(ctx.r11.s32, -1, ctx.xer);
	// beq cr6,0x82f3a290
	if (ctx.cr6.eq) goto loc_82F3A290;
loc_82F3A158:
	// oris r30,r29,29616
...
loc_82F3A160:
	...
	ctx.cr6.compare<uint32_t>(ctx.r25.u32, ctx.r24.u32, ctx.xer);
	// beq cr6,0x82f3a1c8
	if (ctx.cr6.eq) goto loc_82F3A1C8;
	// lis r11,29520
	ctx.r11.s64 = 1934622720;
	// cmplw cr6,r25,r11
	ctx.cr6.compare<uint32_t>(ctx.r25.u32, ctx.r11.u32, ctx.xer);
	// beq cr6,0x82f3a1bc
	if (ctx.cr6.eq) goto loc_82F3A1BC;
	// lis r11,29536
	ctx.r11.s64 = 1935671296;
	// cmplw cr6,r25,r11
	ctx.cr6.compare<uint32_t>(ctx.r25.u32, ctx.r11.u32, ctx.xer);
	// beq cr6,0x82f3a1b0
	if (ctx.cr6.eq) goto loc_82F3A1B0;
	// lis r11,29552
	ctx.r11.s64 = 1936719872;
	// cmplw cr6,r25,r11
	ctx.cr6.compare<uint32_t>(ctx.r25.u32, ctx.r11.u32, ctx.xer);
	// beq cr6,0x82f3a1a4
	if (ctx.cr6.eq) goto loc_82F3A1A4;
	// lis r11,29568
	ctx.r11.s64 = 1937768448;
	// cmplw cr6,r25,r11
	ctx.cr6.compare<uint32_t>(ctx.r25.u32, ctx.r11.u32, ctx.xer);
	// bne cr6,0x82f3a060
	if (!ctx.cr6.eq) goto loc_82F3A060;
	// clrlwi r11,r28,12
	ctx.r11.u64 = ctx.r28.u32 & 0xFFFFF;
	// oris r30,r11,29696
...
loc_82F3A1C8:
	...
	ctx.cr0.compare<uint32_t>(ctx.r11.u32, 0, ctx.xer);
	// beq 0x82f3a288
	if (ctx.cr0.eq) goto loc_82F3A288;
	// lwz r3,0(r31)
	ctx.r3.u64 = PPC_LOAD_U32(ctx.r31.u32 + 0);
	// cmplwi cr6,r3,0
	ctx.cr6.compare<uint32_t>(ctx.r3.u32, 0, ctx.xer);
	// beq cr6,0x82f3a268
	if (ctx.cr6.eq) goto loc_82F3A268;
	// li r4,105
	ctx.r4.s64 = 105;
	// bl 0x82cb80a0
	ctx.lr = 0x82F3A218;
	...
	ctx.cr0.compare<uint32_t>(ctx.r3.u32, 0, ctx.xer);
	// bne 0x82f3a268
	if (!ctx.cr0.eq) goto loc_82F3A268;
	// li r4,73
	ctx.r4.s64 = 73;
	// lwz r3,0(r31)
	ctx.r3.u64 = PPC_LOAD_U32(ctx.r31.u32 + 0);
...
loc_82F3A290:
	...
	ctx.cr0.compare<uint32_t>(ctx.r3.u32, 0, ctx.xer);
	// beq 0x82f3a2ac
	if (ctx.cr0.eq) goto loc_82F3A2AC;
	// bl 0x82f4b940
	ctx.lr = 0x82F3A2A4;
	sub_82F4B940(ctx, base);
	// mr r31,r3
...
loc_82F3A2B0:
	...
	ctx.cr6.compare<uint32_t>(ctx.r25.u32, ctx.r24.u32, ctx.xer);
	// bne cr6,0x82f3a2d4
	if (!ctx.cr6.eq) goto loc_82F3A2D4;
	// cmpwi cr6,r23,0
	ctx.cr6.compare<int32_t>(ctx.r23.s32, 0, ctx.xer);
	// bne cr6,0x82f3a2d4
	if (!ctx.cr6.eq) goto loc_82F3A2D4;
...
loc_82F3A2DC:
	...
	ctx.r3.u64 = ctx.r31.u64;
	// bge cr6,0x82f3a308
	if (!ctx.cr6.lt) goto loc_82F3A308;
loc_82F3A2F8:
	// bl 0x82f4b990
	ctx.lr = 0x82F3A2FC;
	sub_82F4B990(ctx, base);
...
loc_82F3A308:
	...
	ctx.cr0.compare<int32_t>(ctx.r3.s32, 0, ctx.xer);
	// bge 0x82f3a320
	if (!ctx.cr0.lt) goto loc_82F3A320;
loc_82F3A318:
	// mr r3,r31
	ctx.r3.u64 = ctx.r31.u64;
	// b 0x82f3a2f8
...
loc_82F3A320:
	...
	ctx.f31.u64 = PPC_LOAD_U64(ctx.r11.u32 + -18344);
	// beq cr6,0x82f3a348
	if (ctx.cr6.eq) goto loc_82F3A348;
	// lwz r11,12(r26)
...
loc_82F3A3AC:
	...
	ctx.cr6.compare<int32_t>(ctx.r23.s32, 0, ctx.xer);
	// beq cr6,0x82f3a470
	if (ctx.cr6.eq) goto loc_82F3A470;
	// lwz r11,8(r27)
	ctx.r11.u64 = PPC_LOAD_U32(ctx.r27.u32 + 8);
	// li r5,0
	ctx.r5.s64 = 0;
	...
	ctx.cr6.compare<uint32_t>(ctx.r11.u32, 0, ctx.xer);
	// ble cr6,0x82f3a438
	if (!ctx.cr6.gt) goto loc_82F3A438;
	// lwz r8,16(r27)
	ctx.r8.u64 = PPC_LOAD_U32(ctx.r27.u32 + 16);
	// lwz r10,20(r27)
	ctx.r10.u64 = PPC_LOAD_U32(ctx.r27.u32 + 20);
loc_82F3A3E4:
	...
	ctx.cr0.compare<int32_t>(ctx.r7.s32, 0, ctx.xer);
	// beq 0x82f3a41c
	if (ctx.cr0.eq) goto loc_82F3A41C;
	// lfd f0,32(r11)
	ctx.fpscr.disableFlushMode();
	ctx.f0.u64 = PPC_LOAD_U64(ctx.r11.u32 + 32);
	// fcmpu cr6,f0,f31
	ctx.cr6.compare(ctx.f0.f64, ctx.f31.f64);
	// beq cr6,0x82f3a434
	if (ctx.cr6.eq) goto loc_82F3A434;
	// lwz r11,12(r11)
	ctx.r11.u64 = PPC_LOAD_U32(ctx.r11.u32 + 12);
	// cmplw cr6,r11,r5
	ctx.cr6.compare<uint32_t>(ctx.r11.u32, ctx.r5.u32, ctx.xer);
	// blt cr6,0x82f3a41c
	if (ctx.cr6.lt) goto loc_82F3A41C;
	// addi r5,r11,1
...
loc_82F3A41C:
	...
	// blt cr6,0x82f3a3e4
	if (ctx.cr6.lt) goto loc_82F3A3E4;
	// b 0x82f3a438
	goto loc_82F3A438;
loc_82F3A434:
	// stw r9,396(r27)
...
loc_82F3A438:
	...
	ctx.cr6.compare<int32_t>(ctx.r11.s32, -1, ctx.xer);
	// bne cr6,0x82f3a45c
	if (!ctx.cr6.eq) goto loc_82F3A45C;
	// li r6,0
	ctx.r6.s64 = 0;
	// lwz r4,120(r27)
...
loc_82F3A45C:
	...
	ctx.cr6.compare<int32_t>(ctx.r11.s32, -1, ctx.xer);
	// beq cr6,0x82f3a318
	if (ctx.cr6.eq) goto loc_82F3A318;
	// lwz r10,8(r31)
	ctx.r10.u64 = PPC_LOAD_U32(ctx.r31.u32 + 8);
	// stw r11,4(r10)
	PPC_STORE_U32(ctx.r10.u32 + 4, ctx.r11.u32);
