...
__attribute__((alias("__imp__sub_8254474C"))) PPC_WEAK_FUNC(sub_8254474C);
PPC_FUNC_IMPL(__imp__sub_8254474C) {
	PPC_FUNC_PROLOGUE();
	// .long 0x0
}

__attribute__((alias("__imp__sub_82544750"))) PPC_WEAK_FUNC(sub_82544750);
PPC_FUNC_IMPL(__imp__sub_82544750) {
	PPC_FUNC_PROLOGUE();
	// b 0x82538df0
...
__attribute__((alias("__imp__sub_82544754"))) PPC_WEAK_FUNC(sub_82544754);
PPC_FUNC_IMPL(__imp__sub_82544754) {
	PPC_FUNC_PROLOGUE();
	// .long 0x0
}
...
__attribute__((alias("__imp__sub_82548154"))) PPC_WEAK_FUNC(sub_82548154);
PPC_FUNC_IMPL(__imp__sub_82548154) {
	PPC_FUNC_PROLOGUE();
	// .long 0x0
}
...
PPC_FUNC_IMPL(__imp__sub_82548158) {
	...
	ctx.cr6.compare<int32_t>(ctx.r29.s32, 0, ctx.xer);
	// blt cr6,0x825481dc
	if (ctx.cr6.lt) goto loc_825481DC;
	// lwz r11,84(r1)
	ctx.r11.u64 = PPC_LOAD_U32(ctx.r1.u32 + 84);
	// cmpw cr6,r29,r11
	ctx.cr6.compare<int32_t>(ctx.r29.s32, ctx.r11.s32, ctx.xer);
	...
	// bne cr6,0x825481d4
	if (!ctx.cr6.eq) goto loc_825481D4;
	// stw r31,4(r30)
	PPC_STORE_U32(ctx.r30.u32 + 4, ctx.r31.u32);
	// b 0x825481d8
	goto loc_825481D8;
