...
__attribute__((alias("__imp__sub_82893250"))) PPC_WEAK_FUNC(sub_82893250);
PPC_FUNC_IMPL(__imp__sub_82893250) {
	PPC_FUNC_PROLOGUE();
	PPCRegister temp{};
	// lwz r11,16(r3)
	ctx.r11.u64 = PPC_LOAD_U32(ctx.r3.u32 + 16);
	...
	ctx.cr6.compare<uint32_t>(ctx.r11.u32, ctx.r10.u32, ctx.xer);
	// bge cr6,0x82893268
	if (!ctx.cr6.lt) goto loc_82893268;
loc_82893260:
	// li r3,-1
	ctx.r3.s64 = -1;
	// blr 
...
loc_82893268:
	// ble cr6,0x82893274
	if (!ctx.cr6.gt) goto loc_82893274;
loc_8289326C:
	// li r3,1
	ctx.r3.s64 = 1;
	// blr 
...
loc_82893274:
	...
	ctx.cr6.compare<uint32_t>(ctx.r11.u32, ctx.r10.u32, ctx.xer);
	// blt cr6,0x82893260
	if (ctx.cr6.lt) goto loc_82893260;
	// bgt cr6,0x8289326c
	if (ctx.cr6.gt) goto loc_8289326C;
	// lwz r11,4(r3)
	ctx.r11.u64 = PPC_LOAD_U32(ctx.r3.u32 + 4);
	// lwz r10,4(r4)
	ctx.r10.u64 = PPC_LOAD_U32(ctx.r4.u32 + 4);
