...
__attribute__((alias("__imp__sub_823BB4B8"))) PPC_WEAK_FUNC(sub_823BB4B8);
PPC_FUNC_IMPL(__imp__sub_823BB4B8) {
	PPC_FUNC_PROLOGUE();
	uint32_t ea{};
	// mflr r12
	ctx.r12.u64 = ctx.lr;
...
__attribute__((alias("__imp__sub_823BB4FC"))) PPC_WEAK_FUNC(sub_823BB4FC);
PPC_FUNC_IMPL(__imp__sub_823BB4FC) {
	PPC_FUNC_PROLOGUE();
	// .long 0x0
}
...
PPC_FUNC_IMPL(__imp__sub_823BB500) {
	...
	ctx.r3.u64 = __builtin_rotateleft64(ctx.r11.u32 | (ctx.r11.u64 << 32), 2) & 0xFFFFFFFC;
	// ble cr6,0x823bb52c
	if (!ctx.cr6.gt) goto loc_823BB52C;
	// li r3,-1
	ctx.r3.s64 = -1;
loc_823BB52C:
	// li r4,8
	...
	ctx.cr6.compare<int32_t>(ctx.r10.s32, 0, ctx.xer);
	// ble cr6,0x823bb568
	if (!ctx.cr6.gt) goto loc_823BB568;
	// mr r10,r30
	ctx.r10.u64 = ctx.r30.u64;
loc_823BB550:
	// addi r11,r11,1
	...
	ctx.cr6.compare<int32_t>(ctx.r11.s32, ctx.r8.s32, ctx.xer);
	// blt cr6,0x823bb550
	if (ctx.cr6.lt) goto loc_823BB550;
loc_823BB568:
	// lwz r9,0(r31)
	ctx.r9.u64 = PPC_LOAD_U32(ctx.r31.u32 + 0);
	// cmplwi cr6,r9,0
	ctx.cr6.compare<uint32_t>(ctx.r9.u32, 0, ctx.xer);
	// beq cr6,0x823bb640
	if (ctx.cr6.eq) goto loc_823BB640;
	// lis r11,-25033
	ctx.r11.s64 = -1640562688;
	// ori r7,r11,31161
	ctx.r7.u64 = ctx.r11.u64 | 31161;
loc_823BB57C:
	...
	ctx.cr6.compare<uint32_t>(ctx.r10.u32, 0, ctx.xer);
	// beq cr6,0x823bb630
	if (ctx.cr6.eq) goto loc_823BB630;
	// stw r8,4(r10)
	PPC_STORE_U32(ctx.r10.u32 + 4, ctx.r8.u32);
loc_823BB630:
	// stw r9,0(r11)
	...
	ctx.cr6.compare<uint32_t>(ctx.r9.u32, 0, ctx.xer);
	// bne cr6,0x823bb57c
	if (!ctx.cr6.eq) goto loc_823BB57C;
loc_823BB640:
	// lwz r28,8(r31)
	ctx.r28.u64 = PPC_LOAD_U32(ctx.r31.u32 + 8);
	// cmplwi cr6,r28,0
	ctx.cr6.compare<uint32_t>(ctx.r28.u32, 0, ctx.xer);
	// beq cr6,0x823bb678
	if (ctx.cr6.eq) goto loc_823BB678;
	// lis r29,-31885
	ctx.r29.s64 = -2089615360;
	// lwz r3,28888(r29)
	ctx.r3.u64 = PPC_LOAD_U32(ctx.r29.u32 + 28888);
	...
	ctx.cr6.compare<uint32_t>(ctx.r3.u32, 0, ctx.xer);
	// bne cr6,0x823bb664
	if (!ctx.cr6.eq) goto loc_823BB664;
	// bl 0x822900a0
	ctx.lr = 0x823BB660;
	sub_822900A0(ctx, base);
	// lwz r3,28888(r29)
...
__attribute__((alias("__imp__sub_823BB684"))) PPC_WEAK_FUNC(sub_823BB684);
PPC_FUNC_IMPL(__imp__sub_823BB684) {
	PPC_FUNC_PROLOGUE();
	// .long 0x0
}
...
__attribute__((alias("__imp__sub_823BB6A8"))) PPC_WEAK_FUNC(sub_823BB6A8);
PPC_FUNC_IMPL(__imp__sub_823BB6A8) {
	PPC_FUNC_PROLOGUE();
	// lwz r11,0(r3)
	ctx.r11.u64 = PPC_LOAD_U32(ctx.r3.u32 + 0);
	// rlwinm r10,r4,4,0,27
