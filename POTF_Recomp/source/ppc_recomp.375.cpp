...
__attribute__((alias("__imp__sub_82BE31F0"))) PPC_WEAK_FUNC(sub_82BE31F0);
PPC_FUNC_IMPL(__imp__sub_82BE31F0) {
	PPC_FUNC_PROLOGUE();
	// addi r3,r3,12
	ctx.r3.s64 = ctx.r3.s64 + 12;
	// b 0x82bd5630
...
__attribute__((alias("__imp__sub_82BE31F8"))) PPC_WEAK_FUNC(sub_82BE31F8);
PPC_FUNC_IMPL(__imp__sub_82BE31F8) {
	PPC_FUNC_PROLOGUE();
	// lwz r11,12(r3)
	ctx.r11.u64 = PPC_LOAD_U32(ctx.r3.u32 + 12);
	// cmplwi cr6,r11,0
	ctx.cr6.compare<uint32_t>(ctx.r11.u32, 0, ctx.xer);
	// beq cr6,0x82be3218
	if (ctx.cr6.eq) goto loc_82BE3218;
	// lwz r10,0(r11)
	ctx.r10.u64 = PPC_LOAD_U32(ctx.r11.u32 + 0);
	// mr r3,r11
	ctx.r3.u64 = ctx.r11.u64;
