...
__attribute__((alias("__imp__sub_8255FFA0"))) PPC_WEAK_FUNC(sub_8255FFA0);
PPC_FUNC_IMPL(__imp__sub_8255FFA0) {
	PPC_FUNC_PROLOGUE();
	uint32_t ea{};
	// mflr r12
	ctx.r12.u64 = ctx.lr;
...
loc_8255FFF0:
	// lwz r3,-19732(r31)
	ctx.r3.u64 = PPC_LOAD_U32(ctx.r31.u32 + -19732);
loc_8255FFF4:
	// cmplwi cr6,r3,0
	ctx.cr6.compare<uint32_t>(ctx.r3.u32, 0, ctx.xer);
	// beq cr6,0x82560030
	if (ctx.cr6.eq) goto loc_82560030;
	// clrlwi r11,r29,24
	ctx.r11.u64 = ctx.r29.u32 & 0xFF;
	// cmplwi cr6,r11,3
	ctx.cr6.compare<uint32_t>(ctx.r11.u32, 3, ctx.xer);
	// bgt cr6,0x82560030
	if (ctx.cr6.gt) goto loc_82560030;
	// lwz r10,68(r3)
	ctx.r10.u64 = PPC_LOAD_U32(ctx.r3.u32 + 68);
	// rlwinm r9,r11,3,0,28
	ctx.r9.u64 = __builtin_rotateleft64(ctx.r11.u32 | (ctx.r11.u64 << 32), 3) & 0xFFFFFFF8;
...
__attribute__((alias("__imp__sub_8256004C"))) PPC_WEAK_FUNC(sub_8256004C);
PPC_FUNC_IMPL(__imp__sub_8256004C) {
	PPC_FUNC_PROLOGUE();
	// .long 0x0
}
