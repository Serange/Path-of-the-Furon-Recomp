...
__attribute__((alias("__imp__sub_82809D58"))) PPC_WEAK_FUNC(sub_82809D58);
PPC_FUNC_IMPL(__imp__sub_82809D58) {
	PPC_FUNC_PROLOGUE();
	uint32_t ea{};
	// mflr r12
	ctx.r12.u64 = ctx.lr;
	...
	ctx.cr6.compare<uint32_t>(ctx.r28.u32, ctx.r31.u32, ctx.xer);
	// beq cr6,0x82809df0
	if (ctx.cr6.eq) goto loc_82809DF0;
	// lwz r4,4(r31)
	ctx.r4.u64 = PPC_LOAD_U32(ctx.r31.u32 + 4);
	// cmpwi cr6,r4,0
	ctx.cr6.compare<int32_t>(ctx.r4.s32, 0, ctx.xer);
	// ble cr6,0x82809de8
	if (!ctx.cr6.gt) goto loc_82809DE8;
	// bl 0x827f9a18
	ctx.lr = 0x82809D84;
	sub_827F9A18(ctx, base);
	// lwz r11,4(r31)
	...
	ctx.cr6.compare<int32_t>(ctx.r11.s32, 0, ctx.xer);
	// ble cr6,0x82809df0
	if (!ctx.cr6.gt) goto loc_82809DF0;
	// li r30,0
	ctx.r30.s64 = 0;
loc_82809D98:
	// mr r4,r28
...
loc_82809DCC:
	...
	ctx.cr6.compare<int32_t>(ctx.r29.s32, ctx.r11.s32, ctx.xer);
	// blt cr6,0x82809d98
	if (ctx.cr6.lt) goto loc_82809D98;
	// addi r1,r1,128
	ctx.r1.s64 = ctx.r1.s64 + 128;
	// b 0x82cb1138
	__restgprlr_28(ctx, base);
