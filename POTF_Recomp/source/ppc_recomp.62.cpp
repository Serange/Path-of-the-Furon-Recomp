...
__attribute__((alias("__imp__sub_82404F04"))) PPC_WEAK_FUNC(sub_82404F04);
PPC_FUNC_IMPL(__imp__sub_82404F04) {
	PPC_FUNC_PROLOGUE();
	// .long 0x0
}
...
__attribute__((alias("__imp__sub_8240540C"))) PPC_WEAK_FUNC(sub_8240540C);
PPC_FUNC_IMPL(__imp__sub_8240540C) {
	PPC_FUNC_PROLOGUE();
	// .long 0x0
}
...
loc_824066C4:
	...
	_mm_store_ps(ctx.v59.f32, _mm_blend_ps(_mm_load_ps(ctx.v59.f32), _mm_permute_ps(_mm_load_ps(ctx.v52.f32), 57), 4));
	...
	_mm_store_ps(ctx.v60.f32, _mm_blend_ps(_mm_load_ps(ctx.v60.f32), _mm_permute_ps(_mm_load_ps(ctx.v59.f32), 78), 3));
	// vrlimi128 v62,v55,3,2
	_mm_store_ps(ctx.v62.f32, _mm_blend_ps(_mm_load_ps(ctx.v62.f32), _mm_permute_ps(_mm_load_ps(ctx.v55.f32), 78), 3));
	// stvx128 v53,r3,r30
	_mm_store_si128((__m128i*)(base + ((ctx.r3.u32 + ctx.r30.u32) & ~0xF)), _mm_shuffle_epi8(_mm_load_si128((__m128i*)ctx.v53.u8), _mm_load_si128((__m128i*)VectorMaskL)));
	// stvx128 v60,r0,r3
