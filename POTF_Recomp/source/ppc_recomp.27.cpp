...
loc_8232F774:
	...
	// mulhd r7,r31,r3
	ctx.r7.u64 = (ctx.r31.u64 * ctx.r3.u64) >> 64;
	// sradi r9,r7,2
...
__attribute__((alias("__imp__sub_82333098"))) PPC_WEAK_FUNC(sub_82333098);
PPC_FUNC_IMPL(__imp__sub_82333098) {
	...
	ctx.cr6.compare<uint32_t>(ctx.r3.u32, 0, ctx.xer);
	// beq cr6,0x82333150
	if (ctx.cr6.eq) goto loc_82333150;
	// li r30,0
	ctx.r30.s64 = 0;
	// addi r3,r1,96
	ctx.r3.s64 = ctx.r1.s64 + 96;
...
loc_82333184:
	...
	// bne cr6,0x823331a8
	if (!ctx.cr6.eq) goto loc_823331A8;
loc_8233319C:
	// addi r11,r11,2
	ctx.r11.s64 = ctx.r11.s64 + 2;
	// stw r11,0(r31)
...
loc_823331A8:
	...
	ctx.cr6.compare<int32_t>(ctx.r3.s32, 0, ctx.xer);
	// bne cr6,0x8233323c
	if (!ctx.cr6.eq) goto loc_8233323C;
	// mr r3,r30
	ctx.r3.u64 = ctx.r30.u64;
	// bl 0x82cb0ec8
	ctx.lr = 0x823331D4;
...
loc_823331F4:
	...
	ctx.cr6.compare<uint32_t>(ctx.r10.u32, 9, ctx.xer);
	// bne cr6,0x82333218
	if (!ctx.cr6.eq) goto loc_82333218;
loc_8233320C:
	// addi r11,r11,2
	ctx.r11.s64 = ctx.r11.s64 + 2;
	// stw r11,0(r31)
