...
__attribute__((alias("__imp__sub_8235FF48"))) PPC_WEAK_FUNC(sub_8235FF48);
PPC_FUNC_IMPL(__imp__sub_8235FF48) {
	PPC_FUNC_PROLOGUE();
	uint32_t ea{};
	// mflr r12
	ctx.r12.u64 = ctx.lr;
...
__attribute__((alias("__imp__sub_8235FF94"))) PPC_WEAK_FUNC(sub_8235FF94);
PPC_FUNC_IMPL(__imp__sub_8235FF94) {
	PPC_FUNC_PROLOGUE();
	// .long 0x0
}

__attribute__((alias("__imp__sub_8235FF98"))) PPC_WEAK_FUNC(sub_8235FF98);
