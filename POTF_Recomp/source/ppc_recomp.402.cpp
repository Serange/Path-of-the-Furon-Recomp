...
__attribute__((alias("__imp__sub_82C97248"))) PPC_WEAK_FUNC(sub_82C97248);
PPC_FUNC_IMPL(__imp__sub_82C97248) {
	PPC_FUNC_PROLOGUE();
	PPCRegister temp{};
	// lis r11,-32256
	ctx.r11.s64 = -2113929216;
	...
	ctx.f11.f64 = double(temp.f32);
	// blt cr6,0x82c9726c
	if (ctx.cr6.lt) goto loc_82C9726C;
	// fcmpu cr6,f1,f11
	ctx.cr6.compare(ctx.f1.f64, ctx.f11.f64);
	// bgt cr6,0x82c9726c
	if (ctx.cr6.gt) goto loc_82C9726C;
	// stfs f1,68(r3)
	temp.f32 = float(ctx.f1.f64);
...
__attribute__((alias("__imp__sub_82C97294"))) PPC_WEAK_FUNC(sub_82C97294);
PPC_FUNC_IMPL(__imp__sub_82C97294) {
	PPC_FUNC_PROLOGUE();
	// .long 0x0
}
