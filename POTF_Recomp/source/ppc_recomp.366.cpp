...
__attribute__((alias("__imp__sub_82BBD258"))) PPC_WEAK_FUNC(sub_82BBD258);
PPC_FUNC_IMPL(__imp__sub_82BBD258) {
	PPC_FUNC_PROLOGUE();
	PPCRegister temp{};
	uint32_t ea{};
	// mflr r12
	...
	ctx.cr6.compare<int32_t>(ctx.r27.s32, 0, ctx.xer);
	// ble cr6,0x82bbd37c
	if (!ctx.cr6.gt) goto loc_82BBD37C;
	// rotlwi r11,r11,0
	ctx.r11.u64 = __builtin_rotateleft32(ctx.r11.u32, 0);
	// li r30,0
	ctx.r30.s64 = 0;
...
loc_82BBD2A8:
	...
	ctx.cr6.compare<uint32_t>(ctx.r31.u32, ctx.r25.u32, ctx.xer);
	// bge cr6,0x82bbd36c
	if (!ctx.cr6.lt) goto loc_82BBD36C;
	// lwz r11,48(r28)
	ctx.r11.u64 = PPC_LOAD_U32(ctx.r28.u32 + 48);
	// lwzx r11,r11,r30
	ctx.r11.u64 = PPC_LOAD_U32(ctx.r11.u32 + ctx.r30.u32);
	...
	ctx.cr6.compare<uint32_t>(ctx.r11.u32, 0, ctx.xer);
	// beq cr6,0x82bbd36c
	if (ctx.cr6.eq) goto loc_82BBD36C;
	// lwz r10,8(r29)
	ctx.r10.u64 = PPC_LOAD_U32(ctx.r29.u32 + 8);
	// lwz r9,20(r10)
	ctx.r9.u64 = PPC_LOAD_U32(ctx.r10.u32 + 20);
	...
	ctx.cr6.compare(ctx.f5.f64, ctx.f30.f64);
	// bgt cr6,0x82bbd36c
	if (ctx.cr6.gt) goto loc_82BBD36C;
	// lfs f11,4(r26)
	temp.u32 = PPC_LOAD_U32(ctx.r26.u32 + 4);
	ctx.f11.f64 = double(temp.f32);
	// fmuls f10,f11,f0
	...
	ctx.cr6.compare(ctx.f29.f64, ctx.f1.f64);
	// blt cr6,0x82bbd394
	if (ctx.cr6.lt) goto loc_82BBD394;
loc_82BBD36C:
	// addi r31,r31,1
	ctx.r31.s64 = ctx.r31.s64 + 1;
	// addi r30,r30,4
	...
	ctx.cr6.compare<int32_t>(ctx.r31.s32, ctx.r27.s32, ctx.xer);
	// blt cr6,0x82bbd2a8
	if (ctx.cr6.lt) goto loc_82BBD2A8;
loc_82BBD37C:
	// li r3,0
	ctx.r3.s64 = 0;
	// addi r1,r1,176
