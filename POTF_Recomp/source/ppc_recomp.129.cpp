...
loc_82590CA4:
	...
	ctx.cr6.compare<uint32_t>(ctx.r3.u32, 0, ctx.xer);
	// bne cr6,0x82590d3c
	if (!ctx.cr6.eq) goto loc_82590D3C;
	// lwz r11,88(r1)
	ctx.r11.u64 = PPC_LOAD_U32(ctx.r1.u32 + 88);
	// cmpwi cr6,r11,0
	ctx.cr6.compare<int32_t>(ctx.r11.s32, 0, ctx.xer);
	// bne cr6,0x82590d00
	if (!ctx.cr6.eq) goto loc_82590D00;
	// lwz r11,92(r1)
...
loc_82590D3C:
	...
	ctx.cr6.compare<int32_t>(ctx.r11.s32, 0, ctx.xer);
	// ble cr6,0x82590d9c
	if (!ctx.cr6.gt) goto loc_82590D9C;
	// li r30,0
	ctx.r30.s64 = 0;
loc_82590D58:
	// lwz r11,192(r31)
	...
	ctx.cr6.compare<uint32_t>(ctx.r3.u32, 0, ctx.xer);
	// beq cr6,0x82590d88
	if (ctx.cr6.eq) goto loc_82590D88;
	// lwz r11,92(r3)
...
loc_82590D88:
	...
	// blt cr6,0x82590d58
	if (ctx.cr6.lt) goto loc_82590D58;
loc_82590D9C:
	// addi r1,r1,144
	ctx.r1.s64 = ctx.r1.s64 + 144;
	// b 0x82cb1138
