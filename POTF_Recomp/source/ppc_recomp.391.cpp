...
__attribute__((alias("__imp__sub_82C52A90"))) PPC_WEAK_FUNC(sub_82C52A90);
PPC_FUNC_IMPL(__imp__sub_82C52A90) {
	PPC_FUNC_PROLOGUE();
	PPCRegister temp{};
	uint32_t ea{};
	// mflr r12
...
loc_82C52AE4:
	...
	// bdnz 0x82c52ae4
	--ctx.ctr.u64;
	if (ctx.ctr.u32 != 0) goto loc_82C52AE4;
	// lis r10,-32256
	ctx.r10.s64 = -2113929216;
	// stw r11,96(r1)
	PPC_STORE_U32(ctx.r1.u32 + 96, ctx.r11.u32);
...
loc_82C52B1C:
	...
	// bdnz 0x82c52b1c
	--ctx.ctr.u64;
	if (ctx.ctr.u32 != 0) goto loc_82C52B1C;
	// lis r11,-32222
	ctx.r11.s64 = -2111700992;
	// stb r28,184(r1)
	PPC_STORE_U8(ctx.r1.u32 + 184, ctx.r28.u8);
	...
	// beq cr6,0x82c52d14
	if (ctx.cr6.eq) goto loc_82C52D14;
	// lis r11,-31903
	ctx.r11.s64 = -2090795008;
	// li r5,1
	ctx.r5.s64 = 1;
	...
	ctx.f31.f64 = double(temp.f32);
	// beq 0x82c52be4
	if (ctx.cr0.eq) goto loc_82C52BE4;
	// lfs f12,4(r3)
	temp.u32 = PPC_LOAD_U32(ctx.r3.u32 + 4);
	ctx.f12.f64 = double(temp.f32);
	// lwz r11,36(r29)
	...
	PPC_STORE_U32(ctx.r1.u32 + 104, temp.u32);
	// bne cr6,0x82c52bb4
	if (!ctx.cr6.eq) goto loc_82C52BB4;
	// mr r3,r28
	ctx.r3.u64 = ctx.r28.u64;
	// b 0x82c52bd4
	goto loc_82C52BD4;
...
loc_82C52BE4:
	...
	ctx.cr0.compare<uint32_t>(ctx.r3.u32, 0, ctx.xer);
	// beq 0x82c52d14
	if (ctx.cr0.eq) goto loc_82C52D14;
	// lis r11,-31909
	ctx.r11.s64 = -2091188224;
	// lfs f10,80(r31)
	ctx.fpscr.disableFlushMode();
	...
	PPC_STORE_U32(ctx.r1.u32 + 100, temp.u32);
	// bne cr6,0x82c52c88
	if (!ctx.cr6.eq) goto loc_82C52C88;
	// mr r3,r28
	ctx.r3.u64 = ctx.r28.u64;
	// b 0x82c52ca8
	goto loc_82C52CA8;
...
loc_82C52CA8:
	...
	ctx.cr0.compare<int32_t>(ctx.r11.s32, 0, ctx.xer);
	// beq 0x82c52bdc
	if (ctx.cr0.eq) goto loc_82C52BDC;
	// lfs f0,0(r30)
	ctx.fpscr.disableFlushMode();
	temp.u32 = PPC_LOAD_U32(ctx.r30.u32 + 0);
	ctx.f0.f64 = double(temp.f32);
	...
	ctx.cr6.compare<uint32_t>(ctx.r11.u32, 0, ctx.xer);
	// bne cr6,0x82c52cec
	if (!ctx.cr6.eq) goto loc_82C52CEC;
	// mr r3,r28
	ctx.r3.u64 = ctx.r28.u64;
	// b 0x82c52d0c
	goto loc_82C52D0C;
...
loc_82C52D14:
	...
	PPC_STORE_U32(ctx.r1.u32 + 108, temp.u32);
	// bne cr6,0x82c52d44
	if (!ctx.cr6.eq) goto loc_82C52D44;
	// mr r3,r28
	ctx.r3.u64 = ctx.r28.u64;
	// b 0x82c52d64
	goto loc_82C52D64;
...
__attribute__((alias("__imp__sub_82C52D80"))) PPC_WEAK_FUNC(sub_82C52D80);
PPC_FUNC_IMPL(__imp__sub_82C52D80) {
	PPC_FUNC_PROLOGUE();
	PPCRegister temp{};
	uint32_t ea{};
	// mflr r12
...
loc_82C52DD8:
	...
	// bdnz 0x82c52dd8
	--ctx.ctr.u64;
	if (ctx.ctr.u32 != 0) goto loc_82C52DD8;
	// lis r11,-32222
	ctx.r11.s64 = -2111700992;
	// stb r27,280(r1)
...
loc_82C52E30:
	...
	// bdnz 0x82c52e30
	--ctx.ctr.u64;
	if (ctx.ctr.u32 != 0) goto loc_82C52E30;
	// addi r4,r1,80
	ctx.r4.s64 = ctx.r1.s64 + 80;
	// stb r27,184(r1)
	...
	ctx.f31.f64 = double(temp.f32);
	// beq 0x82c52ea0
	if (ctx.cr0.eq) goto loc_82C52EA0;
	// lfs f0,4(r3)
	temp.u32 = PPC_LOAD_U32(ctx.r3.u32 + 4);
	ctx.f0.f64 = double(temp.f32);
	// stfs f0,196(r1)
...
loc_82C52EA0:
	...
	ctx.cr0.compare<uint32_t>(ctx.r3.u32, 0, ctx.xer);
	// beq 0x82c52f08
	if (ctx.cr0.eq) goto loc_82C52F08;
	// lfs f13,0(r29)
	ctx.fpscr.disableFlushMode();
	temp.u32 = PPC_LOAD_U32(ctx.r29.u32 + 0);
	ctx.f13.f64 = double(temp.f32);
...
loc_82C52F08:
	...
	ctx.cr0.compare<uint32_t>(ctx.r3.u32, 0, ctx.xer);
	// beq 0x82c530ac
	if (ctx.cr0.eq) goto loc_82C530AC;
	// lfs f5,0(r30)
	ctx.fpscr.disableFlushMode();
	temp.u32 = PPC_LOAD_U32(ctx.r30.u32 + 0);
	ctx.f5.f64 = double(temp.f32);
	...
	// beq cr6,0x82c530ac
	if (ctx.cr6.eq) goto loc_82C530AC;
	// lis r11,-32256
	ctx.r11.s64 = -2113929216;
	// lfs f12,4(r30)
	temp.u32 = PPC_LOAD_U32(ctx.r30.u32 + 4);
...
loc_82C5303C:
	...
	ctx.cr0.compare<int32_t>(ctx.r10.s32, 0, ctx.xer);
	// bne 0x82c5304c
	if (!ctx.cr0.eq) goto loc_82C5304C;
loc_82C53044:
	// li r3,1
	ctx.r3.s64 = 1;
	// b 0x82c53180
...
loc_82C5304C:
	...
	PPC_STORE_U32(ctx.r1.u32 + 108, temp.u32);
	// bne cr6,0x82c53084
	if (!ctx.cr6.eq) goto loc_82C53084;
	// mr r3,r27
	ctx.r3.u64 = ctx.r27.u64;
	// b 0x82c530a4
	goto loc_82C530A4;
...
loc_82C530A4:
	...
	ctx.cr0.compare<int32_t>(ctx.r11.s32, 0, ctx.xer);
	// beq 0x82c53044
	if (ctx.cr0.eq) goto loc_82C53044;
loc_82C530AC:
	// li r5,1
	ctx.r5.s64 = 1;
	// mr r4,r25
	...
	ctx.cr0.compare<uint32_t>(ctx.r3.u32, 0, ctx.xer);
	// beq 0x82c53124
	if (ctx.cr0.eq) goto loc_82C53124;
	// lfs f12,4(r3)
	ctx.fpscr.disableFlushMode();
	temp.u32 = PPC_LOAD_U32(ctx.r3.u32 + 4);
	ctx.f12.f64 = double(temp.f32);
	...
	PPC_STORE_U32(ctx.r1.u32 + 104, temp.u32);
	// bne cr6,0x82c530fc
	if (!ctx.cr6.eq) goto loc_82C530FC;
	// mr r3,r27
	ctx.r3.u64 = ctx.r27.u64;
	// b 0x82c5311c
	goto loc_82C5311C;
...
loc_82C53124:
	...
	PPC_STORE_U32(ctx.r1.u32 + 108, temp.u32);
	// bne cr6,0x82c53154
	if (!ctx.cr6.eq) goto loc_82C53154;
	// mr r3,r27
	ctx.r3.u64 = ctx.r27.u64;
	// b 0x82c53174
	goto loc_82C53174;
...
__attribute__((alias("__imp__sub_82C53190"))) PPC_WEAK_FUNC(sub_82C53190);
PPC_FUNC_IMPL(__imp__sub_82C53190) {
	PPC_FUNC_PROLOGUE();
	PPCRegister temp{};
	uint32_t ea{};
	// mflr r12
	...
	ctx.cr0.compare<int32_t>(ctx.r11.s32, 0, ctx.xer);
	// bne 0x82c531bc
	if (!ctx.cr0.eq) goto loc_82C531BC;
	// lwz r11,120(r30)
	ctx.r11.u64 = PPC_LOAD_U32(ctx.r30.u32 + 120);
	// cmplw cr6,r4,r11
	ctx.cr6.compare<uint32_t>(ctx.r4.u32, ctx.r11.u32, ctx.xer);
	// ble cr6,0x82c53250
	if (!ctx.cr6.gt) goto loc_82C53250;
loc_82C531BC:
	// lwz r3,112(r30)
	...
	ctx.cr0.compare<uint32_t>(ctx.r3.u32, 0, ctx.xer);
	// beq 0x82c531dc
	if (ctx.cr0.eq) goto loc_82C531DC;
	// lis r11,-31909
	ctx.r11.s64 = -2091188224;
	// lwz r11,8884(r11)
	ctx.r11.u64 = PPC_LOAD_U32(ctx.r11.u32 + 8884);
...
loc_82C531DC:
	...
	ctx.cr6.compare<uint32_t>(ctx.r31.u32, ctx.r11.u32, ctx.xer);
	// ble cr6,0x82c53200
	if (!ctx.cr6.gt) goto loc_82C53200;
	// li r3,-1
	ctx.r3.s64 = -1;
loc_82C53200:
	// bl 0x82b6e518
	...
	ctx.cr0.compare<int32_t>(ctx.r10.s32, 0, ctx.xer);
	// blt 0x82c53238
	if (ctx.cr0.lt) goto loc_82C53238;
	// lis r9,-32256
	ctx.r9.s64 = -2113929216;
	// addi r11,r3,8
...
loc_82C53220:
	...
	ctx.r11.s64 = ctx.r11.s64 + 12;
	// bge 0x82c53220
	if (!ctx.cr0.lt) goto loc_82C53220;
loc_82C53238:
	// mr r11,r3
	ctx.r11.u64 = ctx.r3.u64;
	// b 0x82c53244
...
__attribute__((alias("__imp__sub_82C53268"))) PPC_WEAK_FUNC(sub_82C53268);
PPC_FUNC_IMPL(__imp__sub_82C53268) {
	PPC_FUNC_PROLOGUE();
	uint32_t ea{};
	// mflr r12
	ctx.r12.u64 = ctx.lr;
	...
	ctx.cr0.compare<int32_t>(ctx.r11.s32, 0, ctx.xer);
	// bne 0x82c53294
	if (!ctx.cr0.eq) goto loc_82C53294;
	// lwz r11,132(r31)
	ctx.r11.u64 = PPC_LOAD_U32(ctx.r31.u32 + 132);
	// cmplw cr6,r4,r11
	ctx.cr6.compare<uint32_t>(ctx.r4.u32, ctx.r11.u32, ctx.xer);
	// ble cr6,0x82c532f0
	if (!ctx.cr6.gt) goto loc_82C532F0;
loc_82C53294:
	// lwz r3,124(r31)
	ctx.r3.u64 = PPC_LOAD_U32(ctx.r31.u32 + 124);
	// stw r4,132(r31)
	...
	ctx.cr0.compare<uint32_t>(ctx.r3.u32, 0, ctx.xer);
	// beq 0x82c532b4
	if (ctx.cr0.eq) goto loc_82C532B4;
	// lis r11,-31909
	ctx.r11.s64 = -2091188224;
	// lwz r11,8884(r11)
	ctx.r11.u64 = PPC_LOAD_U32(ctx.r11.u32 + 8884);
...
loc_82C532B4:
	...
	ctx.cr0.compare<uint32_t>(ctx.r11.u32, 0, ctx.xer);
	// bne 0x82c532cc
	if (!ctx.cr0.eq) goto loc_82C532CC;
	// stw r30,124(r31)
...
loc_82C532CC:
	...
	ctx.cr6.compare<uint32_t>(ctx.r11.u32, ctx.r10.u32, ctx.xer);
	// ble cr6,0x82c532e4
	if (!ctx.cr6.gt) goto loc_82C532E4;
	// li r3,-1
	ctx.r3.s64 = -1;
loc_82C532E4:
	// bl 0x82b6e518
...
__attribute__((alias("__imp__sub_82C53308"))) PPC_WEAK_FUNC(sub_82C53308);
PPC_FUNC_IMPL(__imp__sub_82C53308) {
	PPC_FUNC_PROLOGUE();
	PPCRegister temp{};
	uint32_t ea{};
	// mflr r12
...
__attribute__((alias("__imp__sub_82C533B4"))) PPC_WEAK_FUNC(sub_82C533B4);
PPC_FUNC_IMPL(__imp__sub_82C533B4) {
	PPC_FUNC_PROLOGUE();
	// .long 0x0
}

__attribute__((alias("__imp__sub_82C533B8"))) PPC_WEAK_FUNC(sub_82C533B8);
PPC_FUNC_IMPL(__imp__sub_82C533B8) {
	PPC_FUNC_PROLOGUE();
	uint32_t ea{};
	// mflr r12
	ctx.r12.u64 = ctx.lr;
...
loc_82C533E0:
	...
	ctx.cr6.compare<int32_t>(ctx.r11.s32, -1, ctx.xer);
	// bne cr6,0x82c533fc
	if (!ctx.cr6.eq) goto loc_82C533FC;
	// li r5,0
	ctx.r5.s64 = 0;
	// li r4,8
	ctx.r4.s64 = 8;
...
loc_82C533FC:
	...
	ctx.cr6.compare<int32_t>(ctx.r11.s32, -1, ctx.xer);
	// bne cr6,0x82c53418
	if (!ctx.cr6.eq) goto loc_82C53418;
	// li r5,0
	ctx.r5.s64 = 0;
	// li r4,8
	ctx.r4.s64 = 8;
...
PPC_FUNC_IMPL(__imp__sub_82C53430) {
	...
	ctx.cr6.compare<uint32_t>(ctx.r31.u32, 0, ctx.xer);
	// bne cr6,0x82c53454
	if (!ctx.cr6.eq) goto loc_82C53454;
	// li r3,0
	ctx.r3.s64 = 0;
	// b 0x82c534f0
	goto loc_82C534F0;
loc_82C53454:
	...
	ctx.r3.u64 = ctx.r31.u64;
	// bne 0x82c534a0
	if (!ctx.cr0.eq) goto loc_82C534A0;
	// bl 0x82c05198
	ctx.lr = 0x82C5347C;
	sub_82C05198(ctx, base);
	// cmplwi r3,0
	ctx.cr0.compare<uint32_t>(ctx.r3.u32, 0, ctx.xer);
	// beq 0x82c534e4
	if (ctx.cr0.eq) goto loc_82C534E4;
	// bl 0x82cb6a70
	ctx.lr = 0x82C53488;
	sub_82CB6A70(ctx, base);
	// mr r4,r3
...
PPC_FUNC_IMPL(__imp__sub_82C534F8) {
	...
	ctx.cr0.compare<uint32_t>(ctx.r3.u32, 0, ctx.xer);
	// beq 0x82c5351c
	if (ctx.cr0.eq) goto loc_82C5351C;
	// bl 0x82c53308
	ctx.lr = 0x82C53518;
...
__attribute__((alias("__imp__sub_82C53538"))) PPC_WEAK_FUNC(sub_82C53538);
...
__attribute__((alias("__imp__sub_82C535A0"))) PPC_WEAK_FUNC(sub_82C535A0);
PPC_FUNC_IMPL(__imp__sub_82C535A0) {
	PPC_FUNC_PROLOGUE();
	// li r3,0
	ctx.r3.s64 = 0;
	// blr 
...
__attribute__((alias("__imp__sub_82C535A8"))) PPC_WEAK_FUNC(sub_82C535A8);
PPC_FUNC_IMPL(__imp__sub_82C535A8) {
	PPC_FUNC_PROLOGUE();
	uint32_t ea{};
	// mflr r12
	ctx.r12.u64 = ctx.lr;
	...
	PPC_STORE_U32(ctx.r31.u32 + 0, ctx.r11.u32);
	// beq 0x82c535f0
	if (ctx.cr0.eq) goto loc_82C535F0;
	// lbz r11,44(r31)
	ctx.r11.u64 = PPC_LOAD_U8(ctx.r31.u32 + 44);
	// cmplwi cr6,r11,1
	ctx.cr6.compare<uint32_t>(ctx.r11.u32, 1, ctx.xer);
	// bne cr6,0x82c535f0
	if (!ctx.cr6.eq) goto loc_82C535F0;
	// lis r11,-31909
	ctx.r11.s64 = -2091188224;
	// lwz r11,8884(r11)
	ctx.r11.u64 = PPC_LOAD_U32(ctx.r11.u32 + 8884);
...
__attribute__((alias("__imp__sub_82C5360C"))) PPC_WEAK_FUNC(sub_82C5360C);
PPC_FUNC_IMPL(__imp__sub_82C5360C) {
	PPC_FUNC_PROLOGUE();
	// .long 0x0
}

__attribute__((alias("__imp__sub_82C53610"))) PPC_WEAK_FUNC(sub_82C53610);
PPC_FUNC_IMPL(__imp__sub_82C53610) {
	PPC_FUNC_PROLOGUE();
	uint32_t ea{};
	// mflr r12
	ctx.r12.u64 = ctx.lr;
	...
	ctx.cr0.compare<uint32_t>(ctx.r3.u32, 0, ctx.xer);
	// beq 0x82c53654
	if (ctx.cr0.eq) goto loc_82C53654;
	// lbz r11,44(r31)
	ctx.r11.u64 = PPC_LOAD_U8(ctx.r31.u32 + 44);
	// cmplwi cr6,r11,1
	ctx.cr6.compare<uint32_t>(ctx.r11.u32, 1, ctx.xer);
	// bne cr6,0x82c53654
	if (!ctx.cr6.eq) goto loc_82C53654;
	// lis r11,-31909
	ctx.r11.s64 = -2091188224;
	// lwz r11,8884(r11)
	ctx.r11.u64 = PPC_LOAD_U32(ctx.r11.u32 + 8884);
...
loc_82C53654:
	...
	// ble cr6,0x82c53678
	if (!ctx.cr6.gt) goto loc_82C53678;
	// li r3,-1
	ctx.r3.s64 = -1;
loc_82C53678:
	// bl 0x82b6e518
...
__attribute__((alias("__imp__sub_82C53690"))) PPC_WEAK_FUNC(sub_82C53690);
PPC_FUNC_IMPL(__imp__sub_82C53690) {
	PPC_FUNC_PROLOGUE();
	uint32_t ea{};
	// mflr r12
	ctx.r12.u64 = ctx.lr;
	...
	ctx.cr0.compare<uint32_t>(ctx.r3.u32, 0, ctx.xer);
	// beq 0x82c536d8
	if (ctx.cr0.eq) goto loc_82C536D8;
	// lbz r11,44(r31)
	ctx.r11.u64 = PPC_LOAD_U8(ctx.r31.u32 + 44);
	// cmplwi cr6,r11,1
	ctx.cr6.compare<uint32_t>(ctx.r11.u32, 1, ctx.xer);
...
__attribute__((alias("__imp__sub_82C536EC"))) PPC_WEAK_FUNC(sub_82C536EC);
PPC_FUNC_IMPL(__imp__sub_82C536EC) {
	PPC_FUNC_PROLOGUE();
	// .long 0x0
}
