...
__attribute__((alias("__imp__sub_823515E0"))) PPC_WEAK_FUNC(sub_823515E0);
PPC_FUNC_IMPL(__imp__sub_823515E0) {
	PPC_FUNC_PROLOGUE();
	// cmplwi cr6,r3,6
...
__attribute__((alias("__imp__sub_82351678"))) PPC_WEAK_FUNC(sub_82351678);
PPC_FUNC_IMPL(__imp__sub_82351678) {
	PPC_FUNC_PROLOGUE();
	// blr 
	return;
}
