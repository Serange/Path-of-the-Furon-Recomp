...
__attribute__((alias("__imp__sub_832E79F0"))) PPC_WEAK_FUNC(sub_832E79F0);
PPC_FUNC_IMPL(__imp__sub_832E79F0) {
	PPC_FUNC_PROLOGUE();
	// lis r11,-32247
...
__attribute__((alias("__imp__sub_832E79FC"))) PPC_WEAK_FUNC(sub_832E79FC);
PPC_FUNC_IMPL(__imp__sub_832E79FC) {
	PPC_FUNC_PROLOGUE();
	// .long 0x0
}

__attribute__((alias("__imp__sub_832E7A00"))) PPC_WEAK_FUNC(sub_832E7A00);
PPC_FUNC_IMPL(__imp__sub_832E7A00) {
	PPC_FUNC_PROLOGUE();
	// stw r4,2040(r3)
	PPC_STORE_U32(ctx.r3.u32 + 2040, ctx.r4.u32);
	// blr 
	return;
}
