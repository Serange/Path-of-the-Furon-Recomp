...
__attribute__((alias("__imp__sub_82421118"))) PPC_WEAK_FUNC(sub_82421118);
PPC_FUNC_IMPL(__imp__sub_82421118) {
	PPC_FUNC_PROLOGUE();
	uint32_t ea{};
	// mflr r12
	ctx.r12.u64 = ctx.lr;
...
loc_82421144:
	...
	// bne cr6,0x82421144
	if (!ctx.cr6.eq) goto loc_82421144;
loc_82421160:
	// cmplwi cr6,r30,0
	ctx.cr6.compare<uint32_t>(ctx.r30.u32, 0, ctx.xer);
	// beq cr6,0x82421188
	if (ctx.cr6.eq) goto loc_82421188;
	// lis r11,-31884
...
loc_82421188:
	...
	// bl 0x8241d4c0
	ctx.lr = 0x82421190;
	sub_8241D4C0(ctx, base);
	// lwz r3,288(r31)
	ctx.r3.u64 = PPC_LOAD_U32(ctx.r31.u32 + 288);
	// cmplwi cr6,r3,0
	ctx.cr6.compare<uint32_t>(ctx.r3.u32, 0, ctx.xer);
	// beq cr6,0x824211a0
	if (ctx.cr6.eq) goto loc_824211A0;
	// bl 0x828b5808
	ctx.lr = 0x824211A0;
	sub_828B5808(ctx, base);
loc_824211A0:
	// cmplwi cr6,r30,0
	ctx.cr6.compare<uint32_t>(ctx.r30.u32, 0, ctx.xer);
	// beq cr6,0x824211ac
	if (ctx.cr6.eq) goto loc_824211AC;
	// bl 0x829f0cd8
	ctx.lr = 0x824211AC;
	sub_829F0CD8(ctx, base);
loc_824211AC:
	// addi r1,r1,112
...
__attribute__((alias("__imp__sub_824211C4"))) PPC_WEAK_FUNC(sub_824211C4);
PPC_FUNC_IMPL(__imp__sub_824211C4) {
	PPC_FUNC_PROLOGUE();
	// .long 0x0
}

__attribute__((alias("__imp__sub_824211C8"))) PPC_WEAK_FUNC(sub_824211C8);
PPC_FUNC_IMPL(__imp__sub_824211C8) {
	PPC_FUNC_PROLOGUE();
	uint32_t ea{};
	// mflr r12
	ctx.r12.u64 = ctx.lr;
...
loc_824211F4:
	...
	// bge cr6,0x8242138c
	if (!ctx.cr6.lt) goto loc_8242138C;
	// lwz r10,0(r28)
	...
	// beq cr6,0x8242126c
	if (ctx.cr6.eq) goto loc_8242126C;
	// lwz r3,40(r11)
...
loc_82421240:
	...
	// beq cr6,0x82421260
	if (ctx.cr6.eq) goto loc_82421260;
	// addi r10,r10,1
	...
	// blt cr6,0x82421240
	if (ctx.cr6.lt) goto loc_82421240;
	// b 0x8242126c
	goto loc_8242126C;
loc_82421260:
	// cmpwi cr6,r10,-1
	...
	ctx.r30.s64 = 1;
	// bne cr6,0x82421270
	if (!ctx.cr6.eq) goto loc_82421270;
loc_8242126C:
	// li r30,0
	ctx.r30.s64 = 0;
loc_82421270:
	...
	// bne cr6,0x82421298
	if (!ctx.cr6.eq) goto loc_82421298;
	// mr r4,r26
	ctx.r4.u64 = ctx.r26.u64;
	// bl 0x826cff70
	ctx.lr = 0x82421290;
	sub_826CFF70(ctx, base);
	// cmplwi cr6,r3,0
	ctx.cr6.compare<uint32_t>(ctx.r3.u32, 0, ctx.xer);
	// beq cr6,0x824212dc
	if (ctx.cr6.eq) goto loc_824212DC;
loc_82421298:
	// lwz r11,0(r28)
	ctx.r11.u64 = PPC_LOAD_U32(ctx.r28.u32 + 0);
	// lwzx r31,r29,r11
	...
	ctx.cr6.compare<uint32_t>(ctx.r10.u32, 0, ctx.xer);
	// beq cr6,0x824212c8
	if (ctx.cr6.eq) goto loc_824212C8;
	// rotlwi r3,r10,0
...
loc_824212C8:
	...
	ctx.cr6.compare<uint32_t>(ctx.r10.u32, 0, ctx.xer);
	// beq cr6,0x824212e0
	if (ctx.cr6.eq) goto loc_824212E0;
loc_824212DC:
	// li r11,0
	ctx.r11.s64 = 0;
loc_824212E0:
	...
	// beq cr6,0x824212f4
	if (ctx.cr6.eq) goto loc_824212F4;
	// cmplwi cr6,r11,0
	ctx.cr6.compare<uint32_t>(ctx.r11.u32, 0, ctx.xer);
	// li r31,0
	ctx.r31.s64 = 0;
...
loc_824212F8:
	...
	ctx.cr6.compare<uint32_t>(ctx.r11.u32, 0, ctx.xer);
	// beq cr6,0x82421358
	if (ctx.cr6.eq) goto loc_82421358;
loc_82421344:
	// cmplw cr6,r11,r3
	...
	ctx.cr6.compare<uint32_t>(ctx.r11.u32, 0, ctx.xer);
	// bne cr6,0x82421344
	if (!ctx.cr6.eq) goto loc_82421344;
loc_82421358:
	// cntlzw r11,r3
...
PPC_FUNC_IMPL(__imp__sub_82421398) {
	...
	// bgt cr6,0x824213b4
	if (ctx.cr6.gt) goto loc_824213B4;
	// li r11,0
	ctx.r11.s64 = 0;
	// lbz r3,0(0)
	ctx.r3.u64 = PPC_LOAD_U8(0);
	// blr 
	return;
loc_824213B4:
	// lwz r11,128(r11)
	...
	// lbz r3,940(r10)
	ctx.r3.u64 = PPC_LOAD_U8(ctx.r10.u32 + 940);
	// blr 
	return;
}

__attribute__((alias("__imp__sub_824213C4"))) PPC_WEAK_FUNC(sub_824213C4);
PPC_FUNC_IMPL(__imp__sub_824213C4) {
	PPC_FUNC_PROLOGUE();
	// .long 0x0
}

__attribute__((alias("__imp__sub_824213C8"))) PPC_WEAK_FUNC(sub_824213C8);
PPC_FUNC_IMPL(__imp__sub_824213C8) {
	PPC_FUNC_PROLOGUE();
	// lwz r11,80(r3)
	ctx.r11.u64 = PPC_LOAD_U32(ctx.r3.u32 + 80);
	// lwz r10,132(r11)
	...
	ctx.cr6.compare<int32_t>(ctx.r10.s32, 0, ctx.xer);
	// bgt cr6,0x824213e4
	if (ctx.cr6.gt) goto loc_824213E4;
	// li r11,0
	ctx.r11.s64 = 0;
	// lwz r3,0(0)
...
__attribute__((alias("__imp__sub_824213F4"))) PPC_WEAK_FUNC(sub_824213F4);
PPC_FUNC_IMPL(__imp__sub_824213F4) {
	PPC_FUNC_PROLOGUE();
	// .long 0x0
}

__attribute__((alias("__imp__sub_824213F8"))) PPC_WEAK_FUNC(sub_824213F8);
PPC_FUNC_IMPL(__imp__sub_824213F8) {
	PPC_FUNC_PROLOGUE();
	// lwz r11,80(r3)
	ctx.r11.u64 = PPC_LOAD_U32(ctx.r3.u32 + 80);
	// lwz r10,132(r11)
	...
	ctx.cr6.compare<int32_t>(ctx.r10.s32, 0, ctx.xer);
	// bgt cr6,0x82421414
	if (ctx.cr6.gt) goto loc_82421414;
	// li r11,0
	ctx.r11.s64 = 0;
	// lwz r3,0(0)
	ctx.r3.u64 = PPC_LOAD_U32(0);
