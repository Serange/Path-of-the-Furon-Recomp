...
loc_828FE034:
	...
	// lvx128 v61,r10,r4
	simde_mm_store_si128((simde__m128i*)ctx.v61.u8, simde_mm_shuffle_epi8(simde_mm_load_si128((simde__m128i*)(base + ((ctx.r10.u32 + ctx.r4.u32) & ~0xF))), simde_mm_load_si128((simde__m128i*)VectorMaskL)));
	// lvx128 v60,r0,r10
	...
	// lvx128 v59,r9,r4
	simde_mm_store_si128((simde__m128i*)ctx.v59.u8, simde_mm_shuffle_epi8(simde_mm_load_si128((simde__m128i*)(base + ((ctx.r9.u32 + ctx.r4.u32) & ~0xF))), simde_mm_load_si128((simde__m128i*)VectorMaskL)));
	// lvx128 v58,r0,r9
	...
	// lvx128 v55,r8,r4
	simde_mm_store_si128((simde__m128i*)ctx.v55.u8, simde_mm_shuffle_epi8(simde_mm_load_si128((simde__m128i*)(base + ((ctx.r8.u32 + ctx.r4.u32) & ~0xF))), simde_mm_load_si128((simde__m128i*)VectorMaskL)));
	// lvx128 v54,r0,r8
	...
	simde_mm_store_si128((simde__m128i*)ctx.v57.u8, simde_mm_perm_epi8_(simde_mm_load_si128((simde__m128i*)ctx.v60.u8), simde_mm_load_si128((simde__m128i*)ctx.v61.u8), simde_mm_load_si128((simde__m128i*)ctx.v0.u8)));
	// lvsl v6,r0,r8
	temp.u32 = ctx.r8.u32;
	simde_mm_store_si128((simde__m128i*)ctx.v6.u8, simde_mm_load_si128((simde__m128i*)&VectorShiftTableL[(temp.u32 & 0xF) * 16]));
	// vperm128 v56,v58,v59,v7
	simde_mm_store_si128((simde__m128i*)ctx.v56.u8, simde_mm_perm_epi8_(simde_mm_load_si128((simde__m128i*)ctx.v58.u8), simde_mm_load_si128((simde__m128i*)ctx.v59.u8), simde_mm_load_si128((simde__m128i*)ctx.v7.u8)));
	// vperm128 v53,v54,v55,v6
	simde_mm_store_si128((simde__m128i*)ctx.v53.u8, simde_mm_perm_epi8_(simde_mm_load_si128((simde__m128i*)ctx.v54.u8), simde_mm_load_si128((simde__m128i*)ctx.v55.u8), simde_mm_load_si128((simde__m128i*)ctx.v6.u8)));
	// vmulfp128 v52,v57,v62
	ctx.fpscr.enableFlushMode();
	simde_mm_store_ps(ctx.v52.f32, simde_mm_mul_ps(simde_mm_load_ps(ctx.v57.f32), simde_mm_load_ps(ctx.v62.f32)));
	// vsubfp128 v51,v57,v56
	simde_mm_store_ps(ctx.v51.f32, simde_mm_sub_ps(simde_mm_load_ps(ctx.v57.f32), simde_mm_load_ps(ctx.v56.f32)));
	// vsubfp128 v50,v53,v56
	simde_mm_store_ps(ctx.v50.f32, simde_mm_sub_ps(simde_mm_load_ps(ctx.v53.f32), simde_mm_load_ps(ctx.v56.f32)));
	// vsubfp128 v49,v63,v52
	simde_mm_store_ps(ctx.v49.f32, simde_mm_sub_ps(simde_mm_load_ps(ctx.v63.f32), simde_mm_load_ps(ctx.v52.f32)));
	...
	simde_mm_store_si128((simde__m128i*)ctx.v5.u32, simde_mm_shuffle_epi32(simde_mm_load_si128((simde__m128i*)ctx.v51.u32), 0x9C));
	// vpermwi128 v4,v50,135
	simde_mm_store_si128((simde__m128i*)ctx.v4.u32, simde_mm_shuffle_epi32(simde_mm_load_si128((simde__m128i*)ctx.v50.u32), 0x78));
	// vmulfp128 v3,v47,v48
	simde_mm_store_ps(ctx.v3.f32, simde_mm_mul_ps(simde_mm_load_ps(ctx.v47.f32), simde_mm_load_ps(ctx.v48.f32)));
	...
	simde_mm_store_ps(ctx.v46.f32, simde_mm_dp_ps(simde_mm_load_ps(ctx.v2.f32), simde_mm_load_ps(ctx.v49.f32), 0xEF));
	// vspltw128 v45,v46,0
...
loc_828FE8E4:
	...
	// lvx128 v60,r7,r8
	simde_mm_store_si128((simde__m128i*)ctx.v60.u8, simde_mm_shuffle_epi8(simde_mm_load_si128((simde__m128i*)(base + ((ctx.r7.u32 + ctx.r8.u32) & ~0xF))), simde_mm_load_si128((simde__m128i*)VectorMaskL)));
	// lis r10,-31881
	ctx.r10.s64 = -2089353216;
	// lis r9,-31881
	ctx.r9.s64 = -2089353216;
	// lvx128 v9,r7,r5
	simde_mm_store_si128((simde__m128i*)ctx.v9.u8, simde_mm_shuffle_epi8(simde_mm_load_si128((simde__m128i*)(base + ((ctx.r7.u32 + ctx.r5.u32) & ~0xF))), simde_mm_load_si128((simde__m128i*)VectorMaskL)));
	// lis r8,-31881
	...
	// lvx128 v0,r7,r3
	simde_mm_store_si128((simde__m128i*)ctx.v0.u8, simde_mm_shuffle_epi8(simde_mm_load_si128((simde__m128i*)(base + ((ctx.r7.u32 + ctx.r3.u32) & ~0xF))), simde_mm_load_si128((simde__m128i*)VectorMaskL)));
	// li r19,11
	ctx.r19.s64 = 11;
	// stw r6,80(r1)
...
loc_828FEE2C:
	...
	// lvx128 v59,r9,r19
	simde_mm_store_si128((simde__m128i*)ctx.v59.u8, simde_mm_shuffle_epi8(simde_mm_load_si128((simde__m128i*)(base + ((ctx.r9.u32 + ctx.r19.u32) & ~0xF))), simde_mm_load_si128((simde__m128i*)VectorMaskL)));
	// vor128 v5,v62,v62
	simde_mm_store_si128((simde__m128i*)ctx.v5.u8, simde_mm_load_si128((simde__m128i*)ctx.v62.u8));
	// lvsl v6,r0,r9
	temp.u32 = ctx.r9.u32;
	simde_mm_store_si128((simde__m128i*)ctx.v6.u8, simde_mm_load_si128((simde__m128i*)&VectorShiftTableL[(temp.u32 & 0xF) * 16]));
	// addi r10,r9,16
	...
	simde_mm_store_si128((simde__m128i*)ctx.v4.u8, simde_mm_perm_epi8_(simde_mm_load_si128((simde__m128i*)ctx.v61.u8), simde_mm_load_si128((simde__m128i*)ctx.v59.u8), simde_mm_load_si128((simde__m128i*)ctx.v6.u8)));
	// addi r8,r9,20
	...
	// vsel v30,v4,v5,v31
	simde_mm_store_si128((simde__m128i*)ctx.v30.u8, simde_mm_or_si128(simde_mm_andnot_si128(simde_mm_load_si128((simde__m128i*)ctx.v31.u8), simde_mm_load_si128((simde__m128i*)ctx.v4.u8)), simde_mm_and_si128(simde_mm_load_si128((simde__m128i*)ctx.v31.u8), simde_mm_load_si128((simde__m128i*)ctx.v5.u8))));
	// vperm128 v56,v58,v57,v3
	simde_mm_store_si128((simde__m128i*)ctx.v56.u8, simde_mm_perm_epi8_(simde_mm_load_si128((simde__m128i*)ctx.v58.u8), simde_mm_load_si128((simde__m128i*)ctx.v57.u8), simde_mm_load_si128((simde__m128i*)ctx.v3.u8)));
	// lvx128 v55,r0,r10
	...
	// lvx128 v54,r10,r19
	simde_mm_store_si128((simde__m128i*)ctx.v54.u8, simde_mm_shuffle_epi8(simde_mm_load_si128((simde__m128i*)(base + ((ctx.r10.u32 + ctx.r19.u32) & ~0xF))), simde_mm_load_si128((simde__m128i*)VectorMaskL)));
	// addi r15,r15,1
	...
	simde_mm_store_si128((simde__m128i*)ctx.v53.u8, simde_mm_perm_epi8_(simde_mm_load_si128((simde__m128i*)ctx.v55.u8), simde_mm_load_si128((simde__m128i*)ctx.v54.u8), simde_mm_load_si128((simde__m128i*)ctx.v2.u8)));
	// lvx128 v52,r8,r19
	simde_mm_store_si128((simde__m128i*)ctx.v52.u8, simde_mm_shuffle_epi8(simde_mm_load_si128((simde__m128i*)(base + ((ctx.r8.u32 + ctx.r19.u32) & ~0xF))), simde_mm_load_si128((simde__m128i*)VectorMaskL)));
	// vspltw128 v51,v56,0
	simde_mm_store_si128((simde__m128i*)ctx.v51.u32, simde_mm_shuffle_epi32(simde_mm_load_si128((simde__m128i*)ctx.v56.u32), 0xFF));
	// lvx128 v50,r0,r8
	simde_mm_store_si128((simde__m128i*)ctx.v50.u8, simde_mm_shuffle_epi8(simde_mm_load_si128((simde__m128i*)(base + ((ctx.r8.u32) & ~0xF))), simde_mm_load_si128((simde__m128i*)VectorMaskL)));
	// lvsl v6,r0,r8
	temp.u32 = ctx.r8.u32;
	simde_mm_store_si128((simde__m128i*)ctx.v6.u8, simde_mm_load_si128((simde__m128i*)&VectorShiftTableL[(temp.u32 & 0xF) * 16]));
	// lhzx r3,r6,r18
	...
	simde_mm_store_si128((simde__m128i*)ctx.v49.u8, simde_mm_perm_epi8_(simde_mm_load_si128((simde__m128i*)ctx.v50.u8), simde_mm_load_si128((simde__m128i*)ctx.v52.u8), simde_mm_load_si128((simde__m128i*)ctx.v6.u8)));
	// vspltw128 v48,v53,0
	...
	simde_mm_store_si128((simde__m128i*)ctx.v47.u8, simde_mm_perm_epi8_(simde_mm_load_si128((simde__m128i*)ctx.v51.u8), simde_mm_load_si128((simde__m128i*)ctx.v63.u8), simde_mm_load_si128((simde__m128i*)ctx.v7.u8)));
	// add r11,r11,r28
	ctx.r11.u64 = ctx.r11.u64 + ctx.r28.u64;
	// vspltw v4,v30,2
	simde_mm_store_si128((simde__m128i*)ctx.v4.u32, simde_mm_shuffle_epi32(simde_mm_load_si128((simde__m128i*)ctx.v30.u32), 0x55));
	// vspltw128 v46,v49,0
	simde_mm_store_si128((simde__m128i*)ctx.v46.u32, simde_mm_shuffle_epi32(simde_mm_load_si128((simde__m128i*)ctx.v49.u32), 0xFF));
	// vperm128 v45,v48,v63,v7
	simde_mm_store_si128((simde__m128i*)ctx.v45.u8, simde_mm_perm_epi8_(simde_mm_load_si128((simde__m128i*)ctx.v48.u8), simde_mm_load_si128((simde__m128i*)ctx.v63.u8), simde_mm_load_si128((simde__m128i*)ctx.v7.u8)));
	// vcuxwfp128 v5,v47,0
	ctx.fpscr.enableFlushMode();
	simde_mm_store_ps(ctx.v5.f32, simde_mm_cvtepu32_ps_(simde_mm_load_si128((simde__m128i*)ctx.v47.u32)));
	// vspltw v29,v30,1
	simde_mm_store_si128((simde__m128i*)ctx.v29.u32, simde_mm_shuffle_epi32(simde_mm_load_si128((simde__m128i*)ctx.v30.u32), 0xAA));
	// vspltw v27,v30,0
	simde_mm_store_si128((simde__m128i*)ctx.v27.u32, simde_mm_shuffle_epi32(simde_mm_load_si128((simde__m128i*)ctx.v30.u32), 0xFF));
	// vperm128 v44,v46,v63,v7
	simde_mm_store_si128((simde__m128i*)ctx.v44.u8, simde_mm_perm_epi8_(simde_mm_load_si128((simde__m128i*)ctx.v46.u8), simde_mm_load_si128((simde__m128i*)ctx.v63.u8), simde_mm_load_si128((simde__m128i*)ctx.v7.u8)));
	// lvx128 v13,r11,r29
	...
	// vcuxwfp128 v2,v45,0
	simde_mm_store_ps(ctx.v2.f32, simde_mm_cvtepu32_ps_(simde_mm_load_si128((simde__m128i*)ctx.v45.u32)));
	// lvx128 v12,r11,r17
	...
	simde_mm_store_ps(ctx.v28.f32, simde_mm_add_ps(simde_mm_mul_ps(simde_mm_load_ps(ctx.v4.f32), simde_mm_load_ps(ctx.v13.f32)), simde_mm_load_ps(ctx.v3.f32)));
	// vcuxwfp128 v26,v44,0
	simde_mm_store_ps(ctx.v26.f32, simde_mm_cvtepu32_ps_(simde_mm_load_si128((simde__m128i*)ctx.v44.u32)));
	// li r11,12
	ctx.r11.s64 = 12;
	// vmaddfp v25,v5,v8,v9
	simde_mm_store_ps(ctx.v25.f32, simde_mm_add_ps(simde_mm_mul_ps(simde_mm_load_ps(ctx.v5.f32), simde_mm_load_ps(ctx.v8.f32)), simde_mm_load_ps(ctx.v9.f32)));
	// vmaddfp v24,v2,v8,v9
	simde_mm_store_ps(ctx.v24.f32, simde_mm_add_ps(simde_mm_mul_ps(simde_mm_load_ps(ctx.v2.f32), simde_mm_load_ps(ctx.v8.f32)), simde_mm_load_ps(ctx.v9.f32)));
	// vmaddfp v23,v29,v12,v28
	simde_mm_store_ps(ctx.v23.f32, simde_mm_add_ps(simde_mm_mul_ps(simde_mm_load_ps(ctx.v29.f32), simde_mm_load_ps(ctx.v12.f32)), simde_mm_load_ps(ctx.v28.f32)));
	// vmaddfp v22,v26,v8,v9
	simde_mm_store_ps(ctx.v22.f32, simde_mm_add_ps(simde_mm_mul_ps(simde_mm_load_ps(ctx.v26.f32), simde_mm_load_ps(ctx.v8.f32)), simde_mm_load_ps(ctx.v9.f32)));
	// vspltw128 v43,v25,2
	simde_mm_store_si128((simde__m128i*)ctx.v43.u32, simde_mm_shuffle_epi32(simde_mm_load_si128((simde__m128i*)ctx.v25.u32), 0x55));
	// vspltw v21,v25,1
	simde_mm_store_si128((simde__m128i*)ctx.v21.u32, simde_mm_shuffle_epi32(simde_mm_load_si128((simde__m128i*)ctx.v25.u32), 0xAA));
	// vspltw v19,v25,0
	simde_mm_store_si128((simde__m128i*)ctx.v19.u32, simde_mm_shuffle_epi32(simde_mm_load_si128((simde__m128i*)ctx.v25.u32), 0xFF));
	// vspltw128 v42,v24,2
	simde_mm_store_si128((simde__m128i*)ctx.v42.u32, simde_mm_shuffle_epi32(simde_mm_load_si128((simde__m128i*)ctx.v24.u32), 0x55));
	// vmulfp128 v18,v43,v13
	simde_mm_store_ps(ctx.v18.f32, simde_mm_mul_ps(simde_mm_load_ps(ctx.v43.f32), simde_mm_load_ps(ctx.v13.f32)));
	// vspltw v17,v24,1
	simde_mm_store_si128((simde__m128i*)ctx.v17.u32, simde_mm_shuffle_epi32(simde_mm_load_si128((simde__m128i*)ctx.v24.u32), 0xAA));
	// vspltw v16,v24,0
	simde_mm_store_si128((simde__m128i*)ctx.v16.u32, simde_mm_shuffle_epi32(simde_mm_load_si128((simde__m128i*)ctx.v24.u32), 0xFF));
	// vmaddfp v20,v27,v11,v23
	simde_mm_store_ps(ctx.v20.f32, simde_mm_add_ps(simde_mm_mul_ps(simde_mm_load_ps(ctx.v27.f32), simde_mm_load_ps(ctx.v11.f32)), simde_mm_load_ps(ctx.v23.f32)));
	// vspltw128 v41,v22,2
	simde_mm_store_si128((simde__m128i*)ctx.v41.u32, simde_mm_shuffle_epi32(simde_mm_load_si128((simde__m128i*)ctx.v22.u32), 0x55));
	// vmulfp128 v15,v42,v13
	simde_mm_store_ps(ctx.v15.f32, simde_mm_mul_ps(simde_mm_load_ps(ctx.v42.f32), simde_mm_load_ps(ctx.v13.f32)));
	// vspltw v14,v22,1
	simde_mm_store_si128((simde__m128i*)ctx.v14.u32, simde_mm_shuffle_epi32(simde_mm_load_si128((simde__m128i*)ctx.v22.u32), 0xAA));
	// vspltw v10,v22,0
	simde_mm_store_si128((simde__m128i*)ctx.v10.u32, simde_mm_shuffle_epi32(simde_mm_load_si128((simde__m128i*)ctx.v22.u32), 0xFF));
	// vmulfp128 v6,v41,v13
	simde_mm_store_ps(ctx.v6.f32, simde_mm_mul_ps(simde_mm_load_ps(ctx.v41.f32), simde_mm_load_ps(ctx.v13.f32)));
	// vmaddfp v5,v21,v12,v18
	simde_mm_store_ps(ctx.v5.f32, simde_mm_add_ps(simde_mm_mul_ps(simde_mm_load_ps(ctx.v21.f32), simde_mm_load_ps(ctx.v12.f32)), simde_mm_load_ps(ctx.v18.f32)));
	// stvx128 v20,r0,r22
	...
	simde_mm_store_ps(ctx.v4.f32, simde_mm_add_ps(simde_mm_mul_ps(simde_mm_load_ps(ctx.v17.f32), simde_mm_load_ps(ctx.v12.f32)), simde_mm_load_ps(ctx.v15.f32)));
	// vmaddfp v3,v14,v12,v6
	simde_mm_store_ps(ctx.v3.f32, simde_mm_add_ps(simde_mm_mul_ps(simde_mm_load_ps(ctx.v14.f32), simde_mm_load_ps(ctx.v12.f32)), simde_mm_load_ps(ctx.v6.f32)));
	// vmaddfp v13,v19,v11,v5
	simde_mm_store_ps(ctx.v13.f32, simde_mm_add_ps(simde_mm_mul_ps(simde_mm_load_ps(ctx.v19.f32), simde_mm_load_ps(ctx.v11.f32)), simde_mm_load_ps(ctx.v5.f32)));
	// vmaddfp v12,v16,v11,v4
	simde_mm_store_ps(ctx.v12.f32, simde_mm_add_ps(simde_mm_mul_ps(simde_mm_load_ps(ctx.v16.f32), simde_mm_load_ps(ctx.v11.f32)), simde_mm_load_ps(ctx.v4.f32)));
	// vmaddfp v11,v10,v11,v3
	simde_mm_store_ps(ctx.v11.f32, simde_mm_add_ps(simde_mm_mul_ps(simde_mm_load_ps(ctx.v10.f32), simde_mm_load_ps(ctx.v11.f32)), simde_mm_load_ps(ctx.v3.f32)));
	// vmaddfp v2,v13,v0,v0
	simde_mm_store_ps(ctx.v2.f32, simde_mm_add_ps(simde_mm_mul_ps(simde_mm_load_ps(ctx.v13.f32), simde_mm_load_ps(ctx.v0.f32)), simde_mm_load_ps(ctx.v0.f32)));
	// vmaddfp v30,v12,v0,v0
	simde_mm_store_ps(ctx.v30.f32, simde_mm_add_ps(simde_mm_mul_ps(simde_mm_load_ps(ctx.v12.f32), simde_mm_load_ps(ctx.v0.f32)), simde_mm_load_ps(ctx.v0.f32)));
	// vmaddfp v29,v11,v0,v0
	simde_mm_store_ps(ctx.v29.f32, simde_mm_add_ps(simde_mm_mul_ps(simde_mm_load_ps(ctx.v11.f32), simde_mm_load_ps(ctx.v0.f32)), simde_mm_load_ps(ctx.v0.f32)));
	// vpermwi128 v40,v2,228
	simde_mm_store_si128((simde__m128i*)ctx.v40.u32, simde_mm_shuffle_epi32(simde_mm_load_si128((simde__m128i*)ctx.v2.u32), 0x1B));
	// vpermwi128 v39,v30,228
	simde_mm_store_si128((simde__m128i*)ctx.v39.u32, simde_mm_shuffle_epi32(simde_mm_load_si128((simde__m128i*)ctx.v30.u32), 0x1B));
	// vcfpuxws128 v38,v40,0
	simde_mm_store_si128((simde__m128i*)ctx.v38.u32, simde_mm_vctuxs(simde_mm_load_ps(ctx.v40.f32)));
	// vcfpuxws128 v36,v39,0
	simde_mm_store_si128((simde__m128i*)ctx.v36.u32, simde_mm_vctuxs(simde_mm_load_ps(ctx.v39.f32)));
	// vpkuwus128 v37,v38,v63
	ctx.r37.u16 = pack_unsigned_word_to_ushort(ctx.r38.u32, ctx.r63.u32);
	// vpkuhus128 v35,v37,v63
	vTemp.u8[0] = ctx.v63.u16[0] > UCHAR_MAX ? UCHAR_MAX : ctx.v63.u16[0];
	vTemp.u8[8] = ctx.v37.u16[0] > UCHAR_MAX ? UCHAR_MAX : ctx.v37.u16[0];
	vTemp.u8[1] = ctx.v63.u16[1] > UCHAR_MAX ? UCHAR_MAX : ctx.v63.u16[1];
	vTemp.u8[9] = ctx.v37.u16[1] > UCHAR_MAX ? UCHAR_MAX : ctx.v37.u16[1];
	vTemp.u8[2] = ctx.v63.u16[2] > UCHAR_MAX ? UCHAR_MAX : ctx.v63.u16[2];
	vTemp.u8[10] = ctx.v37.u16[2] > UCHAR_MAX ? UCHAR_MAX : ctx.v37.u16[2];
	vTemp.u8[3] = ctx.v63.u16[3] > UCHAR_MAX ? UCHAR_MAX : ctx.v63.u16[3];
	vTemp.u8[11] = ctx.v37.u16[3] > UCHAR_MAX ? UCHAR_MAX : ctx.v37.u16[3];
	vTemp.u8[4] = ctx.v63.u16[4] > UCHAR_MAX ? UCHAR_MAX : ctx.v63.u16[4];
	vTemp.u8[12] = ctx.v37.u16[4] > UCHAR_MAX ? UCHAR_MAX : ctx.v37.u16[4];
	vTemp.u8[5] = ctx.v63.u16[5] > UCHAR_MAX ? UCHAR_MAX : ctx.v63.u16[5];
	vTemp.u8[13] = ctx.v37.u16[5] > UCHAR_MAX ? UCHAR_MAX : ctx.v37.u16[5];
	vTemp.u8[6] = ctx.v63.u16[6] > UCHAR_MAX ? UCHAR_MAX : ctx.v63.u16[6];
	vTemp.u8[14] = ctx.v37.u16[6] > UCHAR_MAX ? UCHAR_MAX : ctx.v37.u16[6];
	vTemp.u8[7] = ctx.v63.u16[7] > UCHAR_MAX ? UCHAR_MAX : ctx.v63.u16[7];
	vTemp.u8[15] = ctx.v37.u16[7] > UCHAR_MAX ? UCHAR_MAX : ctx.v37.u16[7];
ctx.v35 = vTemp;
	// vpermwi128 v32,v29,228
	simde_mm_store_si128((simde__m128i*)ctx.v32.u32, simde_mm_shuffle_epi32(simde_mm_load_si128((simde__m128i*)ctx.v29.u32), 0x1B));
	// vpkuwus128 v33,v36,v63
	ctx.r33.u16 = pack_unsigned_word_to_ushort(ctx.r36.u32, ctx.r63.u32);
	// vspltw128 v34,v35,0
	simde_mm_store_si128((simde__m128i*)ctx.v34.u32, simde_mm_shuffle_epi32(simde_mm_load_si128((simde__m128i*)ctx.v35.u32), 0xFF));
	// vcfpuxws128 v59,v32,0
	simde_mm_store_si128((simde__m128i*)ctx.v59.u32, simde_mm_vctuxs(simde_mm_load_ps(ctx.v32.f32)));
	// vpkuhus128 v61,v33,v63
	vTemp.u8[0] = ctx.v63.u16[0] > UCHAR_MAX ? UCHAR_MAX : ctx.v63.u16[0];
	vTemp.u8[8] = ctx.v33.u16[0] > UCHAR_MAX ? UCHAR_MAX : ctx.v33.u16[0];
	vTemp.u8[1] = ctx.v63.u16[1] > UCHAR_MAX ? UCHAR_MAX : ctx.v63.u16[1];
	vTemp.u8[9] = ctx.v33.u16[1] > UCHAR_MAX ? UCHAR_MAX : ctx.v33.u16[1];
	vTemp.u8[2] = ctx.v63.u16[2] > UCHAR_MAX ? UCHAR_MAX : ctx.v63.u16[2];
	vTemp.u8[10] = ctx.v33.u16[2] > UCHAR_MAX ? UCHAR_MAX : ctx.v33.u16[2];
	vTemp.u8[3] = ctx.v63.u16[3] > UCHAR_MAX ? UCHAR_MAX : ctx.v63.u16[3];
	vTemp.u8[11] = ctx.v33.u16[3] > UCHAR_MAX ? UCHAR_MAX : ctx.v33.u16[3];
	vTemp.u8[4] = ctx.v63.u16[4] > UCHAR_MAX ? UCHAR_MAX : ctx.v63.u16[4];
	vTemp.u8[12] = ctx.v33.u16[4] > UCHAR_MAX ? UCHAR_MAX : ctx.v33.u16[4];
	vTemp.u8[5] = ctx.v63.u16[5] > UCHAR_MAX ? UCHAR_MAX : ctx.v63.u16[5];
	vTemp.u8[13] = ctx.v33.u16[5] > UCHAR_MAX ? UCHAR_MAX : ctx.v33.u16[5];
	vTemp.u8[6] = ctx.v63.u16[6] > UCHAR_MAX ? UCHAR_MAX : ctx.v63.u16[6];
	vTemp.u8[14] = ctx.v33.u16[6] > UCHAR_MAX ? UCHAR_MAX : ctx.v33.u16[6];
	vTemp.u8[7] = ctx.v63.u16[7] > UCHAR_MAX ? UCHAR_MAX : ctx.v63.u16[7];
	vTemp.u8[15] = ctx.v33.u16[7] > UCHAR_MAX ? UCHAR_MAX : ctx.v33.u16[7];
ctx.v61 = vTemp;
	// vspltw128 v58,v61,0
	...
	ctx.r57.u16 = pack_unsigned_word_to_ushort(ctx.r59.u32, ctx.r63.u32);
	// stvewx128 v58,r22,r17
	ea = (ctx.r22.u32 + ctx.r17.u32) & ~0x3;
	PPC_STORE_U32(ea, ctx.v58.u32[3 - ((ea & 0xF) >> 2)]);
	// vpkuhus128 v56,v57,v63
	vTemp.u8[0] = ctx.v63.u16[0] > UCHAR_MAX ? UCHAR_MAX : ctx.v63.u16[0];
	vTemp.u8[8] = ctx.v57.u16[0] > UCHAR_MAX ? UCHAR_MAX : ctx.v57.u16[0];
	vTemp.u8[1] = ctx.v63.u16[1] > UCHAR_MAX ? UCHAR_MAX : ctx.v63.u16[1];
	vTemp.u8[9] = ctx.v57.u16[1] > UCHAR_MAX ? UCHAR_MAX : ctx.v57.u16[1];
	vTemp.u8[2] = ctx.v63.u16[2] > UCHAR_MAX ? UCHAR_MAX : ctx.v63.u16[2];
	vTemp.u8[10] = ctx.v57.u16[2] > UCHAR_MAX ? UCHAR_MAX : ctx.v57.u16[2];
	vTemp.u8[3] = ctx.v63.u16[3] > UCHAR_MAX ? UCHAR_MAX : ctx.v63.u16[3];
	vTemp.u8[11] = ctx.v57.u16[3] > UCHAR_MAX ? UCHAR_MAX : ctx.v57.u16[3];
	vTemp.u8[4] = ctx.v63.u16[4] > UCHAR_MAX ? UCHAR_MAX : ctx.v63.u16[4];
	vTemp.u8[12] = ctx.v57.u16[4] > UCHAR_MAX ? UCHAR_MAX : ctx.v57.u16[4];
	vTemp.u8[5] = ctx.v63.u16[5] > UCHAR_MAX ? UCHAR_MAX : ctx.v63.u16[5];
	vTemp.u8[13] = ctx.v57.u16[5] > UCHAR_MAX ? UCHAR_MAX : ctx.v57.u16[5];
	vTemp.u8[6] = ctx.v63.u16[6] > UCHAR_MAX ? UCHAR_MAX : ctx.v63.u16[6];
	vTemp.u8[14] = ctx.v57.u16[6] > UCHAR_MAX ? UCHAR_MAX : ctx.v57.u16[6];
	vTemp.u8[7] = ctx.v63.u16[7] > UCHAR_MAX ? UCHAR_MAX : ctx.v63.u16[7];
	vTemp.u8[15] = ctx.v57.u16[7] > UCHAR_MAX ? UCHAR_MAX : ctx.v57.u16[7];
ctx.v56 = vTemp;
	// vspltw128 v55,v56,0
...
loc_828FEFFC:
	...
	ctx.v54 = vTemp;
	// vspltw128 v61,v54,3
	simde_mm_store_si128((simde__m128i*)ctx.v61.u32, simde_mm_shuffle_epi32(simde_mm_load_si128((simde__m128i*)ctx.v54.u32), 0x0));
loc_828FF018:
	// li r11,128
	ctx.r11.s64 = 128;
	// dcbt r24,r11
...
loc_828FF404:
	...
	// lvx128 v52,r9,r19
	simde_mm_store_si128((simde__m128i*)ctx.v52.u8, simde_mm_shuffle_epi8(simde_mm_load_si128((simde__m128i*)(base + ((ctx.r9.u32 + ctx.r19.u32) & ~0xF))), simde_mm_load_si128((simde__m128i*)VectorMaskL)));
	// addi r11,r9,12
	ctx.r11.s64 = ctx.r9.s64 + 12;
	// lvsl v6,r0,r9
	temp.u32 = ctx.r9.u32;
	...
	simde_mm_store_si128((simde__m128i*)ctx.v5.u8, simde_mm_perm_epi8_(simde_mm_load_si128((simde__m128i*)ctx.v53.u8), simde_mm_load_si128((simde__m128i*)ctx.v52.u8), simde_mm_load_si128((simde__m128i*)ctx.v6.u8)));
	// addi r20,r1,448
	...
	ctx.r8.s64 = ctx.r9.s64 + 20;
	// vsel v6,v5,v13,v31
	simde_mm_store_si128((simde__m128i*)ctx.v6.u8, simde_mm_or_si128(simde_mm_andnot_si128(simde_mm_load_si128((simde__m128i*)ctx.v31.u8), simde_mm_load_si128((simde__m128i*)ctx.v5.u8)), simde_mm_and_si128(simde_mm_load_si128((simde__m128i*)ctx.v31.u8), simde_mm_load_si128((simde__m128i*)ctx.v13.u8))));
	// lvsl v5,r0,r7
	temp.u32 = ctx.r7.u32;
	simde_mm_store_si128((simde__m128i*)ctx.v5.u8, simde_mm_load_si128((simde__m128i*)&VectorShiftTableL[(temp.u32 & 0xF) * 16]));
	// stvx128 v5,r0,r20
	simde_mm_store_si128((simde__m128i*)(base + ((ctx.r20.u32) & ~0xF)), simde_mm_shuffle_epi8(simde_mm_load_si128((simde__m128i*)ctx.v5.u8), simde_mm_load_si128((simde__m128i*)VectorMaskL)));
	// li r4,32
	ctx.r4.s64 = 32;
	// lvsl v3,r0,r10
	temp.u32 = ctx.r10.u32;
	...
	ctx.r25.s64 = 47;
	// stvx128 v6,r0,r14
	simde_mm_store_si128((simde__m128i*)(base + ((ctx.r14.u32) & ~0xF)), simde_mm_shuffle_epi8(simde_mm_load_si128((simde__m128i*)ctx.v6.u8), simde_mm_load_si128((simde__m128i*)VectorMaskL)));
	// lvx128 v50,r11,r19
	simde_mm_store_si128((simde__m128i*)ctx.v50.u8, simde_mm_shuffle_epi8(simde_mm_load_si128((simde__m128i*)(base + ((ctx.r11.u32 + ctx.r19.u32) & ~0xF))), simde_mm_load_si128((simde__m128i*)VectorMaskL)));
	// lvsl v2,r0,r8
	temp.u32 = ctx.r8.u32;
	simde_mm_store_si128((simde__m128i*)ctx.v2.u8, simde_mm_load_si128((simde__m128i*)&VectorShiftTableL[(temp.u32 & 0xF) * 16]));
	// lvx128 v51,r0,r11
	...
	simde_mm_store_si128((simde__m128i*)ctx.v49.u8, simde_mm_perm_epi8_(simde_mm_load_si128((simde__m128i*)ctx.v51.u8), simde_mm_load_si128((simde__m128i*)ctx.v50.u8), simde_mm_load_si128((simde__m128i*)ctx.v4.u8)));
	// vspltw128 v48,v49,0
	...
	simde_mm_store_si128((simde__m128i*)ctx.v47.u8, simde_mm_perm_epi8_(simde_mm_load_si128((simde__m128i*)ctx.v48.u8), simde_mm_load_si128((simde__m128i*)ctx.v63.u8), simde_mm_load_si128((simde__m128i*)ctx.v7.u8)));
	// vcuxwfp128 v30,v47,0
	ctx.fpscr.enableFlushMode();
	simde_mm_store_ps(ctx.v30.f32, simde_mm_cvtepu32_ps_(simde_mm_load_si128((simde__m128i*)ctx.v47.u32)));
	// vmaddfp v5,v30,v8,v9
	simde_mm_store_ps(ctx.v5.f32, simde_mm_add_ps(simde_mm_mul_ps(simde_mm_load_ps(ctx.v30.f32), simde_mm_load_ps(ctx.v8.f32)), simde_mm_load_ps(ctx.v9.f32)));
	// stvx128 v5,r14,r6
	simde_mm_store_si128((simde__m128i*)(base + ((ctx.r14.u32 + ctx.r6.u32) & ~0xF)), simde_mm_shuffle_epi8(simde_mm_load_si128((simde__m128i*)ctx.v5.u8), simde_mm_load_si128((simde__m128i*)VectorMaskL)));
	// lvx128 v46,r0,r10
	...
	// lvx128 v45,r10,r19
	simde_mm_store_si128((simde__m128i*)ctx.v45.u8, simde_mm_shuffle_epi8(simde_mm_load_si128((simde__m128i*)(base + ((ctx.r10.u32 + ctx.r19.u32) & ~0xF))), simde_mm_load_si128((simde__m128i*)VectorMaskL)));
	// vperm128 v44,v46,v45,v3
	simde_mm_store_si128((simde__m128i*)ctx.v44.u8, simde_mm_perm_epi8_(simde_mm_load_si128((simde__m128i*)ctx.v46.u8), simde_mm_load_si128((simde__m128i*)ctx.v45.u8), simde_mm_load_si128((simde__m128i*)ctx.v3.u8)));
	// vspltw128 v43,v44,0
	...
	simde_mm_store_si128((simde__m128i*)ctx.v42.u8, simde_mm_perm_epi8_(simde_mm_load_si128((simde__m128i*)ctx.v43.u8), simde_mm_load_si128((simde__m128i*)ctx.v63.u8), simde_mm_load_si128((simde__m128i*)ctx.v7.u8)));
	// vcuxwfp128 v29,v42,0
	simde_mm_store_ps(ctx.v29.f32, simde_mm_cvtepu32_ps_(simde_mm_load_si128((simde__m128i*)ctx.v42.u32)));
	// vmaddfp v4,v29,v8,v9
	simde_mm_store_ps(ctx.v4.f32, simde_mm_add_ps(simde_mm_mul_ps(simde_mm_load_ps(ctx.v29.f32), simde_mm_load_ps(ctx.v8.f32)), simde_mm_load_ps(ctx.v9.f32)));
	// stvx128 v4,r14,r4
	simde_mm_store_si128((simde__m128i*)(base + ((ctx.r14.u32 + ctx.r4.u32) & ~0xF)), simde_mm_shuffle_epi8(simde_mm_load_si128((simde__m128i*)ctx.v4.u8), simde_mm_load_si128((simde__m128i*)VectorMaskL)));
	// lvx128 v41,r8,r19
	simde_mm_store_si128((simde__m128i*)ctx.v41.u8, simde_mm_shuffle_epi8(simde_mm_load_si128((simde__m128i*)(base + ((ctx.r8.u32 + ctx.r19.u32) & ~0xF))), simde_mm_load_si128((simde__m128i*)VectorMaskL)));
	// lvx128 v40,r0,r8
	simde_mm_store_si128((simde__m128i*)ctx.v40.u8, simde_mm_shuffle_epi8(simde_mm_load_si128((simde__m128i*)(base + ((ctx.r8.u32) & ~0xF))), simde_mm_load_si128((simde__m128i*)VectorMaskL)));
	// vperm128 v39,v40,v41,v2
	simde_mm_store_si128((simde__m128i*)ctx.v39.u8, simde_mm_perm_epi8_(simde_mm_load_si128((simde__m128i*)ctx.v40.u8), simde_mm_load_si128((simde__m128i*)ctx.v41.u8), simde_mm_load_si128((simde__m128i*)ctx.v2.u8)));
	// vspltw128 v38,v39,0
	...
	simde_mm_store_si128((simde__m128i*)ctx.v37.u8, simde_mm_perm_epi8_(simde_mm_load_si128((simde__m128i*)ctx.v38.u8), simde_mm_load_si128((simde__m128i*)ctx.v63.u8), simde_mm_load_si128((simde__m128i*)ctx.v7.u8)));
	// vcuxwfp128 v28,v37,0
	simde_mm_store_ps(ctx.v28.f32, simde_mm_cvtepu32_ps_(simde_mm_load_si128((simde__m128i*)ctx.v37.u32)));
	// vmaddfp v3,v28,v8,v9
	simde_mm_store_ps(ctx.v3.f32, simde_mm_add_ps(simde_mm_mul_ps(simde_mm_load_ps(ctx.v28.f32), simde_mm_load_ps(ctx.v8.f32)), simde_mm_load_ps(ctx.v9.f32)));
	// stvx128 v3,r14,r3
	simde_mm_store_si128((simde__m128i*)(base + ((ctx.r14.u32 + ctx.r3.u32) & ~0xF)), simde_mm_shuffle_epi8(simde_mm_load_si128((simde__m128i*)ctx.v3.u8), simde_mm_load_si128((simde__m128i*)VectorMaskL)));
	// lbz r11,35(r9)
	ctx.r11.u64 = PPC_LOAD_U8(ctx.r9.u32 + 35);
	// lvx128 v36,r9,r25
	simde_mm_store_si128((simde__m128i*)ctx.v36.u8, simde_mm_shuffle_epi8(simde_mm_load_si128((simde__m128i*)(base + ((ctx.r9.u32 + ctx.r25.u32) & ~0xF))), simde_mm_load_si128((simde__m128i*)VectorMaskL)));
	// rotlwi r10,r11,1
	ctx.r10.u64 = __builtin_rotateleft32(ctx.r11.u32, 1);
	// lvx128 v35,r0,r7
	simde_mm_store_si128((simde__m128i*)ctx.v35.u8, simde_mm_shuffle_epi8(simde_mm_load_si128((simde__m128i*)(base + ((ctx.r7.u32) & ~0xF))), simde_mm_load_si128((simde__m128i*)VectorMaskL)));
	// lhzx r8,r10,r18
	...
	simde_mm_store_si128((simde__m128i*)ctx.v34.u8, simde_mm_perm_epi8_(simde_mm_load_si128((simde__m128i*)ctx.v35.u8), simde_mm_load_si128((simde__m128i*)ctx.v36.u8), simde_mm_load_si128((simde__m128i*)ctx.v2.u8)));
	// cmpwi cr6,r10,1
	...
	// lvx128 v59,r11,r30
	simde_mm_store_si128((simde__m128i*)ctx.v59.u8, simde_mm_shuffle_epi8(simde_mm_load_si128((simde__m128i*)(base + ((ctx.r11.u32 + ctx.r30.u32) & ~0xF))), simde_mm_load_si128((simde__m128i*)VectorMaskL)));
	// lvx128 v58,r0,r11
	simde_mm_store_si128((simde__m128i*)ctx.v58.u8, simde_mm_shuffle_epi8(simde_mm_load_si128((simde__m128i*)(base + ((ctx.r11.u32) & ~0xF))), simde_mm_load_si128((simde__m128i*)VectorMaskL)));
	// lvx128 v56,r11,r17
	simde_mm_store_si128((simde__m128i*)ctx.v56.u8, simde_mm_shuffle_epi8(simde_mm_load_si128((simde__m128i*)(base + ((ctx.r11.u32 + ctx.r17.u32) & ~0xF))), simde_mm_load_si128((simde__m128i*)VectorMaskL)));
	// vperm128 v57,v33,v63,v1
	simde_mm_store_si128((simde__m128i*)ctx.v57.u8, simde_mm_perm_epi8_(simde_mm_load_si128((simde__m128i*)ctx.v33.u8), simde_mm_load_si128((simde__m128i*)ctx.v63.u8), simde_mm_load_si128((simde__m128i*)ctx.v1.u8)));
	// lvx128 v32,r11,r29
	simde_mm_store_si128((simde__m128i*)ctx.v32.u8, simde_mm_shuffle_epi8(simde_mm_load_si128((simde__m128i*)(base + ((ctx.r11.u32 + ctx.r29.u32) & ~0xF))), simde_mm_load_si128((simde__m128i*)VectorMaskL)));
	// vcuxwfp128 v55,v57,0
	simde_mm_store_ps(ctx.v55.f32, simde_mm_cvtepu32_ps_(simde_mm_load_si128((simde__m128i*)ctx.v57.u32)));
	// vmulfp128 v62,v55,v60
	simde_mm_store_ps(ctx.v62.f32, simde_mm_mul_ps(simde_mm_load_ps(ctx.v55.f32), simde_mm_load_ps(ctx.v60.f32)));
	// vspltw128 v54,v62,3
	simde_mm_store_si128((simde__m128i*)ctx.v54.u32, simde_mm_shuffle_epi32(simde_mm_load_si128((simde__m128i*)ctx.v62.u32), 0x0));
	// vmulfp128 v11,v32,v54
	simde_mm_store_ps(ctx.v11.f32, simde_mm_mul_ps(simde_mm_load_ps(ctx.v32.f32), simde_mm_load_ps(ctx.v54.f32)));
	// vmulfp128 v12,v56,v54
	simde_mm_store_ps(ctx.v12.f32, simde_mm_mul_ps(simde_mm_load_ps(ctx.v56.f32), simde_mm_load_ps(ctx.v54.f32)));
	// vmulfp128 v13,v58,v54
	simde_mm_store_ps(ctx.v13.f32, simde_mm_mul_ps(simde_mm_load_ps(ctx.v58.f32), simde_mm_load_ps(ctx.v54.f32)));
	// vmulfp128 v10,v59,v54
	simde_mm_store_ps(ctx.v10.f32, simde_mm_mul_ps(simde_mm_load_ps(ctx.v59.f32), simde_mm_load_ps(ctx.v54.f32)));
	// ble cr6,0x828ff5d4
	if (!ctx.cr6.gt) goto loc_828FF5D4;
	// lbz r11,34(r9)
	ctx.r11.u64 = PPC_LOAD_U8(ctx.r9.u32 + 34);
	// vspltw128 v2,v62,2
	simde_mm_store_si128((simde__m128i*)ctx.v2.u32, simde_mm_shuffle_epi32(simde_mm_load_si128((simde__m128i*)ctx.v62.u32), 0x55));
	// cmpwi cr6,r10,2
	...
	// lvx128 v29,r11,r17
	simde_mm_store_si128((simde__m128i*)ctx.v29.u8, simde_mm_shuffle_epi8(simde_mm_load_si128((simde__m128i*)(base + ((ctx.r11.u32 + ctx.r17.u32) & ~0xF))), simde_mm_load_si128((simde__m128i*)VectorMaskL)));
	// vmaddfp v13,v30,v2,v13
	simde_mm_store_ps(ctx.v13.f32, simde_mm_add_ps(simde_mm_mul_ps(simde_mm_load_ps(ctx.v30.f32), simde_mm_load_ps(ctx.v2.f32)), simde_mm_load_ps(ctx.v13.f32)));
	// lvx128 v28,r11,r29
	simde_mm_store_si128((simde__m128i*)ctx.v28.u8, simde_mm_shuffle_epi8(simde_mm_load_si128((simde__m128i*)(base + ((ctx.r11.u32 + ctx.r29.u32) & ~0xF))), simde_mm_load_si128((simde__m128i*)VectorMaskL)));
	// vmaddfp v12,v29,v2,v12
	simde_mm_store_ps(ctx.v12.f32, simde_mm_add_ps(simde_mm_mul_ps(simde_mm_load_ps(ctx.v29.f32), simde_mm_load_ps(ctx.v2.f32)), simde_mm_load_ps(ctx.v12.f32)));
	// lvx128 v27,r11,r30
	simde_mm_store_si128((simde__m128i*)ctx.v27.u8, simde_mm_shuffle_epi8(simde_mm_load_si128((simde__m128i*)(base + ((ctx.r11.u32 + ctx.r30.u32) & ~0xF))), simde_mm_load_si128((simde__m128i*)VectorMaskL)));
	// vmaddfp v11,v28,v2,v11
	simde_mm_store_ps(ctx.v11.f32, simde_mm_add_ps(simde_mm_mul_ps(simde_mm_load_ps(ctx.v28.f32), simde_mm_load_ps(ctx.v2.f32)), simde_mm_load_ps(ctx.v11.f32)));
	// vmaddfp v10,v27,v2,v10
	simde_mm_store_ps(ctx.v10.f32, simde_mm_add_ps(simde_mm_mul_ps(simde_mm_load_ps(ctx.v27.f32), simde_mm_load_ps(ctx.v2.f32)), simde_mm_load_ps(ctx.v10.f32)));
	// ble cr6,0x828ff5d4
	if (!ctx.cr6.gt) goto loc_828FF5D4;
	// lbz r11,33(r9)
	...
	// vspltw128 v2,v62,1
	simde_mm_store_si128((simde__m128i*)ctx.v2.u32, simde_mm_shuffle_epi32(simde_mm_load_si128((simde__m128i*)ctx.v62.u32), 0xAA));
	// rotlwi r10,r11,1
	ctx.r10.u64 = __builtin_rotateleft32(ctx.r11.u32, 1);
	// lhzx r8,r10,r18
	ctx.r8.u64 = PPC_LOAD_U16(ctx.r10.u32 + ctx.r18.u32);
	...
	// vspltw128 v2,v62,0
	simde_mm_store_si128((simde__m128i*)ctx.v2.u32, simde_mm_shuffle_epi32(simde_mm_load_si128((simde__m128i*)ctx.v62.u32), 0xFF));
	// rotlwi r10,r11,1
	ctx.r10.u64 = __builtin_rotateleft32(ctx.r11.u32, 1);
	// lhzx r8,r10,r18
	ctx.r8.u64 = PPC_LOAD_U16(ctx.r10.u32 + ctx.r18.u32);
...
loc_828FF5D4:
	// vspltw128 v53,v5,2
	simde_mm_store_si128((simde__m128i*)ctx.v53.u32, simde_mm_shuffle_epi32(simde_mm_load_si128((simde__m128i*)ctx.v5.u32), 0x55));
	// li r11,12
	ctx.r11.s64 = 12;
	// vspltw128 v52,v4,2
	simde_mm_store_si128((simde__m128i*)ctx.v52.u32, simde_mm_shuffle_epi32(simde_mm_load_si128((simde__m128i*)ctx.v4.u32), 0x55));
	// li r10,20
	ctx.r10.s64 = 20;
	// vspltw128 v51,v3,2
	simde_mm_store_si128((simde__m128i*)ctx.v51.u32, simde_mm_shuffle_epi32(simde_mm_load_si128((simde__m128i*)ctx.v3.u32), 0x55));
	// addi r23,r23,1
	ctx.r23.s64 = ctx.r23.s64 + 1;
	// vspltw v2,v6,2
	...
	ctx.fpscr.enableFlushMode();
	simde_mm_store_ps(ctx.v30.f32, simde_mm_mul_ps(simde_mm_load_ps(ctx.v53.f32), simde_mm_load_ps(ctx.v11.f32)));
	// vspltw v29,v5,1
	...
	simde_mm_store_ps(ctx.v28.f32, simde_mm_mul_ps(simde_mm_load_ps(ctx.v52.f32), simde_mm_load_ps(ctx.v11.f32)));
	// vspltw v27,v4,1
	simde_mm_store_si128((simde__m128i*)ctx.v27.u32, simde_mm_shuffle_epi32(simde_mm_load_si128((simde__m128i*)ctx.v4.u32), 0xAA));
	// vmulfp128 v26,v51,v11
	simde_mm_store_ps(ctx.v26.f32, simde_mm_mul_ps(simde_mm_load_ps(ctx.v51.f32), simde_mm_load_ps(ctx.v11.f32)));
	// vspltw v25,v3,1
	simde_mm_store_si128((simde__m128i*)ctx.v25.u32, simde_mm_shuffle_epi32(simde_mm_load_si128((simde__m128i*)ctx.v3.u32), 0xAA));
	// vmaddfp v24,v2,v11,v10
	simde_mm_store_ps(ctx.v24.f32, simde_mm_add_ps(simde_mm_mul_ps(simde_mm_load_ps(ctx.v2.f32), simde_mm_load_ps(ctx.v11.f32)), simde_mm_load_ps(ctx.v10.f32)));
	// vspltw v23,v6,1
	simde_mm_store_si128((simde__m128i*)ctx.v23.u32, simde_mm_shuffle_epi32(simde_mm_load_si128((simde__m128i*)ctx.v6.u32), 0xAA));
	// vspltw v22,v5,0
	simde_mm_store_si128((simde__m128i*)ctx.v22.u32, simde_mm_shuffle_epi32(simde_mm_load_si128((simde__m128i*)ctx.v5.u32), 0xFF));
	// addi r24,r24,40
	ctx.r24.s64 = ctx.r24.s64 + 40;
	// vspltw v21,v4,0
	simde_mm_store_si128((simde__m128i*)ctx.v21.u32, simde_mm_shuffle_epi32(simde_mm_load_si128((simde__m128i*)ctx.v4.u32), 0xFF));
	// vspltw v20,v3,0
	simde_mm_store_si128((simde__m128i*)ctx.v20.u32, simde_mm_shuffle_epi32(simde_mm_load_si128((simde__m128i*)ctx.v3.u32), 0xFF));
	// vspltw v19,v6,0
	simde_mm_store_si128((simde__m128i*)ctx.v19.u32, simde_mm_shuffle_epi32(simde_mm_load_si128((simde__m128i*)ctx.v6.u32), 0xFF));
	...
	simde_mm_store_ps(ctx.v17.f32, simde_mm_add_ps(simde_mm_mul_ps(simde_mm_load_ps(ctx.v27.f32), simde_mm_load_ps(ctx.v12.f32)), simde_mm_load_ps(ctx.v28.f32)));
	...
	simde_mm_store_ps(ctx.v15.f32, simde_mm_add_ps(simde_mm_mul_ps(simde_mm_load_ps(ctx.v23.f32), simde_mm_load_ps(ctx.v12.f32)), simde_mm_load_ps(ctx.v24.f32)));
	// vmaddfp v12,v22,v13,v18
	simde_mm_store_ps(ctx.v12.f32, simde_mm_add_ps(simde_mm_mul_ps(simde_mm_load_ps(ctx.v22.f32), simde_mm_load_ps(ctx.v13.f32)), simde_mm_load_ps(ctx.v18.f32)));
	// vmaddfp v11,v21,v13,v17
	simde_mm_store_ps(ctx.v11.f32, simde_mm_add_ps(simde_mm_mul_ps(simde_mm_load_ps(ctx.v21.f32), simde_mm_load_ps(ctx.v13.f32)), simde_mm_load_ps(ctx.v17.f32)));
	// vmaddfp v10,v20,v13,v16
	simde_mm_store_ps(ctx.v10.f32, simde_mm_add_ps(simde_mm_mul_ps(simde_mm_load_ps(ctx.v20.f32), simde_mm_load_ps(ctx.v13.f32)), simde_mm_load_ps(ctx.v16.f32)));
	// vmaddfp v14,v19,v13,v15
	simde_mm_store_ps(ctx.v14.f32, simde_mm_add_ps(simde_mm_mul_ps(simde_mm_load_ps(ctx.v19.f32), simde_mm_load_ps(ctx.v13.f32)), simde_mm_load_ps(ctx.v15.f32)));
	// vmaddfp v13,v12,v0,v0
	simde_mm_store_ps(ctx.v13.f32, simde_mm_add_ps(simde_mm_mul_ps(simde_mm_load_ps(ctx.v12.f32), simde_mm_load_ps(ctx.v0.f32)), simde_mm_load_ps(ctx.v0.f32)));
	// vmaddfp v12,v11,v0,v0
	simde_mm_store_ps(ctx.v12.f32, simde_mm_add_ps(simde_mm_mul_ps(simde_mm_load_ps(ctx.v11.f32), simde_mm_load_ps(ctx.v0.f32)), simde_mm_load_ps(ctx.v0.f32)));
	// vmaddfp v11,v10,v0,v0
	simde_mm_store_ps(ctx.v11.f32, simde_mm_add_ps(simde_mm_mul_ps(simde_mm_load_ps(ctx.v10.f32), simde_mm_load_ps(ctx.v0.f32)), simde_mm_load_ps(ctx.v0.f32)));
	// stvx128 v14,r0,r22
	simde_mm_store_si128((simde__m128i*)(base + ((ctx.r22.u32) & ~0xF)), simde_mm_shuffle_epi8(simde_mm_load_si128((simde__m128i*)ctx.v14.u8), simde_mm_load_si128((simde__m128i*)VectorMaskL)));
	// vpermwi128 v50,v13,228
	simde_mm_store_si128((simde__m128i*)ctx.v50.u32, simde_mm_shuffle_epi32(simde_mm_load_si128((simde__m128i*)ctx.v13.u32), 0x1B));
	// vpermwi128 v49,v12,228
	simde_mm_store_si128((simde__m128i*)ctx.v49.u32, simde_mm_shuffle_epi32(simde_mm_load_si128((simde__m128i*)ctx.v12.u32), 0x1B));
	// vpermwi128 v48,v11,228
	simde_mm_store_si128((simde__m128i*)ctx.v48.u32, simde_mm_shuffle_epi32(simde_mm_load_si128((simde__m128i*)ctx.v11.u32), 0x1B));
	// vcfpuxws128 v47,v50,0
	simde_mm_store_si128((simde__m128i*)ctx.v47.u32, simde_mm_vctuxs(simde_mm_load_ps(ctx.v50.f32)));
	// vcfpuxws128 v46,v49,0
	simde_mm_store_si128((simde__m128i*)ctx.v46.u32, simde_mm_vctuxs(simde_mm_load_ps(ctx.v49.f32)));
	// vcfpuxws128 v45,v48,0
	simde_mm_store_si128((simde__m128i*)ctx.v45.u32, simde_mm_vctuxs(simde_mm_load_ps(ctx.v48.f32)));
	// vpkuwus128 v44,v47,v63
	ctx.r44.u16 = pack_unsigned_word_to_ushort(ctx.r47.u32, ctx.r63.u32);
	// vpkuwus128 v43,v46,v63
	ctx.r43.u16 = pack_unsigned_word_to_ushort(ctx.r46.u32, ctx.r63.u32);
	// vpkuwus128 v42,v45,v63
	ctx.r42.u16 = pack_unsigned_word_to_ushort(ctx.r45.u32, ctx.r63.u32);
	// vpkuhus128 v41,v44,v63
	vTemp.u8[0] = ctx.v63.u16[0] > UCHAR_MAX ? UCHAR_MAX : ctx.v63.u16[0];
	vTemp.u8[8] = ctx.v44.u16[0] > UCHAR_MAX ? UCHAR_MAX : ctx.v44.u16[0];
	vTemp.u8[1] = ctx.v63.u16[1] > UCHAR_MAX ? UCHAR_MAX : ctx.v63.u16[1];
	vTemp.u8[9] = ctx.v44.u16[1] > UCHAR_MAX ? UCHAR_MAX : ctx.v44.u16[1];
	vTemp.u8[2] = ctx.v63.u16[2] > UCHAR_MAX ? UCHAR_MAX : ctx.v63.u16[2];
	vTemp.u8[10] = ctx.v44.u16[2] > UCHAR_MAX ? UCHAR_MAX : ctx.v44.u16[2];
	vTemp.u8[3] = ctx.v63.u16[3] > UCHAR_MAX ? UCHAR_MAX : ctx.v63.u16[3];
	vTemp.u8[11] = ctx.v44.u16[3] > UCHAR_MAX ? UCHAR_MAX : ctx.v44.u16[3];
	vTemp.u8[4] = ctx.v63.u16[4] > UCHAR_MAX ? UCHAR_MAX : ctx.v63.u16[4];
	vTemp.u8[12] = ctx.v44.u16[4] > UCHAR_MAX ? UCHAR_MAX : ctx.v44.u16[4];
	vTemp.u8[5] = ctx.v63.u16[5] > UCHAR_MAX ? UCHAR_MAX : ctx.v63.u16[5];
	vTemp.u8[13] = ctx.v44.u16[5] > UCHAR_MAX ? UCHAR_MAX : ctx.v44.u16[5];
	vTemp.u8[6] = ctx.v63.u16[6] > UCHAR_MAX ? UCHAR_MAX : ctx.v63.u16[6];
	vTemp.u8[14] = ctx.v44.u16[6] > UCHAR_MAX ? UCHAR_MAX : ctx.v44.u16[6];
	vTemp.u8[7] = ctx.v63.u16[7] > UCHAR_MAX ? UCHAR_MAX : ctx.v63.u16[7];
	vTemp.u8[15] = ctx.v44.u16[7] > UCHAR_MAX ? UCHAR_MAX : ctx.v44.u16[7];
ctx.v41 = vTemp;
	// vpkuhus128 v40,v43,v63
	vTemp.u8[0] = ctx.v63.u16[0] > UCHAR_MAX ? UCHAR_MAX : ctx.v63.u16[0];
	vTemp.u8[8] = ctx.v43.u16[0] > UCHAR_MAX ? UCHAR_MAX : ctx.v43.u16[0];
	vTemp.u8[1] = ctx.v63.u16[1] > UCHAR_MAX ? UCHAR_MAX : ctx.v63.u16[1];
	vTemp.u8[9] = ctx.v43.u16[1] > UCHAR_MAX ? UCHAR_MAX : ctx.v43.u16[1];
	vTemp.u8[2] = ctx.v63.u16[2] > UCHAR_MAX ? UCHAR_MAX : ctx.v63.u16[2];
	vTemp.u8[10] = ctx.v43.u16[2] > UCHAR_MAX ? UCHAR_MAX : ctx.v43.u16[2];
	vTemp.u8[3] = ctx.v63.u16[3] > UCHAR_MAX ? UCHAR_MAX : ctx.v63.u16[3];
	vTemp.u8[11] = ctx.v43.u16[3] > UCHAR_MAX ? UCHAR_MAX : ctx.v43.u16[3];
	vTemp.u8[4] = ctx.v63.u16[4] > UCHAR_MAX ? UCHAR_MAX : ctx.v63.u16[4];
	vTemp.u8[12] = ctx.v43.u16[4] > UCHAR_MAX ? UCHAR_MAX : ctx.v43.u16[4];
	vTemp.u8[5] = ctx.v63.u16[5] > UCHAR_MAX ? UCHAR_MAX : ctx.v63.u16[5];
	vTemp.u8[13] = ctx.v43.u16[5] > UCHAR_MAX ? UCHAR_MAX : ctx.v43.u16[5];
	vTemp.u8[6] = ctx.v63.u16[6] > UCHAR_MAX ? UCHAR_MAX : ctx.v63.u16[6];
	vTemp.u8[14] = ctx.v43.u16[6] > UCHAR_MAX ? UCHAR_MAX : ctx.v43.u16[6];
	vTemp.u8[7] = ctx.v63.u16[7] > UCHAR_MAX ? UCHAR_MAX : ctx.v63.u16[7];
	vTemp.u8[15] = ctx.v43.u16[7] > UCHAR_MAX ? UCHAR_MAX : ctx.v43.u16[7];
ctx.v40 = vTemp;
	// vpkuhus128 v39,v42,v63
	vTemp.u8[0] = ctx.v63.u16[0] > UCHAR_MAX ? UCHAR_MAX : ctx.v63.u16[0];
	vTemp.u8[8] = ctx.v42.u16[0] > UCHAR_MAX ? UCHAR_MAX : ctx.v42.u16[0];
	vTemp.u8[1] = ctx.v63.u16[1] > UCHAR_MAX ? UCHAR_MAX : ctx.v63.u16[1];
	vTemp.u8[9] = ctx.v42.u16[1] > UCHAR_MAX ? UCHAR_MAX : ctx.v42.u16[1];
	vTemp.u8[2] = ctx.v63.u16[2] > UCHAR_MAX ? UCHAR_MAX : ctx.v63.u16[2];
	vTemp.u8[10] = ctx.v42.u16[2] > UCHAR_MAX ? UCHAR_MAX : ctx.v42.u16[2];
	vTemp.u8[3] = ctx.v63.u16[3] > UCHAR_MAX ? UCHAR_MAX : ctx.v63.u16[3];
	vTemp.u8[11] = ctx.v42.u16[3] > UCHAR_MAX ? UCHAR_MAX : ctx.v42.u16[3];
	vTemp.u8[4] = ctx.v63.u16[4] > UCHAR_MAX ? UCHAR_MAX : ctx.v63.u16[4];
	vTemp.u8[12] = ctx.v42.u16[4] > UCHAR_MAX ? UCHAR_MAX : ctx.v42.u16[4];
	vTemp.u8[5] = ctx.v63.u16[5] > UCHAR_MAX ? UCHAR_MAX : ctx.v63.u16[5];
	vTemp.u8[13] = ctx.v42.u16[5] > UCHAR_MAX ? UCHAR_MAX : ctx.v42.u16[5];
	vTemp.u8[6] = ctx.v63.u16[6] > UCHAR_MAX ? UCHAR_MAX : ctx.v63.u16[6];
	vTemp.u8[14] = ctx.v42.u16[6] > UCHAR_MAX ? UCHAR_MAX : ctx.v42.u16[6];
	vTemp.u8[7] = ctx.v63.u16[7] > UCHAR_MAX ? UCHAR_MAX : ctx.v63.u16[7];
	vTemp.u8[15] = ctx.v42.u16[7] > UCHAR_MAX ? UCHAR_MAX : ctx.v42.u16[7];
ctx.v39 = vTemp;
	// vspltw128 v38,v41,0
	simde_mm_store_si128((simde__m128i*)ctx.v38.u32, simde_mm_shuffle_epi32(simde_mm_load_si128((simde__m128i*)ctx.v41.u32), 0xFF));
	// vspltw128 v37,v40,0
	simde_mm_store_si128((simde__m128i*)ctx.v37.u32, simde_mm_shuffle_epi32(simde_mm_load_si128((simde__m128i*)ctx.v40.u32), 0xFF));
	// vspltw128 v36,v39,0
	simde_mm_store_si128((simde__m128i*)ctx.v36.u32, simde_mm_shuffle_epi32(simde_mm_load_si128((simde__m128i*)ctx.v39.u32), 0xFF));
...
loc_829001EC:
	...
	ctx.r11.s64 = ctx.r11.s64 + 6;
	// lvx128 v61,r7,r4
	simde_mm_store_si128((simde__m128i*)ctx.v61.u8, simde_mm_shuffle_epi8(simde_mm_load_si128((simde__m128i*)(base + ((ctx.r7.u32 + ctx.r4.u32) & ~0xF))), simde_mm_load_si128((simde__m128i*)VectorMaskL)));
	// lvx128 v60,r0,r7
	...
	simde_mm_store_si128((simde__m128i*)ctx.v58.u8, simde_mm_perm_epi8_(simde_mm_load_si128((simde__m128i*)ctx.v60.u8), simde_mm_load_si128((simde__m128i*)ctx.v61.u8), simde_mm_load_si128((simde__m128i*)ctx.v0.u8)));
	// lvx128 v57,r0,r6
	simde_mm_store_si128((simde__m128i*)ctx.v57.u8, simde_mm_shuffle_epi8(simde_mm_load_si128((simde__m128i*)(base + ((ctx.r6.u32) & ~0xF))), simde_mm_load_si128((simde__m128i*)VectorMaskL)));
	// lvx128 v55,r0,r5
	simde_mm_store_si128((simde__m128i*)ctx.v55.u8, simde_mm_shuffle_epi8(simde_mm_load_si128((simde__m128i*)(base + ((ctx.r5.u32) & ~0xF))), simde_mm_load_si128((simde__m128i*)VectorMaskL)));
	// vperm128 v56,v57,v59,v7
	simde_mm_store_si128((simde__m128i*)ctx.v56.u8, simde_mm_perm_epi8_(simde_mm_load_si128((simde__m128i*)ctx.v57.u8), simde_mm_load_si128((simde__m128i*)ctx.v59.u8), simde_mm_load_si128((simde__m128i*)ctx.v7.u8)));
	// lvx128 v54,r5,r4
	simde_mm_store_si128((simde__m128i*)ctx.v54.u8, simde_mm_shuffle_epi8(simde_mm_load_si128((simde__m128i*)(base + ((ctx.r5.u32 + ctx.r4.u32) & ~0xF))), simde_mm_load_si128((simde__m128i*)VectorMaskL)));
	// lvsl v6,r0,r3
	temp.u32 = ctx.r3.u32;
	simde_mm_store_si128((simde__m128i*)ctx.v6.u8, simde_mm_load_si128((simde__m128i*)&VectorShiftTableL[(temp.u32 & 0xF) * 16]));
	// vmulfp128 v52,v58,v62
	ctx.fpscr.enableFlushMode();
	simde_mm_store_ps(ctx.v52.f32, simde_mm_mul_ps(simde_mm_load_ps(ctx.v58.f32), simde_mm_load_ps(ctx.v62.f32)));
	// vperm128 v53,v55,v54,v6
	simde_mm_store_si128((simde__m128i*)ctx.v53.u8, simde_mm_perm_epi8_(simde_mm_load_si128((simde__m128i*)ctx.v55.u8), simde_mm_load_si128((simde__m128i*)ctx.v54.u8), simde_mm_load_si128((simde__m128i*)ctx.v6.u8)));
	// vsubfp128 v51,v58,v56
	simde_mm_store_ps(ctx.v51.f32, simde_mm_sub_ps(simde_mm_load_ps(ctx.v58.f32), simde_mm_load_ps(ctx.v56.f32)));
	// vsubfp128 v50,v53,v56
	simde_mm_store_ps(ctx.v50.f32, simde_mm_sub_ps(simde_mm_load_ps(ctx.v53.f32), simde_mm_load_ps(ctx.v56.f32)));
	// vsubfp128 v49,v63,v52
	simde_mm_store_ps(ctx.v49.f32, simde_mm_sub_ps(simde_mm_load_ps(ctx.v63.f32), simde_mm_load_ps(ctx.v52.f32)));
...
PPC_FUNC_IMPL(__imp__sub_82900868) {
	...
	// lvx128 v61,r3,r11
	simde_mm_store_si128((simde__m128i*)ctx.v61.u8, simde_mm_shuffle_epi8(simde_mm_load_si128((simde__m128i*)(base + ((ctx.r3.u32 + ctx.r11.u32) & ~0xF))), simde_mm_load_si128((simde__m128i*)VectorMaskL)));
	// li r6,16
	ctx.r6.s64 = 16;
	// vperm128 v60,v63,v61,v0
	simde_mm_store_si128((simde__m128i*)ctx.v60.u8, simde_mm_perm_epi8_(simde_mm_load_si128((simde__m128i*)ctx.v63.u8), simde_mm_load_si128((simde__m128i*)ctx.v61.u8), simde_mm_load_si128((simde__m128i*)ctx.v0.u8)));
	// lvx128 v0,r0,r8
	...
	simde_mm_store_si128((simde__m128i*)ctx.v58.u8, simde_mm_perm_epi8_(simde_mm_load_si128((simde__m128i*)ctx.v59.u8), simde_mm_load_si128((simde__m128i*)ctx.v62.u8), simde_mm_load_si128((simde__m128i*)ctx.v0.u8)));
	// vcuxwfp128 v11,v58,0
	ctx.fpscr.enableFlushMode();
	simde_mm_store_ps(ctx.v11.f32, simde_mm_cvtepu32_ps_(simde_mm_load_si128((simde__m128i*)ctx.v58.u32)));
	// vmaddfp v1,v11,v12,v13
	simde_mm_store_ps(ctx.v1.f32, simde_mm_add_ps(simde_mm_mul_ps(simde_mm_load_ps(ctx.v11.f32), simde_mm_load_ps(ctx.v12.f32)), simde_mm_load_ps(ctx.v13.f32)));
	// blr 
	return;
}
...
PPC_FUNC_IMPL(__imp__sub_829008B8) {
	...
	// vmaddfp v0,v1,v0,v0
	ctx.fpscr.enableFlushMode();
	simde_mm_store_ps(ctx.v0.f32, simde_mm_add_ps(simde_mm_mul_ps(simde_mm_load_ps(ctx.v1.f32), simde_mm_load_ps(ctx.v0.f32)), simde_mm_load_ps(ctx.v0.f32)));
	// vpermwi128 v62,v0,228
	simde_mm_store_si128((simde__m128i*)ctx.v62.u32, simde_mm_shuffle_epi32(simde_mm_load_si128((simde__m128i*)ctx.v0.u32), 0x1B));
	// vcfpuxws128 v61,v62,0
	simde_mm_store_si128((simde__m128i*)ctx.v61.u32, simde_mm_vctuxs(simde_mm_load_ps(ctx.v62.f32)));
	// vpkuwus128 v60,v61,v63
	ctx.r60.u16 = pack_unsigned_word_to_ushort(ctx.r61.u32, ctx.r63.u32);
	// vpkuhus128 v59,v60,v63
	vTemp.u8[0] = ctx.v63.u16[0] > UCHAR_MAX ? UCHAR_MAX : ctx.v63.u16[0];
	vTemp.u8[8] = ctx.v60.u16[0] > UCHAR_MAX ? UCHAR_MAX : ctx.v60.u16[0];
	vTemp.u8[1] = ctx.v63.u16[1] > UCHAR_MAX ? UCHAR_MAX : ctx.v63.u16[1];
	vTemp.u8[9] = ctx.v60.u16[1] > UCHAR_MAX ? UCHAR_MAX : ctx.v60.u16[1];
	vTemp.u8[2] = ctx.v63.u16[2] > UCHAR_MAX ? UCHAR_MAX : ctx.v63.u16[2];
	vTemp.u8[10] = ctx.v60.u16[2] > UCHAR_MAX ? UCHAR_MAX : ctx.v60.u16[2];
	vTemp.u8[3] = ctx.v63.u16[3] > UCHAR_MAX ? UCHAR_MAX : ctx.v63.u16[3];
	vTemp.u8[11] = ctx.v60.u16[3] > UCHAR_MAX ? UCHAR_MAX : ctx.v60.u16[3];
	vTemp.u8[4] = ctx.v63.u16[4] > UCHAR_MAX ? UCHAR_MAX : ctx.v63.u16[4];
	vTemp.u8[12] = ctx.v60.u16[4] > UCHAR_MAX ? UCHAR_MAX : ctx.v60.u16[4];
	vTemp.u8[5] = ctx.v63.u16[5] > UCHAR_MAX ? UCHAR_MAX : ctx.v63.u16[5];
	vTemp.u8[13] = ctx.v60.u16[5] > UCHAR_MAX ? UCHAR_MAX : ctx.v60.u16[5];
	vTemp.u8[6] = ctx.v63.u16[6] > UCHAR_MAX ? UCHAR_MAX : ctx.v63.u16[6];
	vTemp.u8[14] = ctx.v60.u16[6] > UCHAR_MAX ? UCHAR_MAX : ctx.v60.u16[6];
	vTemp.u8[7] = ctx.v63.u16[7] > UCHAR_MAX ? UCHAR_MAX : ctx.v63.u16[7];
	vTemp.u8[15] = ctx.v60.u16[7] > UCHAR_MAX ? UCHAR_MAX : ctx.v60.u16[7];
ctx.v59 = vTemp;
	// vspltw128 v58,v59,0
...
loc_82900948:
	...
	ctx.r11.s64 = -2111700992;
	// lvx128 v9,r4,r31
	simde_mm_store_si128((simde__m128i*)ctx.v9.u8, simde_mm_shuffle_epi8(simde_mm_load_si128((simde__m128i*)(base + ((ctx.r4.u32 + ctx.r31.u32) & ~0xF))), simde_mm_load_si128((simde__m128i*)VectorMaskL)));
	// lis r10,-31881
	ctx.r10.s64 = -2089353216;
	// lvx128 v1,r0,r6
	...
	ctx.r8.s64 = -2089353216;
	// lvx128 v8,r4,r28
	simde_mm_store_si128((simde__m128i*)ctx.v8.u8, simde_mm_shuffle_epi8(simde_mm_load_si128((simde__m128i*)(base + ((ctx.r4.u32 + ctx.r28.u32) & ~0xF))), simde_mm_load_si128((simde__m128i*)VectorMaskL)));
	// addi r11,r11,-18304
	ctx.r11.s64 = ctx.r11.s64 + -18304;
	// lvx128 v0,r4,r27
	simde_mm_store_si128((simde__m128i*)ctx.v0.u8, simde_mm_shuffle_epi8(simde_mm_load_si128((simde__m128i*)(base + ((ctx.r4.u32 + ctx.r27.u32) & ~0xF))), simde_mm_load_si128((simde__m128i*)VectorMaskL)));
	// li r22,11
	ctx.r22.s64 = 11;
	// li r16,32
	ctx.r16.s64 = 32;
...
loc_82900E8C:
	...
	simde_mm_store_si128((simde__m128i*)ctx.v61.u8, simde_mm_shuffle_epi8(simde_mm_load_si128((simde__m128i*)(base + ((ctx.r9.u32) & ~0xF))), simde_mm_load_si128((simde__m128i*)VectorMaskL)));
	// lvx128 v59,r9,r22
	simde_mm_store_si128((simde__m128i*)ctx.v59.u8, simde_mm_shuffle_epi8(simde_mm_load_si128((simde__m128i*)(base + ((ctx.r9.u32 + ctx.r22.u32) & ~0xF))), simde_mm_load_si128((simde__m128i*)VectorMaskL)));
	// vor128 v5,v62,v62
	simde_mm_store_si128((simde__m128i*)ctx.v5.u8, simde_mm_load_si128((simde__m128i*)ctx.v62.u8));
	// lvsl v6,r0,r9
	temp.u32 = ctx.r9.u32;
	...
	ctx.r26.s64 = ctx.r26.s64 + 1;
	// lvx128 v57,r11,r22
	simde_mm_store_si128((simde__m128i*)ctx.v57.u8, simde_mm_shuffle_epi8(simde_mm_load_si128((simde__m128i*)(base + ((ctx.r11.u32 + ctx.r22.u32) & ~0xF))), simde_mm_load_si128((simde__m128i*)VectorMaskL)));
	// rotlwi r6,r7,1
	ctx.r6.u64 = __builtin_rotateleft32(ctx.r7.u32, 1);
	// lvsl v3,r0,r11
	temp.u32 = ctx.r11.u32;
	...
	simde_mm_store_si128((simde__m128i*)ctx.v55.u8, simde_mm_shuffle_epi8(simde_mm_load_si128((simde__m128i*)(base + ((ctx.r10.u32) & ~0xF))), simde_mm_load_si128((simde__m128i*)VectorMaskL)));
	// lvx128 v54,r10,r22
	simde_mm_store_si128((simde__m128i*)ctx.v54.u8, simde_mm_shuffle_epi8(simde_mm_load_si128((simde__m128i*)(base + ((ctx.r10.u32 + ctx.r22.u32) & ~0xF))), simde_mm_load_si128((simde__m128i*)VectorMaskL)));
	// addi r18,r18,1
	...
	simde_mm_store_si128((simde__m128i*)ctx.v53.u8, simde_mm_perm_epi8_(simde_mm_load_si128((simde__m128i*)ctx.v55.u8), simde_mm_load_si128((simde__m128i*)ctx.v54.u8), simde_mm_load_si128((simde__m128i*)ctx.v2.u8)));
	// lvx128 v52,r8,r22
	simde_mm_store_si128((simde__m128i*)ctx.v52.u8, simde_mm_shuffle_epi8(simde_mm_load_si128((simde__m128i*)(base + ((ctx.r8.u32 + ctx.r22.u32) & ~0xF))), simde_mm_load_si128((simde__m128i*)VectorMaskL)));
	// vspltw128 v51,v56,0
	simde_mm_store_si128((simde__m128i*)ctx.v51.u32, simde_mm_shuffle_epi32(simde_mm_load_si128((simde__m128i*)ctx.v56.u32), 0xFF));
	// lvx128 v50,r0,r8
	simde_mm_store_si128((simde__m128i*)ctx.v50.u8, simde_mm_shuffle_epi8(simde_mm_load_si128((simde__m128i*)(base + ((ctx.r8.u32) & ~0xF))), simde_mm_load_si128((simde__m128i*)VectorMaskL)));
	...
	simde_mm_store_si128((simde__m128i*)ctx.v44.u8, simde_mm_perm_epi8_(simde_mm_load_si128((simde__m128i*)ctx.v46.u8), simde_mm_load_si128((simde__m128i*)ctx.v63.u8), simde_mm_load_si128((simde__m128i*)ctx.v7.u8)));
	// lvx128 v13,r11,r16
	simde_mm_store_si128((simde__m128i*)ctx.v13.u8, simde_mm_shuffle_epi8(simde_mm_load_si128((simde__m128i*)(base + ((ctx.r11.u32 + ctx.r16.u32) & ~0xF))), simde_mm_load_si128((simde__m128i*)VectorMaskL)));
	// vcuxwfp128 v2,v45,0
	simde_mm_store_ps(ctx.v2.f32, simde_mm_cvtepu32_ps_(simde_mm_load_si128((simde__m128i*)ctx.v45.u32)));
	// lvx128 v12,r11,r20
	...
	// lvx128 v3,r11,r17
	simde_mm_store_si128((simde__m128i*)ctx.v3.u8, simde_mm_shuffle_epi8(simde_mm_load_si128((simde__m128i*)(base + ((ctx.r11.u32 + ctx.r17.u32) & ~0xF))), simde_mm_load_si128((simde__m128i*)VectorMaskL)));
	// lvx128 v11,r0,r11
	simde_mm_store_si128((simde__m128i*)ctx.v11.u8, simde_mm_shuffle_epi8(simde_mm_load_si128((simde__m128i*)(base + ((ctx.r11.u32) & ~0xF))), simde_mm_load_si128((simde__m128i*)VectorMaskL)));
	// vmaddfp v28,v4,v13,v3
	simde_mm_store_ps(ctx.v28.f32, simde_mm_add_ps(simde_mm_mul_ps(simde_mm_load_ps(ctx.v4.f32), simde_mm_load_ps(ctx.v13.f32)), simde_mm_load_ps(ctx.v3.f32)));
	...
	simde_mm_store_ps(ctx.v5.f32, simde_mm_add_ps(simde_mm_mul_ps(simde_mm_load_ps(ctx.v21.f32), simde_mm_load_ps(ctx.v12.f32)), simde_mm_load_ps(ctx.v18.f32)));
	// stvx128 v20,r0,r25
	simde_mm_store_si128((simde__m128i*)(base + ((ctx.r25.u32) & ~0xF)), simde_mm_shuffle_epi8(simde_mm_load_si128((simde__m128i*)ctx.v20.u8), simde_mm_load_si128((simde__m128i*)VectorMaskL)));
	// vmaddfp v4,v17,v12,v15
	simde_mm_store_ps(ctx.v4.f32, simde_mm_add_ps(simde_mm_mul_ps(simde_mm_load_ps(ctx.v17.f32), simde_mm_load_ps(ctx.v12.f32)), simde_mm_load_ps(ctx.v15.f32)));
	// vmaddfp v3,v14,v12,v6
	simde_mm_store_ps(ctx.v3.f32, simde_mm_add_ps(simde_mm_mul_ps(simde_mm_load_ps(ctx.v14.f32), simde_mm_load_ps(ctx.v12.f32)), simde_mm_load_ps(ctx.v6.f32)));
...
loc_82901464:
	...
	simde_mm_store_si128((simde__m128i*)ctx.v13.u8, simde_mm_load_si128((simde__m128i*)ctx.v61.u8));
	// lvx128 v52,r9,r22
	simde_mm_store_si128((simde__m128i*)ctx.v52.u8, simde_mm_shuffle_epi8(simde_mm_load_si128((simde__m128i*)(base + ((ctx.r9.u32 + ctx.r22.u32) & ~0xF))), simde_mm_load_si128((simde__m128i*)VectorMaskL)));
	// addi r11,r9,12
	ctx.r11.s64 = ctx.r9.s64 + 12;
	// lvsl v6,r0,r9
	temp.u32 = ctx.r9.u32;
	...
	simde_mm_store_si128((simde__m128i*)(base + ((ctx.r14.u32) & ~0xF)), simde_mm_shuffle_epi8(simde_mm_load_si128((simde__m128i*)ctx.v6.u8), simde_mm_load_si128((simde__m128i*)VectorMaskL)));
	// lvx128 v50,r11,r22
	simde_mm_store_si128((simde__m128i*)ctx.v50.u8, simde_mm_shuffle_epi8(simde_mm_load_si128((simde__m128i*)(base + ((ctx.r11.u32 + ctx.r22.u32) & ~0xF))), simde_mm_load_si128((simde__m128i*)VectorMaskL)));
	// lvsl v2,r0,r8
	temp.u32 = ctx.r8.u32;
	simde_mm_store_si128((simde__m128i*)ctx.v2.u8, simde_mm_load_si128((simde__m128i*)&VectorShiftTableL[(temp.u32 & 0xF) * 16]));
	// lvx128 v51,r0,r11
	...
	simde_mm_store_si128((simde__m128i*)ctx.v46.u8, simde_mm_shuffle_epi8(simde_mm_load_si128((simde__m128i*)(base + ((ctx.r10.u32) & ~0xF))), simde_mm_load_si128((simde__m128i*)VectorMaskL)));
	// lvx128 v45,r10,r22
	simde_mm_store_si128((simde__m128i*)ctx.v45.u8, simde_mm_shuffle_epi8(simde_mm_load_si128((simde__m128i*)(base + ((ctx.r10.u32 + ctx.r22.u32) & ~0xF))), simde_mm_load_si128((simde__m128i*)VectorMaskL)));
	// vperm128 v44,v46,v45,v3
	simde_mm_store_si128((simde__m128i*)ctx.v44.u8, simde_mm_perm_epi8_(simde_mm_load_si128((simde__m128i*)ctx.v46.u8), simde_mm_load_si128((simde__m128i*)ctx.v45.u8), simde_mm_load_si128((simde__m128i*)ctx.v3.u8)));
	// vspltw128 v43,v44,0
	simde_mm_store_si128((simde__m128i*)ctx.v43.u32, simde_mm_shuffle_epi32(simde_mm_load_si128((simde__m128i*)ctx.v44.u32), 0xFF));
	...
	simde_mm_store_si128((simde__m128i*)(base + ((ctx.r14.u32 + ctx.r4.u32) & ~0xF)), simde_mm_shuffle_epi8(simde_mm_load_si128((simde__m128i*)ctx.v4.u8), simde_mm_load_si128((simde__m128i*)VectorMaskL)));
	// lvx128 v41,r8,r22
	simde_mm_store_si128((simde__m128i*)ctx.v41.u8, simde_mm_shuffle_epi8(simde_mm_load_si128((simde__m128i*)(base + ((ctx.r8.u32 + ctx.r22.u32) & ~0xF))), simde_mm_load_si128((simde__m128i*)VectorMaskL)));
	// lvx128 v40,r0,r8
	simde_mm_store_si128((simde__m128i*)ctx.v40.u8, simde_mm_shuffle_epi8(simde_mm_load_si128((simde__m128i*)(base + ((ctx.r8.u32) & ~0xF))), simde_mm_load_si128((simde__m128i*)VectorMaskL)));
	// vperm128 v39,v40,v41,v2
	simde_mm_store_si128((simde__m128i*)ctx.v39.u8, simde_mm_perm_epi8_(simde_mm_load_si128((simde__m128i*)ctx.v40.u8), simde_mm_load_si128((simde__m128i*)ctx.v41.u8), simde_mm_load_si128((simde__m128i*)ctx.v2.u8)));
	...
	ctx.r11.u64 = PPC_LOAD_U8(ctx.r9.u32 + 35);
	// lvx128 v36,r9,r28
	simde_mm_store_si128((simde__m128i*)ctx.v36.u8, simde_mm_shuffle_epi8(simde_mm_load_si128((simde__m128i*)(base + ((ctx.r9.u32 + ctx.r28.u32) & ~0xF))), simde_mm_load_si128((simde__m128i*)VectorMaskL)));
	// rotlwi r10,r11,1
	ctx.r10.u64 = __builtin_rotateleft32(ctx.r11.u32, 1);
	// lvx128 v35,r0,r7
	simde_mm_store_si128((simde__m128i*)ctx.v35.u8, simde_mm_shuffle_epi8(simde_mm_load_si128((simde__m128i*)(base + ((ctx.r7.u32) & ~0xF))), simde_mm_load_si128((simde__m128i*)VectorMaskL)));
	...
	simde_mm_store_si128((simde__m128i*)ctx.v33.u32, simde_mm_shuffle_epi32(simde_mm_load_si128((simde__m128i*)ctx.v34.u32), 0xFF));
	// lvx128 v59,r11,r17
	simde_mm_store_si128((simde__m128i*)ctx.v59.u8, simde_mm_shuffle_epi8(simde_mm_load_si128((simde__m128i*)(base + ((ctx.r11.u32 + ctx.r17.u32) & ~0xF))), simde_mm_load_si128((simde__m128i*)VectorMaskL)));
	// lvx128 v58,r0,r11
	simde_mm_store_si128((simde__m128i*)ctx.v58.u8, simde_mm_shuffle_epi8(simde_mm_load_si128((simde__m128i*)(base + ((ctx.r11.u32) & ~0xF))), simde_mm_load_si128((simde__m128i*)VectorMaskL)));
	// lvx128 v56,r11,r20
	...
	simde_mm_store_si128((simde__m128i*)ctx.v57.u8, simde_mm_perm_epi8_(simde_mm_load_si128((simde__m128i*)ctx.v33.u8), simde_mm_load_si128((simde__m128i*)ctx.v63.u8), simde_mm_load_si128((simde__m128i*)ctx.v1.u8)));
	// lvx128 v32,r11,r16
	simde_mm_store_si128((simde__m128i*)ctx.v32.u8, simde_mm_shuffle_epi8(simde_mm_load_si128((simde__m128i*)(base + ((ctx.r11.u32 + ctx.r16.u32) & ~0xF))), simde_mm_load_si128((simde__m128i*)VectorMaskL)));
	// vcuxwfp128 v55,v57,0
	simde_mm_store_ps(ctx.v55.f32, simde_mm_cvtepu32_ps_(simde_mm_load_si128((simde__m128i*)ctx.v57.u32)));
	// vmulfp128 v62,v55,v60
	simde_mm_store_ps(ctx.v62.f32, simde_mm_mul_ps(simde_mm_load_ps(ctx.v55.f32), simde_mm_load_ps(ctx.v60.f32)));
	...
	simde_mm_store_si128((simde__m128i*)ctx.v30.u8, simde_mm_shuffle_epi8(simde_mm_load_si128((simde__m128i*)(base + ((ctx.r11.u32) & ~0xF))), simde_mm_load_si128((simde__m128i*)VectorMaskL)));
	// lvx128 v29,r11,r20
	simde_mm_store_si128((simde__m128i*)ctx.v29.u8, simde_mm_shuffle_epi8(simde_mm_load_si128((simde__m128i*)(base + ((ctx.r11.u32 + ctx.r20.u32) & ~0xF))), simde_mm_load_si128((simde__m128i*)VectorMaskL)));
	// vmaddfp v13,v30,v2,v13
	simde_mm_store_ps(ctx.v13.f32, simde_mm_add_ps(simde_mm_mul_ps(simde_mm_load_ps(ctx.v30.f32), simde_mm_load_ps(ctx.v2.f32)), simde_mm_load_ps(ctx.v13.f32)));
	// lvx128 v28,r11,r16
	simde_mm_store_si128((simde__m128i*)ctx.v28.u8, simde_mm_shuffle_epi8(simde_mm_load_si128((simde__m128i*)(base + ((ctx.r11.u32 + ctx.r16.u32) & ~0xF))), simde_mm_load_si128((simde__m128i*)VectorMaskL)));
	// vmaddfp v12,v29,v2,v12
	simde_mm_store_ps(ctx.v12.f32, simde_mm_add_ps(simde_mm_mul_ps(simde_mm_load_ps(ctx.v29.f32), simde_mm_load_ps(ctx.v2.f32)), simde_mm_load_ps(ctx.v12.f32)));
	// lvx128 v27,r11,r17
	simde_mm_store_si128((simde__m128i*)ctx.v27.u8, simde_mm_shuffle_epi8(simde_mm_load_si128((simde__m128i*)(base + ((ctx.r11.u32 + ctx.r17.u32) & ~0xF))), simde_mm_load_si128((simde__m128i*)VectorMaskL)));
	// vmaddfp v11,v28,v2,v11
	simde_mm_store_ps(ctx.v11.f32, simde_mm_add_ps(simde_mm_mul_ps(simde_mm_load_ps(ctx.v28.f32), simde_mm_load_ps(ctx.v2.f32)), simde_mm_load_ps(ctx.v11.f32)));
	// vmaddfp v10,v27,v2,v10
	simde_mm_store_ps(ctx.v10.f32, simde_mm_add_ps(simde_mm_mul_ps(simde_mm_load_ps(ctx.v27.f32), simde_mm_load_ps(ctx.v2.f32)), simde_mm_load_ps(ctx.v10.f32)));
