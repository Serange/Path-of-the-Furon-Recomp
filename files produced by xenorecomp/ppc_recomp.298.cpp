...
__attribute__((alias("__imp__sub_829DF110"))) PPC_WEAK_FUNC(sub_829DF110);
PPC_FUNC_IMPL(__imp__sub_829DF110) {
	...
	// beq cr6,0x829df150
	if (ctx.cr6.eq) goto loc_829DF150;
	// lwz r11,768(r3)
...
loc_829DF16C:
	...
	// bge cr6,0x829df1f8
	if (!ctx.cr6.lt) goto loc_829DF1F8;
	// lwz r3,492(r31)
	ctx.r3.u64 = PPC_LOAD_U32(ctx.r31.u32 + 492);
	// li r5,0
	ctx.r5.s64 = 0;
	...
	// beq cr6,0x829df1e8
	if (ctx.cr6.eq) goto loc_829DF1E8;
	// mr r4,r28
...
loc_829DF1F8:
	...
	ctx.cr6.compare<uint32_t>(ctx.r11.u32, 0, ctx.xer);
	// beq cr6,0x829df224
	if (ctx.cr6.eq) goto loc_829DF224;
	// lwz r11,80(r11)
	...
	// ble cr6,0x829df224
	if (!ctx.cr6.gt) goto loc_829DF224;
	// lwz r11,128(r11)
...
loc_829DF228:
	...
	// beq cr6,0x829df280
	if (ctx.cr6.eq) goto loc_829DF280;
	// cmplwi cr6,r11,0
	ctx.cr6.compare<uint32_t>(ctx.r11.u32, 0, ctx.xer);
	// beq cr6,0x829df280
	if (ctx.cr6.eq) goto loc_829DF280;
	...
	if (ctx.cr6.eq) goto loc_829DF280;
	// lwz r4,768(r10)
	ctx.r4.u64 = PPC_LOAD_U32(ctx.r10.u32 + 768);
	// cmplwi cr6,r4,0
	ctx.cr6.compare<uint32_t>(ctx.r4.u32, 0, ctx.xer);
	// beq cr6,0x829df270
	if (ctx.cr6.eq) goto loc_829DF270;
	// rotlwi r3,r9,0
...
loc_829DF270:
	...
	ctx.r11.u64 = PPC_LOAD_U32(ctx.r31.u32 + 492);
	// stw r27,768(r11)
	PPC_STORE_U32(ctx.r11.u32 + 768, ctx.r27.u32);
	// lwz r10,492(r31)
	ctx.r10.u64 = PPC_LOAD_U32(ctx.r31.u32 + 492);
	// stfs f31,772(r10)
	ctx.fpscr.disableFlushMode();
...
loc_829DF280:
	...
	// ble cr6,0x829df2c8
	if (!ctx.cr6.gt) goto loc_829DF2C8;
	// lis r10,-32222
...
loc_829DF29C:
	...
	// beq cr6,0x829df2b4
	if (ctx.cr6.eq) goto loc_829DF2B4;
	// rotlwi r10,r8,0
...
loc_829DF2B4:
	...
	// blt cr6,0x829df29c
	if (ctx.cr6.lt) goto loc_829DF29C;
loc_829DF2C8:
	// cmplwi cr6,r26,0
	ctx.cr6.compare<uint32_t>(ctx.r26.u32, 0, ctx.xer);
	// bne cr6,0x829df4b0
	if (!ctx.cr6.eq) goto loc_829DF4B0;
	// lwz r11,864(r31)
	...
	// beq cr6,0x829df2fc
	if (ctx.cr6.eq) goto loc_829DF2FC;
	// li r11,10
	ctx.r11.s64 = 10;
loc_829DF2FC:
	// lis r10,-32245
	...
	ctx.cr6.compare<uint32_t>(ctx.r3.u32, 0, ctx.xer);
	// beq cr6,0x829df36c
	if (ctx.cr6.eq) goto loc_829DF36C;
	// lwz r11,0(r3)
	ctx.r11.u64 = PPC_LOAD_U32(ctx.r3.u32 + 0);
	// li r4,1
	ctx.r4.s64 = 1;
...
loc_829DF3A8:
	...
	// beq cr6,0x829df464
	if (ctx.cr6.eq) goto loc_829DF464;
	// stfs f31,100(r1)
	ctx.fpscr.disableFlushMode();
	temp.f32 = float(ctx.f31.f64);
	...
	// lwz r11,412(r6)
	ctx.r11.u64 = PPC_LOAD_U32(ctx.r6.u32 + 412);
	// mtctr r11
...
loc_829DF464:
	...
	ctx.r4.s64 = 0;
	// lwz r9,1048(r31)
	ctx.r9.u64 = PPC_LOAD_U32(ctx.r31.u32 + 1048);
	// mr r3,r31
	ctx.r3.u64 = ctx.r31.u64;
	// lwz r8,1052(r31)
	ctx.r8.u64 = PPC_LOAD_U32(ctx.r31.u32 + 1052);
	// lwz r7,1056(r31)
