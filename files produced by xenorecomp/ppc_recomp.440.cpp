...
__attribute__((alias("__imp__sub_82D84938"))) PPC_WEAK_FUNC(sub_82D84938);
PPC_FUNC_IMPL(__imp__sub_82D84938) {
	PPC_FUNC_PROLOGUE();
	uint32_t ea{};
	// mflr r12
	ctx.r12.u64 = ctx.lr;
	...
	// beq cr6,0x82d84980
	if (ctx.cr6.eq) goto loc_82D84980;
	// li r3,54
	ctx.r3.s64 = 54;
	// addi r1,r1,128
...
__attribute__((alias("__imp__sub_82D849A8"))) PPC_WEAK_FUNC(sub_82D849A8);
PPC_FUNC_IMPL(__imp__sub_82D849A8) {
	PPC_FUNC_PROLOGUE();
	uint32_t ea{};
	// mflr r12
	ctx.r12.u64 = ctx.lr;
	...
	ctx.cr6.compare<int32_t>(ctx.r3.s32, 0, ctx.xer);
	// bne cr6,0x82d84a10
	if (!ctx.cr6.eq) goto loc_82D84A10;
	// lwz r3,80(r1)
	ctx.r3.u64 = PPC_LOAD_U32(ctx.r1.u32 + 80);
	// lwz r11,268(r3)
	ctx.r11.u64 = PPC_LOAD_U32(ctx.r3.u32 + 268);
