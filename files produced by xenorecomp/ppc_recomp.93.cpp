...
__attribute__((alias("__imp__sub_824B7588"))) PPC_WEAK_FUNC(sub_824B7588);
PPC_FUNC_IMPL(__imp__sub_824B7588) {
	PPC_FUNC_PROLOGUE();
	uint32_t ea{};
	// mflr r12
	ctx.r12.u64 = ctx.lr;
...
loc_824B75B8:
	...
	ctx.cr6.compare<uint32_t>(ctx.r9.u32, 0, ctx.xer);
	// beq cr6,0x824b75d0
	if (ctx.cr6.eq) goto loc_824B75D0;
	// li r4,1
	ctx.r4.s64 = 1;
	// b 0x824b75e4
	goto loc_824B75E4;
loc_824B75D0:
	...
	// beq cr6,0x824b75ec
	if (ctx.cr6.eq) goto loc_824B75EC;
	// li r4,2
	ctx.r4.s64 = 2;
loc_824B75E4:
	// mr r3,r31
...
__attribute__((alias("__imp__sub_824B7634"))) PPC_WEAK_FUNC(sub_824B7634);
PPC_FUNC_IMPL(__imp__sub_824B7634) {
	PPC_FUNC_PROLOGUE();
	// .long 0x0
}

__attribute__((alias("__imp__sub_824B7638"))) PPC_WEAK_FUNC(sub_824B7638);
PPC_FUNC_IMPL(__imp__sub_824B7638) {
	PPC_FUNC_PROLOGUE();
	// lwz r11,136(r3)
...
loc_824B7654:
	...
	ctx.cr6.compare<uint32_t>(ctx.r9.u32, 0, ctx.xer);
	// beq cr6,0x824b766c
	if (ctx.cr6.eq) goto loc_824B766C;
	// li r4,1
	ctx.r4.s64 = 1;
	// b 0x824b7688
	sub_824B7688(ctx, base);
...
__attribute__((alias("__imp__sub_824B7684"))) PPC_WEAK_FUNC(sub_824B7684);
PPC_FUNC_IMPL(__imp__sub_824B7684) {
	PPC_FUNC_PROLOGUE();
	// blr 
	return;
}

__attribute__((alias("__imp__sub_824B7688"))) PPC_WEAK_FUNC(sub_824B7688);
PPC_FUNC_IMPL(__imp__sub_824B7688) {
	PPC_FUNC_PROLOGUE();
	uint32_t ea{};
	// mflr r12
	ctx.r12.u64 = ctx.lr;
	...
	// ble cr6,0x824b7884
	if (!ctx.cr6.gt) goto loc_824B7884;
	// lis r8,-32246
	...
	// addi r17,r8,11272
	ctx.r17.s64 = ctx.r8.s64 + 11272;
	// addi r18,r9,14488
	ctx.r18.s64 = ctx.r9.s64 + 14488;
	// addi r22,r10,7648
	ctx.r22.s64 = ctx.r10.s64 + 7648;
	// addi r16,r11,7620
	ctx.r16.s64 = ctx.r11.s64 + 7620;
loc_824B76DC:
	// lwz r4,-30776(r21)
	ctx.r4.u64 = PPC_LOAD_U32(ctx.r21.u32 + -30776);
	// cmplwi cr6,r4,0
	...
	// stw r3,-30776(r21)
	PPC_STORE_U32(ctx.r21.u32 + -30776, ctx.r3.u32);
	// bl 0x8249bc18
	ctx.lr = 0x824B76F8;
...
loc_824B76FC:
	...
	// beq cr6,0x824b7870
	if (ctx.cr6.eq) goto loc_824B7870;
	// lwz r11,160(r24)
	ctx.r11.u64 = PPC_LOAD_U32(ctx.r24.u32 + 160);
	// add r11,r25,r11
	...
	// beq cr6,0x824b7730
	if (ctx.cr6.eq) goto loc_824B7730;
	// lwz r3,16(r11)
...
loc_824B7734:
	...
	// ble cr6,0x824b7870
	if (!ctx.cr6.gt) goto loc_824B7870;
	// mr r27,r23
...
loc_824B7760:
	...
	// beq cr6,0x824b7854
	if (ctx.cr6.eq) goto loc_824B7854;
	// cmpwi cr6,r19,2
	...
	// stw r23,152(r29)
	PPC_STORE_U32(ctx.r29.u32 + 152, ctx.r23.u32);
	// cmpwi cr6,r11,0
	ctx.cr6.compare<int32_t>(ctx.r11.s32, 0, ctx.xer);
	// beq cr6,0x824b7854
	if (ctx.cr6.eq) goto loc_824B7854;
...
loc_824B77AC:
	...
	// ble cr6,0x824b7818
	if (!ctx.cr6.gt) goto loc_824B7818;
	// mr r31,r28
...
loc_824B77E0:
	...
	// bne cr6,0x824b77f8
	if (!ctx.cr6.eq) goto loc_824B77F8;
	// addi r3,r29,148
	ctx.r3.s64 = ctx.r29.s64 + 148;
	// lwz r4,0(r31)
...
loc_824B77F8:
	...
	// bne cr6,0x824b780c
	if (!ctx.cr6.eq) goto loc_824B780C;
	// addi r3,r29,148
	ctx.r3.s64 = ctx.r29.s64 + 148;
	// lwz r4,0(r31)
	ctx.r4.u64 = PPC_LOAD_U32(ctx.r31.u32 + 0);
...
loc_824B7818:
	...
	// beq cr6,0x824b7848
	if (ctx.cr6.eq) goto loc_824B7848;
	// lwz r3,28888(r20)
...
loc_824B7854:
	...
	// blt cr6,0x824b7760
	if (ctx.cr6.lt) goto loc_824B7760;
loc_824B7870:
	// lwz r11,164(r24)
	ctx.r11.u64 = PPC_LOAD_U32(ctx.r24.u32 + 164);
	// addi r15,r15,1
	...
	// blt cr6,0x824b76dc
	if (ctx.cr6.lt) goto loc_824B76DC;
loc_824B7884:
	// addi r1,r1,240
...
__attribute__((alias("__imp__sub_824B788C"))) PPC_WEAK_FUNC(sub_824B788C);
PPC_FUNC_IMPL(__imp__sub_824B788C) {
	PPC_FUNC_PROLOGUE();
	// .long 0x0
}

__attribute__((alias("__imp__sub_824B7890"))) PPC_WEAK_FUNC(sub_824B7890);
PPC_FUNC_IMPL(__imp__sub_824B7890) {
	PPC_FUNC_PROLOGUE();
	// lwz r11,152(r3)
...
loc_824B78A4:
	...
	// bne cr6,0x824b78c4
	if (!ctx.cr6.eq) goto loc_824B78C4;
	// oris r10,r10,32768
...
loc_824B78C4:
	...
	// blt cr6,0x824b78a4
	if (ctx.cr6.lt) goto loc_824B78A4;
	// blr 
	return;
}

__attribute__((alias("__imp__sub_824B78DC"))) PPC_WEAK_FUNC(sub_824B78DC);
PPC_FUNC_IMPL(__imp__sub_824B78DC) {
	PPC_FUNC_PROLOGUE();
	// .long 0x0
}
