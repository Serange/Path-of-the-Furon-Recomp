...
__attribute__((alias("__imp__sub_82B93B78"))) PPC_WEAK_FUNC(sub_82B93B78);
PPC_FUNC_IMPL(__imp__sub_82B93B78) {
	PPC_FUNC_PROLOGUE();
	// mr r3,r4
...
PPC_FUNC_IMPL(__imp__sub_82B93B80) {
	...
	// bne cr6,0x82b93bac
	if (!ctx.cr6.eq) goto loc_82B93BAC;
	// li r3,0
	ctx.r3.s64 = 0;
	// b 0x82b93c3c
	goto loc_82B93C3C;
loc_82B93BAC:
	...
	// bne cr6,0x82b93bc8
	if (!ctx.cr6.eq) goto loc_82B93BC8;
	// lis r11,-32245
...
loc_82B93BC8:
	...
	// bne cr6,0x82b93be4
	if (!ctx.cr6.eq) goto loc_82B93BE4;
	// lis r11,-32245
	ctx.r11.s64 = -2113208320;
	// addi r4,r11,-19580
