...
PPC_FUNC_IMPL(__imp__sub_83304A50) {
	...
	// bge cr6,0x83304b00
	if (!ctx.cr6.lt) goto loc_83304B00;
	// lis r9,-32256
...
loc_83304A98:
	...
	// blt cr6,0x83304a98
	if (ctx.cr6.lt) goto loc_83304A98;
loc_83304B00:
	// lwz r11,24(r3)
	...
	// beq cr6,0x83304b1c
	if (ctx.cr6.eq) goto loc_83304B1C;
	// lwz r11,104(r3)
...
loc_83304B1C:
	...
	ctx.cr6.compare<int32_t>(ctx.r11.s32, 0, ctx.xer);
	// beq cr6,0x83304b38
	if (ctx.cr6.eq) goto loc_83304B38;
	// lwz r11,104(r3)
	ctx.r11.u64 = PPC_LOAD_U32(ctx.r3.u32 + 104);
	// rlwinm r11,r11,4,0,27
	ctx.r11.u64 = __builtin_rotateleft64(ctx.r11.u32 | (ctx.r11.u64 << 32), 4) & 0xFFFFFFF0;
...
__attribute__((alias("__imp__sub_83304B48"))) PPC_WEAK_FUNC(sub_83304B48);
PPC_FUNC_IMPL(__imp__sub_83304B48) {
	PPC_FUNC_PROLOGUE();
	PPCRegister temp{};
	uint32_t ea{};
	// mflr r12
	...
	ctx.cr6.compare<uint32_t>(ctx.r11.u32, ctx.r10.u32, ctx.xer);
	// bge cr6,0x83304c0c
	if (!ctx.cr6.lt) goto loc_83304C0C;
	// lis r9,-32222
...
loc_83304B8C:
	...
	ctx.r6.s64 = ctx.r6.s64 + 16;
	// blt cr6,0x83304b8c
	if (ctx.cr6.lt) goto loc_83304B8C;
loc_83304C0C:
	// lwz r11,24(r3)
	ctx.r11.u64 = PPC_LOAD_U32(ctx.r3.u32 + 24);
	// cmpwi cr6,r11,0
	ctx.cr6.compare<int32_t>(ctx.r11.s32, 0, ctx.xer);
	// beq cr6,0x83304c28
	if (ctx.cr6.eq) goto loc_83304C28;
	// lwz r11,104(r3)
	ctx.r11.u64 = PPC_LOAD_U32(ctx.r3.u32 + 104);
	// rlwinm r11,r11,4,0,27
	ctx.r11.u64 = __builtin_rotateleft64(ctx.r11.u32 | (ctx.r11.u64 << 32), 4) & 0xFFFFFFF0;
...
loc_83304C28:
	...
	ctx.cr6.compare<int32_t>(ctx.r11.s32, 0, ctx.xer);
	// beq cr6,0x83304c44
	if (ctx.cr6.eq) goto loc_83304C44;
	// lwz r11,104(r3)
	ctx.r11.u64 = PPC_LOAD_U32(ctx.r3.u32 + 104);
	// rlwinm r11,r11,4,0,27
	ctx.r11.u64 = __builtin_rotateleft64(ctx.r11.u32 | (ctx.r11.u64 << 32), 4) & 0xFFFFFFF0;
...
__attribute__((alias("__imp__sub_83304C54"))) PPC_WEAK_FUNC(sub_83304C54);
PPC_FUNC_IMPL(__imp__sub_83304C54) {
	PPC_FUNC_PROLOGUE();
	// .long 0x0
}
