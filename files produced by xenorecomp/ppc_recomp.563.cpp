...
__attribute__((alias("__imp__sub_832256E0"))) PPC_WEAK_FUNC(sub_832256E0);
PPC_FUNC_IMPL(__imp__sub_832256E0) {
	PPC_FUNC_PROLOGUE();
	uint32_t ea{};
	// lwz r25,31060(r27)
	ctx.r25.u64 = PPC_LOAD_U32(ctx.r27.u32 + 31060);
	// lwz r17,-13816(r1)
	ctx.r17.u64 = PPC_LOAD_U32(ctx.r1.u32 + -13816);
	// mflr r12
	ctx.r12.u64 = ctx.lr;
	// bl 0x82cb10e0
	ctx.lr = 0x832256F0;
...
__attribute__((alias("__imp__sub_832257FC"))) PPC_WEAK_FUNC(sub_832257FC);
PPC_FUNC_IMPL(__imp__sub_832257FC) {
	PPC_FUNC_PROLOGUE();
	// lwz r30,84(r31)
	ctx.r30.u64 = PPC_LOAD_U32(ctx.r31.u32 + 84);
	// b 0x83225820
...
__attribute__((alias("__imp__sub_83225804"))) PPC_WEAK_FUNC(sub_83225804);
PPC_FUNC_IMPL(__imp__sub_83225804) {
	PPC_FUNC_PROLOGUE();
	// cmplwi cr6,r30,0
	ctx.cr6.compare<uint32_t>(ctx.r30.u32, 0, ctx.xer);
	// beq cr6,0x83225818
...
__attribute__((alias("__imp__sub_83225820"))) PPC_WEAK_FUNC(sub_83225820);
PPC_FUNC_IMPL(__imp__sub_83225820) {
	PPC_FUNC_PROLOGUE();
	// cmplwi cr6,r30,0
	ctx.cr6.compare<uint32_t>(ctx.r30.u32, 0, ctx.xer);
	// beq cr6,0x83225834
