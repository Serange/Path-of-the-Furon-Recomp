...
__attribute__((alias("__imp__sub_827EEF88"))) PPC_WEAK_FUNC(sub_827EEF88);
PPC_FUNC_IMPL(__imp__sub_827EEF88) {
	PPC_FUNC_PROLOGUE();
	uint32_t ea{};
	// mflr r12
	ctx.r12.u64 = ctx.lr;
	...
	// beq cr6,0x827eeff8
	if (ctx.cr6.eq) goto loc_827EEFF8;
	// lwz r4,4(r31)
	...
	// beq cr6,0x827eefd4
	if (ctx.cr6.eq) goto loc_827EEFD4;
	// lwz r11,0(r3)
	ctx.r11.u64 = PPC_LOAD_U32(ctx.r3.u32 + 0);
	// cmplwi cr6,r11,0
	ctx.cr6.compare<uint32_t>(ctx.r11.u32, 0, ctx.xer);
	// bne cr6,0x827eefdc
	if (!ctx.cr6.eq) goto loc_827EEFDC;
loc_827EEFD4:
	// stw r30,0(r31)
...
PPC_FUNC_IMPL(__imp__sub_827EF010) {
	...
	// bne cr6,0x827ef04c
	if (!ctx.cr6.eq) goto loc_827EF04C;
loc_827EF040:
	// li r11,0
	ctx.r11.s64 = 0;
	// stw r11,4(r31)
...
loc_827EF04C:
	...
	// beq cr6,0x827ef0a4
	if (ctx.cr6.eq) goto loc_827EF0A4;
	// li r3,0
	ctx.r3.s64 = 0;
	// mtctr r11
	ctx.ctr.u64 = ctx.r11.u64;
	...
	// ble cr6,0x827ef0a4
	if (!ctx.cr6.gt) goto loc_827EF0A4;
loc_827EF07C:
	// lwz r11,8(r31)
	ctx.r11.u64 = PPC_LOAD_U32(ctx.r31.u32 + 8);
	// mr r3,r30
	...
	ctx.r10.u64 = PPC_LOAD_U32(ctx.r31.u32 + 0);
	// stbx r3,r10,r30
	PPC_STORE_U8(ctx.r10.u32 + ctx.r30.u32, ctx.r3.u8);
	// addi r30,r30,1
	...
	// bgt cr6,0x827ef07c
	if (ctx.cr6.gt) goto loc_827EF07C;
loc_827EF0A4:
	// addi r1,r1,112
	ctx.r1.s64 = ctx.r1.s64 + 112;
	// lwz r12,-8(r1)
