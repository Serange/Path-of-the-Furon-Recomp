...
__attribute__((alias("__imp__sub_822984D0"))) PPC_WEAK_FUNC(sub_822984D0);
PPC_FUNC_IMPL(__imp__sub_822984D0) {
	...
	// beq cr6,0x822986a0
	if (ctx.cr6.eq) goto loc_822986A0;
	// lis r11,16383
	...
	// ble cr6,0x8229852c
	if (!ctx.cr6.gt) goto loc_8229852C;
	// lis r9,-8193
	...
	// ble cr6,0x82298530
	if (!ctx.cr6.gt) goto loc_82298530;
	// mr r10,r28
...
loc_82298530:
	...
	// beq cr6,0x82298560
	if (ctx.cr6.eq) goto loc_82298560;
	// li r5,28
	ctx.r5.s64 = 28;
	// addi r4,r1,80
...
loc_82298564:
	...
	// beq cr6,0x8229859c
	if (ctx.cr6.eq) goto loc_8229859C;
	// lis r5,0
	ctx.r5.s64 = 0;
	// li r4,0
	ctx.r4.s64 = 0;
...
loc_822985A8:
	...
	// rlwinm r10,r30,21,16,26
	ctx.r10.u64 = __builtin_rotateleft64(ctx.r30.u32 | (ctx.r30.u64 << 32), 21) & 0xFFE0;
	// addi r11,r11,846
	...
	// beq 0x822986a0
	if (ctx.cr0.eq) goto loc_822986A0;
	// lwz r11,12(r31)
	ctx.r11.u64 = PPC_LOAD_U32(ctx.r31.u32 + 12);
	// addi r10,r29,3364
	ctx.r10.s64 = ctx.r29.s64 + 3364;
	// cmplw cr6,r11,r10
	ctx.cr6.compare<uint32_t>(ctx.r11.u32, ctx.r10.u32, ctx.xer);
	// beq cr6,0x82298680
	if (ctx.cr6.eq) goto loc_82298680;
	// dcbt r0,r30
	// lwz r11,16(r31)
...
loc_822985FC:
	...
	// beq cr6,0x82298620
	if (ctx.cr6.eq) goto loc_82298620;
	// stw r10,28(r9)
...
PPC_FUNC_IMPL(__imp__sub_822986A8) {
	...
	// beq cr6,0x82298718
	if (ctx.cr6.eq) goto loc_82298718;
	// addi r11,r11,-32764
...
loc_82298760:
	...
	ctx.cr6.compare<uint32_t>(ctx.r11.u32, 0, ctx.xer);
	// beq cr6,0x8229878c
	if (ctx.cr6.eq) goto loc_8229878C;
	// addi r9,r31,12
