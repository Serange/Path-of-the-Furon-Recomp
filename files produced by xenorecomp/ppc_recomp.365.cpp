...
__attribute__((alias("__imp__sub_82BB0F08"))) PPC_WEAK_FUNC(sub_82BB0F08);
PPC_FUNC_IMPL(__imp__sub_82BB0F08) {
	PPC_FUNC_PROLOGUE();
	uint32_t ea{};
	// mflr r12
	ctx.r12.u64 = ctx.lr;
...
__attribute__((alias("__imp__sub_82BB0F7C"))) PPC_WEAK_FUNC(sub_82BB0F7C);
PPC_FUNC_IMPL(__imp__sub_82BB0F7C) {
	PPC_FUNC_PROLOGUE();
	// .long 0x0
}
