...
__attribute__((alias("__imp__sub_822B8318"))) PPC_WEAK_FUNC(sub_822B8318);
PPC_FUNC_IMPL(__imp__sub_822B8318) {
	PPC_FUNC_PROLOGUE();
	uint32_t ea{};
	// mflr r12
	ctx.r12.u64 = ctx.lr;
...
loc_822B8358:
	...
	// bne cr6,0x822b8358
	if (!ctx.cr6.eq) goto loc_822B8358;
loc_822B8380:
	// lwz r11,108(r31)
	ctx.r11.u64 = PPC_LOAD_U32(ctx.r31.u32 + 108);
	// cmpwi cr6,r11,-1
	ctx.cr6.compare<int32_t>(ctx.r11.s32, -1, ctx.xer);
	// beq cr6,0x822b83a0
	if (ctx.cr6.eq) goto loc_822B83A0;
	// lwz r11,100(r31)
	ctx.r11.u64 = PPC_LOAD_U32(ctx.r31.u32 + 100);
	// lwz r10,108(r31)
	ctx.r10.u64 = PPC_LOAD_U32(ctx.r31.u32 + 108);
	...
	ctx.cr6.compare<int32_t>(ctx.r10.s32, ctx.r9.s32, ctx.xer);
	// beq cr6,0x822b83cc
	if (ctx.cr6.eq) goto loc_822B83CC;
loc_822B83A0:
	// stfd f31,80(r1)
	ctx.fpscr.disableFlushMode();
	PPC_STORE_U64(ctx.r1.u32 + 80, ctx.f31.u64);
...
__attribute__((alias("__imp__sub_822B83E4"))) PPC_WEAK_FUNC(sub_822B83E4);
PPC_FUNC_IMPL(__imp__sub_822B83E4) {
	PPC_FUNC_PROLOGUE();
	// .long 0x0
}
...
loc_822BB2A0:
	...
	// fctiwz f5,f30
	ctx.fpscr.disableFlushMode();
	ctx.f5.s64 = (ctx.f30.f64 > double(INT_MAX)) ? INT_MAX : simde_mm_cvttsd_si32(simde_mm_load_sd(&ctx.f30.f64));
	// stfd f5,112(r1)
	...
	// fctiwz f3,f28
	ctx.f3.s64 = (ctx.f28.f64 > double(INT_MAX)) ? INT_MAX : simde_mm_cvttsd_si32(simde_mm_load_sd(&ctx.f28.f64));
	// fctiwz f2,f29
	ctx.f2.s64 = (ctx.f29.f64 > double(INT_MAX)) ? INT_MAX : simde_mm_cvttsd_si32(simde_mm_load_sd(&ctx.f29.f64));
	// stfd f3,96(r1)
