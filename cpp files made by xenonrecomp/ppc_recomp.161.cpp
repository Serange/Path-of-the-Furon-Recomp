...
__attribute__((alias("__imp__sub_8264AAB8"))) PPC_WEAK_FUNC(sub_8264AAB8);
...
__attribute__((alias("__imp__sub_8264AAC8"))) PPC_WEAK_FUNC(sub_8264AAC8);
PPC_FUNC_IMPL(__imp__sub_8264AAC8) {
	...
	// beq cr6,0x8264ab6c
	if (ctx.cr6.eq) goto loc_8264AB6C;
	// lis r11,1032
...
__attribute__((alias("__imp__sub_8264AB84"))) PPC_WEAK_FUNC(sub_8264AB84);
PPC_FUNC_IMPL(__imp__sub_8264AB84) {
	PPC_FUNC_PROLOGUE();
	// .long 0x0
}

__attribute__((alias("__imp__sub_8264AB88"))) PPC_WEAK_FUNC(sub_8264AB88);
...
loc_8264ABBC:
	...
	// lwz r11,-28236(r29)
	ctx.r11.u64 = PPC_LOAD_U32(ctx.r29.u32 + -28236);
	// cmplw cr6,r10,r11
...
loc_8264ABE4:
	...
	ctx.cr6.compare<uint32_t>(ctx.r10.u32, 0, ctx.xer);
	// bne cr6,0x8264ac14
	if (!ctx.cr6.eq) goto loc_8264AC14;
	// mr r3,r30
...
loc_8264AC14:
	...
	ctx.cr6.compare<uint32_t>(ctx.r10.u32, 0, ctx.xer);
	// bne cr6,0x8264ac40
	if (!ctx.cr6.eq) goto loc_8264AC40;
	// mr r3,r30
	ctx.r3.u64 = ctx.r30.u64;
	// bl 0x82398580
	ctx.lr = 0x8264AC30;
...
loc_8264AC40:
	...
	// beq cr6,0x8264ac78
	if (ctx.cr6.eq) goto loc_8264AC78;
	// rotlwi r31,r10,0
	...
	if (!ctx.cr6.eq) goto loc_8264AC78;
	// lwz r3,-28236(r29)
	ctx.r3.u64 = PPC_LOAD_U32(ctx.r29.u32 + -28236);
	// lwz r11,0(r3)
...
__attribute__((alias("__imp__sub_8264AC80"))) PPC_WEAK_FUNC(sub_8264AC80);
PPC_FUNC_IMPL(__imp__sub_8264AC80) {
	PPC_FUNC_PROLOGUE();
	// li r3,1
	ctx.r3.s64 = 1;
	// blr 
