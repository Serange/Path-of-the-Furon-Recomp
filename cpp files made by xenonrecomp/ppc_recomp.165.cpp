...
__attribute__((alias("__imp__sub_82660410"))) PPC_WEAK_FUNC(sub_82660410);
PPC_FUNC_IMPL(__imp__sub_82660410) {
	PPC_FUNC_PROLOGUE();
	PPCRegister temp{};
	uint32_t ea{};
	// mflr r12
	...
	// bne cr6,0x8266046c
	if (!ctx.cr6.eq) goto loc_8266046C;
	// lis r11,-31905
...
loc_8266044C:
	...
	// bdnz 0x8266044c
	--ctx.ctr.u64;
	if (ctx.ctr.u32 != 0) goto loc_8266044C;
	// mr r3,r27
...
loc_8266046C:
	...
	// beq cr6,0x82660584
	if (ctx.cr6.eq) goto loc_82660584;
	// lwz r11,924(r30)
	...
	// bne cr6,0x826604a4
	if (!ctx.cr6.eq) goto loc_826604A4;
	// cmpwi cr6,r10,0
	ctx.cr6.compare<int32_t>(ctx.r10.s32, 0, ctx.xer);
	// beq cr6,0x82660550
	if (ctx.cr6.eq) goto loc_82660550;
loc_826604A4:
	// li r5,0
	ctx.r5.s64 = 0;
	// cmpwi cr6,r11,0
	ctx.cr6.compare<int32_t>(ctx.r11.s32, 0, ctx.xer);
	// bne cr6,0x826604b8
	if (!ctx.cr6.eq) goto loc_826604B8;
	// cmpwi cr6,r10,0
	ctx.cr6.compare<int32_t>(ctx.r10.s32, 0, ctx.xer);
	// beq cr6,0x826604d0
	if (ctx.cr6.eq) goto loc_826604D0;
loc_826604B8:
	// mr r4,r28
...
loc_826604FC:
	...
	// bdnz 0x826604fc
	--ctx.ctr.u64;
	if (ctx.ctr.u32 != 0) goto loc_826604FC;
	// mr r3,r27
	ctx.r3.u64 = ctx.r27.u64;
	// addi r1,r1,208
	ctx.r1.s64 = ctx.r1.s64 + 208;
...
loc_82660530:
	...
	// bdnz 0x82660530
	--ctx.ctr.u64;
	if (ctx.ctr.u32 != 0) goto loc_82660530;
	// mr r3,r27
	ctx.r3.u64 = ctx.r27.u64;
	// addi r1,r1,208
	ctx.r1.s64 = ctx.r1.s64 + 208;
...
loc_82660564:
	...
	// bdnz 0x82660564
	--ctx.ctr.u64;
	if (ctx.ctr.u32 != 0) goto loc_82660564;
	// mr r3,r27
	ctx.r3.u64 = ctx.r27.u64;
	// addi r1,r1,208
	ctx.r1.s64 = ctx.r1.s64 + 208;
...
loc_82660584:
	// lwz r31,368(r31)
	ctx.r31.u64 = PPC_LOAD_U32(ctx.r31.u32 + 368);
	// cmplwi cr6,r31,0
	ctx.cr6.compare<uint32_t>(ctx.r31.u32, 0, ctx.xer);
	// beq cr6,0x82660618
	if (ctx.cr6.eq) goto loc_82660618;
	// addi r4,r31,112
	...
	// beq cr6,0x826605e8
	if (ctx.cr6.eq) goto loc_826605E8;
	// lwz r10,396(r31)
...
loc_826605F8:
	...
	// bdnz 0x826605f8
	--ctx.ctr.u64;
	if (ctx.ctr.u32 != 0) goto loc_826605F8;
	// mr r3,r27
	ctx.r3.u64 = ctx.r27.u64;
	// addi r1,r1,208
	ctx.r1.s64 = ctx.r1.s64 + 208;
...
loc_8266062C:
	...
	// bdnz 0x8266062c
	--ctx.ctr.u64;
	if (ctx.ctr.u32 != 0) goto loc_8266062C;
	// mr r3,r27
	ctx.r3.u64 = ctx.r27.u64;
	// addi r1,r1,208
	ctx.r1.s64 = ctx.r1.s64 + 208;
...
__attribute__((alias("__imp__sub_8266064C"))) PPC_WEAK_FUNC(sub_8266064C);
PPC_FUNC_IMPL(__imp__sub_8266064C) {
	PPC_FUNC_PROLOGUE();
	// .long 0x0
}

__attribute__((alias("__imp__sub_82660650"))) PPC_WEAK_FUNC(sub_82660650);
PPC_FUNC_IMPL(__imp__sub_82660650) {
	PPC_FUNC_PROLOGUE();
	PPCRegister temp{};
	uint32_t ea{};
	// mflr r12
	...
	// bne cr6,0x826606b8
	if (!ctx.cr6.eq) goto loc_826606B8;
	// lis r11,-32229
...
loc_826606B8:
	...
	ctx.cr6.compare<uint32_t>(ctx.r30.u32, 0, ctx.xer);
	// beq cr6,0x826607c8
	if (ctx.cr6.eq) goto loc_826607C8;
	// lwz r27,732(r30)
	ctx.r27.u64 = PPC_LOAD_U32(ctx.r30.u32 + 732);
	// cmplwi cr6,r27,0
	...
	// beq cr6,0x8266077c
	if (ctx.cr6.eq) goto loc_8266077C;
	// cmpwi cr6,r27,-1
...
__attribute__((alias("__imp__sub_826607E4"))) PPC_WEAK_FUNC(sub_826607E4);
PPC_FUNC_IMPL(__imp__sub_826607E4) {
	PPC_FUNC_PROLOGUE();
	// .long 0x0
}

__attribute__((alias("__imp__sub_826607E8"))) PPC_WEAK_FUNC(sub_826607E8);
PPC_FUNC_IMPL(__imp__sub_826607E8) {
	PPC_FUNC_PROLOGUE();
	PPCRegister temp{};
	uint32_t ea{};
	// mflr r12
	...
	// ble cr6,0x82660864
	if (!ctx.cr6.gt) goto loc_82660864;
	// lwz r11,500(r31)
	ctx.r11.u64 = PPC_LOAD_U32(ctx.r31.u32 + 500);
	// lwz r10,204(r11)
...
__attribute__((alias("__imp__sub_82660894"))) PPC_WEAK_FUNC(sub_82660894);
PPC_FUNC_IMPL(__imp__sub_82660894) {
	PPC_FUNC_PROLOGUE();
	// .long 0x0
}
