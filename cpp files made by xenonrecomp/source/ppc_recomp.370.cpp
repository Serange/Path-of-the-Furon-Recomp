...
__attribute__((alias("__imp__sub_82BCE838"))) PPC_WEAK_FUNC(sub_82BCE838);
PPC_FUNC_IMPL(__imp__sub_82BCE838) {
	PPC_FUNC_PROLOGUE();
	// lwz r11,24(r3)
	ctx.r11.u64 = PPC_LOAD_U32(ctx.r3.u32 + 24);
	// clrlwi r10,r11,31
	...
	ctx.cr6.compare<uint32_t>(ctx.r10.u32, 0, ctx.xer);
	// beq cr6,0x82bce850
	if (ctx.cr6.eq) goto loc_82BCE850;
	// lbz r3,144(r3)
...
__attribute__((alias("__imp__sub_82BCE864"))) PPC_WEAK_FUNC(sub_82BCE864);
PPC_FUNC_IMPL(__imp__sub_82BCE864) {
	PPC_FUNC_PROLOGUE();
	// .long 0x0
}
