...
loc_8237889C:
	...
	_mm_store_ps(ctx.v37.f32, _mm_dp_ps(_mm_load_ps(ctx.v48.f32), _mm_load_ps(ctx.v46.f32), 0xFF));
	// lvx128 v36,r11,r29
	...
	_mm_store_ps(ctx.v35.f32, _mm_dp_ps(_mm_load_ps(ctx.v48.f32), _mm_load_ps(ctx.v45.f32), 0xFF));
	...
	_mm_store_ps(ctx.v34.f32, _mm_dp_ps(_mm_load_ps(ctx.v48.f32), _mm_load_ps(ctx.v44.f32), 0xFF));
	// addi r7,r1,288
	ctx.r7.s64 = ctx.r1.s64 + 288;
	// vmsum4fp128 v32,v48,v43
	_mm_store_ps(ctx.v32.f32, _mm_dp_ps(_mm_load_ps(ctx.v48.f32), _mm_load_ps(ctx.v43.f32), 0xFF));
	// addi r6,r1,304
	ctx.r6.s64 = ctx.r1.s64 + 304;
	// vmsum4fp128 v62,v38,v46
	_mm_store_ps(ctx.v62.f32, _mm_dp_ps(_mm_load_ps(ctx.v38.f32), _mm_load_ps(ctx.v46.f32), 0xFF));
	// addi r5,r1,320
	ctx.r5.s64 = ctx.r1.s64 + 320;
	// vmsum4fp128 v61,v38,v45
	_mm_store_ps(ctx.v61.f32, _mm_dp_ps(_mm_load_ps(ctx.v38.f32), _mm_load_ps(ctx.v45.f32), 0xFF));
	// addi r4,r1,272
	ctx.r4.s64 = ctx.r1.s64 + 272;
	// vmsum4fp128 v57,v36,v46
	_mm_store_ps(ctx.v57.f32, _mm_dp_ps(_mm_load_ps(ctx.v36.f32), _mm_load_ps(ctx.v46.f32), 0xFF));
	// addi r3,r1,336
	ctx.r3.s64 = ctx.r1.s64 + 336;
	// vmsum4fp128 v56,v36,v45
	_mm_store_ps(ctx.v56.f32, _mm_dp_ps(_mm_load_ps(ctx.v36.f32), _mm_load_ps(ctx.v45.f32), 0xFF));
	// vmsum4fp128 v60,v38,v44
	_mm_store_ps(ctx.v60.f32, _mm_dp_ps(_mm_load_ps(ctx.v38.f32), _mm_load_ps(ctx.v44.f32), 0xFF));
	// vmsum4fp128 v59,v38,v43
	_mm_store_ps(ctx.v59.f32, _mm_dp_ps(_mm_load_ps(ctx.v38.f32), _mm_load_ps(ctx.v43.f32), 0xFF));
	// vmsum4fp128 v55,v36,v44
	_mm_store_ps(ctx.v55.f32, _mm_dp_ps(_mm_load_ps(ctx.v36.f32), _mm_load_ps(ctx.v44.f32), 0xFF));
	// vmsum4fp128 v54,v36,v43
	_mm_store_ps(ctx.v54.f32, _mm_dp_ps(_mm_load_ps(ctx.v36.f32), _mm_load_ps(ctx.v43.f32), 0xFF));
	...
	_mm_store_ps(ctx.v58.f32, _mm_dp_ps(_mm_load_ps(ctx.v34.f32), _mm_load_ps(ctx.v40.f32), 0xFF));
	// vmsum4fp128 v57,v34,v37
	_mm_store_ps(ctx.v57.f32, _mm_dp_ps(_mm_load_ps(ctx.v34.f32), _mm_load_ps(ctx.v37.f32), 0xFF));
	// vmsum4fp128 v56,v34,v39
	_mm_store_ps(ctx.v56.f32, _mm_dp_ps(_mm_load_ps(ctx.v34.f32), _mm_load_ps(ctx.v39.f32), 0xFF));
	// vmsum4fp128 v55,v34,v35
	_mm_store_ps(ctx.v55.f32, _mm_dp_ps(_mm_load_ps(ctx.v34.f32), _mm_load_ps(ctx.v35.f32), 0xFF));
	// vmsum4fp128 v54,v32,v40
	_mm_store_ps(ctx.v54.f32, _mm_dp_ps(_mm_load_ps(ctx.v32.f32), _mm_load_ps(ctx.v40.f32), 0xFF));
	// vmsum4fp128 v53,v32,v37
	_mm_store_ps(ctx.v53.f32, _mm_dp_ps(_mm_load_ps(ctx.v32.f32), _mm_load_ps(ctx.v37.f32), 0xFF));
	// vmsum4fp128 v52,v36,v39
	_mm_store_ps(ctx.v52.f32, _mm_dp_ps(_mm_load_ps(ctx.v36.f32), _mm_load_ps(ctx.v39.f32), 0xFF));
	// vmsum4fp128 v51,v36,v35
	_mm_store_ps(ctx.v51.f32, _mm_dp_ps(_mm_load_ps(ctx.v36.f32), _mm_load_ps(ctx.v35.f32), 0xFF));
	...
	_mm_store_si128((__m128i*)ctx.v40.u32, _mm_unpackhi_epi32(_mm_load_si128((__m128i*)ctx.v51.u32), _mm_load_si128((__m128i*)ctx.v52.u32)));
	// stvx128 v45,r0,r4
