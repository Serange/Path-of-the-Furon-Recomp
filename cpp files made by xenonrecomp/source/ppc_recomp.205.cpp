...
__attribute__((alias("__imp__sub_82756BC8"))) PPC_WEAK_FUNC(sub_82756BC8);
PPC_FUNC_IMPL(__imp__sub_82756BC8) {
	PPC_FUNC_PROLOGUE();
	uint32_t ea{};
	// mflr r12
	ctx.r12.u64 = ctx.lr;
...
__attribute__((alias("__imp__sub_82756C28"))) PPC_WEAK_FUNC(sub_82756C28);
PPC_FUNC_IMPL(__imp__sub_82756C28) {
	PPC_FUNC_PROLOGUE();
...
__attribute__((alias("__imp__sub_82756C40"))) PPC_WEAK_FUNC(sub_82756C40);
PPC_FUNC_IMPL(__imp__sub_82756C40) {
	PPC_FUNC_PROLOGUE();
	// rlwinm r11,r4,1,0,30
	ctx.r11.u64 = __builtin_rotateleft64(ctx.r4.u32 | (ctx.r4.u64 << 32), 1) & 0xFFFFFFFE;
	// lwz r10,0(r3)
...
__attribute__((alias("__imp__sub_82756C58"))) PPC_WEAK_FUNC(sub_82756C58);
PPC_FUNC_IMPL(__imp__sub_82756C58) {
	PPC_FUNC_PROLOGUE();
	// lwz r11,12(r3)
...
__attribute__((alias("__imp__sub_82756C68"))) PPC_WEAK_FUNC(sub_82756C68);
PPC_FUNC_IMPL(__imp__sub_82756C68) {
	PPC_FUNC_PROLOGUE();
	// blr 
	return;
}
...
loc_8275DB58:
	...
	// vor128 v127,v63,v60
	_mm_store_si128((__m128i*)ctx.v127.u8, _mm_or_si128(_mm_load_si128((__m128i*)ctx.v63.u8), _mm_load_si128((__m128i*)ctx.v60.u8)));
	// vmulfp128 v126,v59,v59
	ctx.fpscr.enableFlushMode();
	_mm_store_ps(ctx.v126.f32, _mm_mul_ps(_mm_load_ps(ctx.v59.f32), _mm_load_ps(ctx.v59.f32)));
	// ble cr6,0x8275dc40
...
loc_8275DB94:
	...
	// vor128 v52,v56,v57
	_mm_store_si128((__m128i*)ctx.v52.u8, _mm_or_si128(_mm_load_si128((__m128i*)ctx.v56.u8), _mm_load_si128((__m128i*)ctx.v57.u8)));
	// vor128 v51,v53,v54
	_mm_store_si128((__m128i*)ctx.v51.u8, _mm_or_si128(_mm_load_si128((__m128i*)ctx.v53.u8), _mm_load_si128((__m128i*)ctx.v54.u8)));
	...
	_mm_store_ps(ctx.v13.f32, _mm_cmpgt_ps(_mm_load_ps(ctx.v50.f32), _mm_load_ps(ctx.v127.f32)));
	// vsubfp128 v12,v127,v50
	_mm_store_ps(ctx.v12.f32, _mm_sub_ps(_mm_load_ps(ctx.v127.f32), _mm_load_ps(ctx.v50.f32)));
	// vcmpgtfp128 v11,v127,v49
	_mm_store_ps(ctx.v11.f32, _mm_cmpgt_ps(_mm_load_ps(ctx.v127.f32), _mm_load_ps(ctx.v49.f32)));
	// vsubfp128 v10,v127,v49
	_mm_store_ps(ctx.v10.f32, _mm_sub_ps(_mm_load_ps(ctx.v127.f32), _mm_load_ps(ctx.v49.f32)));
	// vsel v9,v0,v12,v13
	...
	_mm_store_ps(ctx.v48.f32, _mm_dp_ps(_mm_load_ps(ctx.v8.f32), _mm_load_ps(ctx.v8.f32), 0xEF));
	// vcmpgefp128. v47,v126,v48
	_mm_store_ps(ctx.v47.f32, _mm_cmpge_ps(_mm_load_ps(ctx.v126.f32), _mm_load_ps(ctx.v48.f32)));
