...
__attribute__((alias("__imp__sub_82B7EA18"))) PPC_WEAK_FUNC(sub_82B7EA18);
PPC_FUNC_IMPL(__imp__sub_82B7EA18) {
	PPC_FUNC_PROLOGUE();
	uint32_t ea{};
	// mflr r12
	ctx.r12.u64 = ctx.lr;
	...
	ctx.cr6.compare<uint32_t>(ctx.r11.u32, 0, ctx.xer);
	// bne cr6,0x82b7ea5c
	if (!ctx.cr6.eq) goto loc_82B7EA5C;
	// lis r11,-32246
	ctx.r11.s64 = -2113273856;
	// addi r3,r11,11480
	ctx.r3.s64 = ctx.r11.s64 + 11480;
...
__attribute__((alias("__imp__sub_82B7EA84"))) PPC_WEAK_FUNC(sub_82B7EA84);
PPC_FUNC_IMPL(__imp__sub_82B7EA84) {
	PPC_FUNC_PROLOGUE();
	// .long 0x0
}
