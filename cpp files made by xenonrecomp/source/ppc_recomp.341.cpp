...
PPC_FUNC_IMPL(__imp__sub_82B1F5D0) {
	...
	ctx.cr6.compare<uint32_t>(ctx.r10.u32, 0, ctx.xer);
	// bne cr6,0x82b1f608
	if (!ctx.cr6.eq) goto loc_82B1F608;
	// mr r3,r29
	ctx.r3.u64 = ctx.r29.u64;
	// bl 0x822aace8
	ctx.lr = 0x82B1F5FC;
...
loc_82B1F608:
	...
	ctx.cr6.compare<uint32_t>(ctx.r10.u32, ctx.r11.u32, ctx.xer);
	// beq cr6,0x82b1f62c
	if (ctx.cr6.eq) goto loc_82B1F62C;
	// bl 0x822955c8
	ctx.lr = 0x82B1F61C;
	sub_822955C8(ctx, base);
	// lwz r11,-23768(r30)
...
loc_82B1F634:
	...
	ctx.cr6.compare<uint32_t>(ctx.r10.u32, 0, ctx.xer);
	// bne cr6,0x82b1f654
	if (!ctx.cr6.eq) goto loc_82B1F654;
	// mr r3,r29
	ctx.r3.u64 = ctx.r29.u64;
	// bl 0x822aace8
	ctx.lr = 0x82B1F644;
...
loc_82B1F654:
	...
	ctx.cr6.compare<uint32_t>(ctx.r10.u32, 0, ctx.xer);
	// bne cr6,0x82b1f680
	if (!ctx.cr6.eq) goto loc_82B1F680;
	// mr r3,r29
	ctx.r3.u64 = ctx.r29.u64;
	// bl 0x82398580
	ctx.lr = 0x82B1F670;
...
loc_82B1F680:
	...
	ctx.cr6.compare<uint32_t>(ctx.r9.u32, 0, ctx.xer);
	// beq cr6,0x82b1f6b8
	if (ctx.cr6.eq) goto loc_82B1F6B8;
	// rotlwi r31,r10,0
	ctx.r31.u64 = __builtin_rotateleft32(ctx.r10.u32, 0);
	// bl 0x822949a0
	ctx.lr = 0x82B1F69C;
	...
	if (!ctx.cr6.eq) goto loc_82B1F6B8;
	// lwz r3,-23768(r30)
	ctx.r3.u64 = PPC_LOAD_U32(ctx.r30.u32 + -23768);
	// lwz r11,0(r3)
	ctx.r11.u64 = PPC_LOAD_U32(ctx.r3.u32 + 0);
	// lwz r10,124(r11)
	ctx.r10.u64 = PPC_LOAD_U32(ctx.r11.u32 + 124);
...
__attribute__((alias("__imp__sub_82B1F6C0"))) PPC_WEAK_FUNC(sub_82B1F6C0);
PPC_FUNC_IMPL(__imp__sub_82B1F6C0) {
	PPC_FUNC_PROLOGUE();
	// li r3,1
	ctx.r3.s64 = 1;
	// blr 
