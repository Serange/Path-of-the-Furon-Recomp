...
__attribute__((alias("__imp__sub_82686A68"))) PPC_WEAK_FUNC(sub_82686A68);
PPC_FUNC_IMPL(__imp__sub_82686A68) {
	PPC_FUNC_PROLOGUE();
	// mr r3,r4
...
__attribute__((alias("__imp__sub_82686A70"))) PPC_WEAK_FUNC(sub_82686A70);
PPC_FUNC_IMPL(__imp__sub_82686A70) {
	PPC_FUNC_PROLOGUE();
	// lis r10,-31883
...
__attribute__((alias("__imp__sub_82686A98"))) PPC_WEAK_FUNC(sub_82686A98);
PPC_FUNC_IMPL(__imp__sub_82686A98) {
	PPC_FUNC_PROLOGUE();
	uint32_t ea{};
	// mflr r12
	ctx.r12.u64 = ctx.lr;
	...
	// beq cr6,0x82686b08
	if (ctx.cr6.eq) goto loc_82686B08;
	// lis r11,-31884
	...
	// blt cr6,0x82686b00
	if (ctx.cr6.lt) goto loc_82686B00;
	// lis r11,-31884
	ctx.r11.s64 = -2089549824;
	// lwz r11,25200(r11)
	...
	ctx.cr6.compare<uint32_t>(ctx.r31.u32, ctx.r11.u32, ctx.xer);
	// ble cr6,0x82686b08
	if (!ctx.cr6.gt) goto loc_82686B08;
loc_82686B00:
	// mr r3,r31
	ctx.r3.u64 = ctx.r31.u64;
	// bl 0x82294a58
