...
__attribute__((alias("__imp__sub_82ACD228"))) PPC_WEAK_FUNC(sub_82ACD228);
PPC_FUNC_IMPL(__imp__sub_82ACD228) {
	PPC_FUNC_PROLOGUE();
	PPCRegister temp{};
	uint32_t ea{};
	// mflr r12
	...
	ctx.cr6.compare<int32_t>(ctx.r11.s32, 0, ctx.xer);
	// beq cr6,0x82acd254
	if (ctx.cr6.eq) goto loc_82ACD254;
	// lwz r29,900(r31)
...
loc_82ACD25C:
	...
	// beq cr6,0x82acd48c
	if (ctx.cr6.eq) goto loc_82ACD48C;
	// lis r10,-32222
	ctx.r10.s64 = -2111700992;
	// addi r27,r10,-18304
...
loc_82ACD344:
	...
	// beq cr6,0x82acd430
	if (ctx.cr6.eq) goto loc_82ACD430;
	// lwz r9,104(r30)
	...
	ctx.cr6.compare<int32_t>(ctx.r9.s32, 0, ctx.xer);
	// beq cr6,0x82acd384
	if (ctx.cr6.eq) goto loc_82ACD384;
	// addi r4,r1,80
	ctx.r4.s64 = ctx.r1.s64 + 80;
	// addi r3,r30,84
	...
	ctx.cr6.compare<uint32_t>(ctx.r3.u32, 0, ctx.xer);
	// beq cr6,0x82acd3b0
	if (ctx.cr6.eq) goto loc_82ACD3B0;
	// lhz r11,0(r3)
...
loc_82ACD384:
	...
	// bge cr6,0x82acd3b0
	if (!ctx.cr6.lt) goto loc_82ACD3B0;
...
loc_82ACD3B4:
	...
	ctx.cr6.compare<int32_t>(ctx.r11.s32, ctx.r10.s32, ctx.xer);
	// bge cr6,0x82acd430
	if (!ctx.cr6.lt) goto loc_82ACD430;
...
loc_82ACD430:
	...
	ctx.cr6.compare<uint32_t>(ctx.r11.u32, 0, ctx.xer);
	// beq cr6,0x82acd44c
	if (ctx.cr6.eq) goto loc_82ACD44C;
	// fadds f0,f0,f27
...
loc_82ACD44C:
	...
	ctx.cr6.compare<uint32_t>(ctx.r11.u32, 0, ctx.xer);
	// bne cr6,0x82acd344
	if (!ctx.cr6.eq) goto loc_82ACD344;
loc_82ACD48C:
	// lfs f0,1008(r31)
	ctx.fpscr.disableFlushMode();
	temp.u32 = PPC_LOAD_U32(ctx.r31.u32 + 1008);
	...
	PPC_STORE_U32(ctx.r31.u32 + 1008, temp.u32);
	// bne cr6,0x82acd4f4
	if (!ctx.cr6.eq) goto loc_82ACD4F4;
	// lfs f0,496(r31)
...
loc_82ACD4F4:
	...
	// bne cr6,0x82acd50c
	if (!ctx.cr6.eq) goto loc_82ACD50C;
	// lfs f0,504(r31)
	ctx.fpscr.disableFlushMode();
...
__attribute__((alias("__imp__sub_82ACD580"))) PPC_WEAK_FUNC(sub_82ACD580);
PPC_FUNC_IMPL(__imp__sub_82ACD580) {
	PPC_FUNC_PROLOGUE();
	PPCRegister temp{};
	uint32_t ea{};
	// mflr r12
	...
	ctx.cr6.compare<uint32_t>(ctx.r10.u32, 0, ctx.xer);
	// beq cr6,0x82acd664
	if (ctx.cr6.eq) goto loc_82ACD664;
	// addi r30,r31,876
	...
	ctx.cr6.compare<uint32_t>(ctx.r3.u32, 0, ctx.xer);
	// beq cr6,0x82acd5f8
	if (ctx.cr6.eq) goto loc_82ACD5F8;
	// lwz r10,0(r31)
