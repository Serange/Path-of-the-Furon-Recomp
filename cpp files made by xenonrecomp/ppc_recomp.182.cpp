...
__attribute__((alias("__imp__sub_826CCF88"))) PPC_WEAK_FUNC(sub_826CCF88);
PPC_FUNC_IMPL(__imp__sub_826CCF88) {
	PPC_FUNC_PROLOGUE();
	// li r11,0
	ctx.r11.s64 = 0;
	// li r10,8
...
__attribute__((alias("__imp__sub_826CCFA8"))) PPC_WEAK_FUNC(sub_826CCFA8);
PPC_FUNC_IMPL(__imp__sub_826CCFA8) {
	PPC_FUNC_PROLOGUE();
	uint32_t ea{};
	// mflr r12
	ctx.r12.u64 = ctx.lr;
	...
	// bl 0x826cdc28
	ctx.lr = 0x826CD030;
	sub_826CDC28(ctx, base);
	// mr r3,r31
	ctx.r3.u64 = ctx.r31.u64;
	// bl 0x826ce368
	ctx.lr = 0x826CD038;
	sub_826CE368(ctx, base);
	// mr r3,r31
	ctx.r3.u64 = ctx.r31.u64;
	// bl 0x826cdb90
	ctx.lr = 0x826CD040;
	sub_826CDB90(ctx, base);
	// lwz r4,112(r31)
	...
	// bne cr6,0x826cd078
	if (!ctx.cr6.eq) goto loc_826CD078;
	// lis r11,-31884
...
loc_826CD078:
	...
	// beq cr6,0x826cd0ec
	if (ctx.cr6.eq) goto loc_826CD0EC;
	// lwz r11,0(r3)
...
loc_826CD0EC:
	...
	ctx.cr6.compare<uint32_t>(ctx.r3.u32, 0, ctx.xer);
	// beq cr6,0x826cd10c
	if (ctx.cr6.eq) goto loc_826CD10C;
	// bl 0x8291bc60
	ctx.lr = 0x826CD104;
	sub_8291BC60(ctx, base);
	// stw r3,296(r31)
...
__attribute__((alias("__imp__sub_826CD12C"))) PPC_WEAK_FUNC(sub_826CD12C);
PPC_FUNC_IMPL(__imp__sub_826CD12C) {
	PPC_FUNC_PROLOGUE();
	// .long 0x0
}

__attribute__((alias("__imp__sub_826CD130"))) PPC_WEAK_FUNC(sub_826CD130);
PPC_FUNC_IMPL(__imp__sub_826CD130) {
	PPC_FUNC_PROLOGUE();
	uint32_t ea{};
	// mflr r12
	ctx.r12.u64 = ctx.lr;
	...
	// beq cr6,0x826cd164
	if (ctx.cr6.eq) goto loc_826CD164;
	// ld r10,8(r11)
...
loc_826CD164:
	...
	ctx.cr6.compare<uint32_t>(ctx.r3.u32, 0, ctx.xer);
	// beq cr6,0x826cd1a0
	if (ctx.cr6.eq) goto loc_826CD1A0;
	// lwz r11,120(r31)
...
loc_826CD1A0:
	...
	ctx.cr6.compare<uint32_t>(ctx.r3.u32, 0, ctx.xer);
	// beq cr6,0x826cd1d8
	if (ctx.cr6.eq) goto loc_826CD1D8;
	// lwz r11,0(r3)
	ctx.r11.u64 = PPC_LOAD_U32(ctx.r3.u32 + 0);
	// lwz r10,100(r11)
...
PPC_FUNC_IMPL(__imp__sub_826CD200) {
	...
	ctx.cr6.compare<uint32_t>(ctx.r3.u32, 0, ctx.xer);
	// beq cr6,0x826cd24c
	if (ctx.cr6.eq) goto loc_826CD24C;
	// lwz r11,0(r3)
	ctx.r11.u64 = PPC_LOAD_U32(ctx.r3.u32 + 0);
	// lwz r10,100(r11)
	ctx.r10.u64 = PPC_LOAD_U32(ctx.r11.u32 + 100);
...
PPC_FUNC_IMPL(__imp__sub_826D0158) {
	...
	_mm_store_ps(ctx.v47.f32, _mm_dp_ps(_mm_load_ps(ctx.v54.f32), _mm_load_ps(ctx.v55.f32), 0xFF));
	// vmsum4fp128 v46,v54,v53
	_mm_store_ps(ctx.v46.f32, _mm_dp_ps(_mm_load_ps(ctx.v54.f32), _mm_load_ps(ctx.v53.f32), 0xFF));
	// addi r8,r1,96
	ctx.r8.s64 = ctx.r1.s64 + 96;
	// vmsum4fp128 v43,v52,v55
	_mm_store_ps(ctx.v43.f32, _mm_dp_ps(_mm_load_ps(ctx.v52.f32), _mm_load_ps(ctx.v55.f32), 0xFF));
	// addi r7,r1,112
	ctx.r7.s64 = ctx.r1.s64 + 112;
	// vmsum4fp128 v42,v52,v53
	_mm_store_ps(ctx.v42.f32, _mm_dp_ps(_mm_load_ps(ctx.v52.f32), _mm_load_ps(ctx.v53.f32), 0xFF));
	// addi r6,r1,128
	...
	_mm_store_ps(ctx.v44.f32, _mm_dp_ps(_mm_load_ps(ctx.v54.f32), _mm_load_ps(ctx.v49.f32), 0xFF));
	// addi r4,r1,80
	ctx.r4.s64 = ctx.r1.s64 + 80;
	// vmsum4fp128 v41,v52,v51
	_mm_store_ps(ctx.v41.f32, _mm_dp_ps(_mm_load_ps(ctx.v52.f32), _mm_load_ps(ctx.v51.f32), 0xFF));
	// mr r3,r31
	ctx.r3.u64 = ctx.r31.u64;
	// vmsum4fp128 v40,v52,v49
	_mm_store_ps(ctx.v40.f32, _mm_dp_ps(_mm_load_ps(ctx.v52.f32), _mm_load_ps(ctx.v49.f32), 0xFF));
	// li r5,64
	ctx.r5.s64 = 64;
	// vmsum4fp128 v39,v50,v55
	_mm_store_ps(ctx.v39.f32, _mm_dp_ps(_mm_load_ps(ctx.v50.f32), _mm_load_ps(ctx.v55.f32), 0xFF));
	// vmsum4fp128 v38,v50,v53
	_mm_store_ps(ctx.v38.f32, _mm_dp_ps(_mm_load_ps(ctx.v50.f32), _mm_load_ps(ctx.v53.f32), 0xFF));
	// vmsum4fp128 v34,v48,v53
	_mm_store_ps(ctx.v34.f32, _mm_dp_ps(_mm_load_ps(ctx.v48.f32), _mm_load_ps(ctx.v53.f32), 0xFF));
	// vmsum4fp128 v37,v50,v51
	_mm_store_ps(ctx.v37.f32, _mm_dp_ps(_mm_load_ps(ctx.v50.f32), _mm_load_ps(ctx.v51.f32), 0xFF));
	...
	_mm_store_ps(ctx.v33.f32, _mm_dp_ps(_mm_load_ps(ctx.v48.f32), _mm_load_ps(ctx.v51.f32), 0xFF));
	// vmsum4fp128 v32,v48,v49
	_mm_store_ps(ctx.v32.f32, _mm_dp_ps(_mm_load_ps(ctx.v48.f32), _mm_load_ps(ctx.v49.f32), 0xFF));
