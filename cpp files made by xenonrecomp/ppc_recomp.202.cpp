...
__attribute__((alias("__imp__sub_82742BA0"))) PPC_WEAK_FUNC(sub_82742BA0);
PPC_FUNC_IMPL(__imp__sub_82742BA0) {
	PPC_FUNC_PROLOGUE();
	uint32_t ea{};
	// mflr r12
	ctx.r12.u64 = ctx.lr;
	...
	// beq cr6,0x82742c7c
	if (ctx.cr6.eq) goto loc_82742C7C;
	// lis r11,-32243
	...
	// bl 0x827478e8
	ctx.lr = 0x82742BE4;
	sub_827478E8(ctx, base);
	// cmplwi cr6,r3,0
	ctx.cr6.compare<uint32_t>(ctx.r3.u32, 0, ctx.xer);
	// beq cr6,0x82742c1c
	if (ctx.cr6.eq) goto loc_82742C1C;
	// lwz r11,80(r3)
	...
	// bne cr6,0x82742c84
	if (!ctx.cr6.eq) goto loc_82742C84;
loc_82742BFC:
	// lwz r11,4(r31)
	...
	// bne cr6,0x82742c28
	if (!ctx.cr6.eq) goto loc_82742C28;
	// lis r11,-32245
...
loc_82742C30:
	...
	// beq cr6,0x82742c44
	if (ctx.cr6.eq) goto loc_82742C44;
	// lwz r5,120(r1)
...
PPC_FUNC_IMPL(__imp__sub_82742CA8) {
	...
	// lwz r11,1100(r22)
	ctx.r11.u64 = PPC_LOAD_U32(ctx.r22.u32 + 1100);
	// cmpwi cr6,r11,0
	ctx.cr6.compare<int32_t>(ctx.r11.s32, 0, ctx.xer);
	// bgt cr6,0x82743020
	if (ctx.cr6.gt) goto loc_82743020;
	// lwz r11,1104(r22)
	ctx.r11.u64 = PPC_LOAD_U32(ctx.r22.u32 + 1104);
	// li r29,0
	ctx.r29.s64 = 0;
	// addi r21,r22,1096
	ctx.r21.s64 = ctx.r22.s64 + 1096;
	// stw r29,1100(r22)
	PPC_STORE_U32(ctx.r22.u32 + 1100, ctx.r29.u32);
	// cmpwi cr6,r11,0
	ctx.cr6.compare<int32_t>(ctx.r11.s32, 0, ctx.xer);
	// beq cr6,0x82742cf4
	if (ctx.cr6.eq) goto loc_82742CF4;
	// stw r29,8(r21)
...
loc_82742CF4:
	...
	// bgt cr6,0x82742d28
	if (ctx.cr6.gt) goto loc_82742D28;
	// mr r11,r29
...
loc_82742D3C:
	...
	ctx.cr6.compare<int32_t>(ctx.r11.s32, 0, ctx.xer);
	// ble cr6,0x82743014
	if (!ctx.cr6.gt) goto loc_82743014;
	// lis r10,-32246
...
loc_82742D68:
	...
	// ldx r10,r27,r11
	ctx.r10.u64 = PPC_LOAD_U64(ctx.r27.u32 + ctx.r11.u32);
	// std r10,80(r1)
...
loc_82742E3C:
	...
	ctx.cr6.compare<int32_t>(ctx.r11.s32, 0, ctx.xer);
	// beq cr6,0x82742e60
	if (ctx.cr6.eq) goto loc_82742E60;
	// stw r29,112(r1)
	PPC_STORE_U32(ctx.r1.u32 + 112, ctx.r29.u32);
	// li r5,8
	ctx.r5.s64 = 8;
...
loc_82742E8C:
	...
	ctx.cr6.compare<int32_t>(ctx.r11.s32, 0, ctx.xer);
	// beq cr6,0x82742eb4
	if (ctx.cr6.eq) goto loc_82742EB4;
	// lwz r4,0(r3)
...
loc_82742EB8:
	...
	ctx.cr6.compare<int32_t>(ctx.r10.s32, 0, ctx.xer);
	// beq cr6,0x82742f20
	if (ctx.cr6.eq) goto loc_82742F20;
	// cmplwi cr6,r31,0
	ctx.cr6.compare<uint32_t>(ctx.r31.u32, 0, ctx.xer);
	// beq cr6,0x82742f50
	if (ctx.cr6.eq) goto loc_82742F50;
	// lwz r3,28888(r28)
	ctx.r3.u64 = PPC_LOAD_U32(ctx.r28.u32 + 28888);
	// cmplwi cr6,r3,0
	ctx.cr6.compare<uint32_t>(ctx.r3.u32, 0, ctx.xer);
	// bne cr6,0x82742f00
	if (!ctx.cr6.eq) goto loc_82742F00;
	// bl 0x822900a0
	ctx.lr = 0x82742EFC;
...
loc_82742F20:
	...
	ctx.cr6.compare<uint32_t>(ctx.r3.u32, 0, ctx.xer);
	// bne cr6,0x82742f3c
	if (!ctx.cr6.eq) goto loc_82742F3C;
	// bl 0x822900a0
	ctx.lr = 0x82742F38;
	sub_822900A0(ctx, base);
	// lwz r3,28888(r28)
...
loc_82742F50:
	...
	ctx.cr6.compare<uint32_t>(ctx.r11.u32, 0, ctx.xer);
	// beq cr6,0x82742ff4
	if (ctx.cr6.eq) goto loc_82742FF4;
	// lwz r3,28888(r28)
	ctx.r3.u64 = PPC_LOAD_U32(ctx.r28.u32 + 28888);
	// mr r31,r11
	...
	ctx.cr6.compare<uint32_t>(ctx.r3.u32, 0, ctx.xer);
	// bne cr6,0x82742f94
	if (!ctx.cr6.eq) goto loc_82742F94;
	// bl 0x822900a0
	ctx.lr = 0x82742F90;
	sub_822900A0(ctx, base);
	// lwz r3,28888(r28)
...
loc_82742FBC:
	...
	ctx.cr6.compare<uint32_t>(ctx.r11.u32, 0, ctx.xer);
	// bne cr6,0x82742fdc
	if (!ctx.cr6.eq) goto loc_82742FDC;
	// bl 0x822900a0
	ctx.lr = 0x82742FD8;
	sub_822900A0(ctx, base);
	// lwz r11,28888(r28)
...
loc_82742FF4:
	...
	PPC_STORE_U32(ctx.r1.u32 + 92, ctx.r29.u32);
	// blt cr6,0x82742d68
	if (ctx.cr6.lt) goto loc_82742D68;
loc_82743014:
	// li r3,1
	ctx.r3.s64 = 1;
	// addi r1,r1,288
...
__attribute__((alias("__imp__sub_8274303C"))) PPC_WEAK_FUNC(sub_8274303C);
PPC_FUNC_IMPL(__imp__sub_8274303C) {
	PPC_FUNC_PROLOGUE();
	// .long 0x0
}

__attribute__((alias("__imp__sub_82743040"))) PPC_WEAK_FUNC(sub_82743040);
PPC_FUNC_IMPL(__imp__sub_82743040) {
	PPC_FUNC_PROLOGUE();
	uint32_t ea{};
	// mflr r12
	ctx.r12.u64 = ctx.lr;
...
__attribute__((alias("__imp__sub_82743074"))) PPC_WEAK_FUNC(sub_82743074);
PPC_FUNC_IMPL(__imp__sub_82743074) {
	PPC_FUNC_PROLOGUE();
	// .long 0x0
}
