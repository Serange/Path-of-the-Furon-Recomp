...
__attribute__((alias("__imp__sub_829C3468"))) PPC_WEAK_FUNC(sub_829C3468);
PPC_FUNC_IMPL(__imp__sub_829C3468) {
	PPC_FUNC_PROLOGUE();
	uint32_t ea{};
	// mflr r12
	ctx.r12.u64 = ctx.lr;
	...
	ctx.cr6.compare<uint32_t>(ctx.r11.u32, 0, ctx.xer);
	// beq cr6,0x829c34c0
	if (ctx.cr6.eq) goto loc_829C34C0;
	// mr r11,r30
	ctx.r11.u64 = ctx.r30.u64;
loc_829C3494:
	// mr r3,r29
	...
	ctx.cr6.compare<int32_t>(ctx.r3.s32, 0, ctx.xer);
	// beq cr6,0x829c34cc
	if (ctx.cr6.eq) goto loc_829C34CC;
	// addi r31,r31,1
	ctx.r31.s64 = ctx.r31.s64 + 1;
	// rlwinm r11,r31,3,0,28
	ctx.r11.u64 = __builtin_rotateleft64(ctx.r31.u32 | (ctx.r31.u64 << 32), 3) & 0xFFFFFFF8;
	...
	ctx.cr6.compare<uint32_t>(ctx.r10.u32, 0, ctx.xer);
	// bne cr6,0x829c3494
	if (!ctx.cr6.eq) goto loc_829C3494;
loc_829C34C0:
	// li r3,0
	ctx.r3.s64 = 0;
	// addi r1,r1,112
